...
This parameter set includes the following corrections:
  -helix_hb_06_2009
  -adjustment to the cosAHD fade interval
  -turn off evaluation of on cosBAH and cosAHD when hbond lengths are *long*

...
class HPC_Driver:
    ...
    def execute(self, executable, arguments, working_dir, log_dir=None, name='_no_name_', memory=3800, time=24, shell_wrapper=False, block=True):
    ...
    def submit_hpc_job(self, name, executable, arguments, working_dir, jobs_to_queue, log_dir, memory=3800, time=12, block=True, shell_wrapper=False):
        print('submit_hpc_job is DEPRECATED and will be removed in near future, please use submit_serial_hpc_job  instead!')
        must_be_implemented_in_inherited_classes


    def submit_serial_hpc_job(self, name, executable, arguments, working_dir, jobs_to_queue, log_dir, memory=3800, time=12, block=True, shell_wrapper=False):
        must_be_implemented_in_inherited_classes


    def submit_mpi_hpc_job(self, name, executable, arguments, working_dir, log_dir, memory=3800, time=12, block=True, process_coefficient="1", requested_nodes=1, requested_processes_per_node=1):

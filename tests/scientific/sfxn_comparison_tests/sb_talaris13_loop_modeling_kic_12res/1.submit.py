...
#==> EDIT HERE
testname    = "sb_talaris13_loop_modeling_kic_12res"
...
-in:file:s {rosetta_dir}/tests/scientific/data/loop_modeling_kic_12res/{target}.pdb
-in:file:native {rosetta_dir}/tests/scientific/data/loop_modeling_kic_12res/reference/{target}.pdb
-loops:loop_file {rosetta_dir}/tests/scientific/data/loop_modeling_kic_12res/{target}.loop
-loops:extended true

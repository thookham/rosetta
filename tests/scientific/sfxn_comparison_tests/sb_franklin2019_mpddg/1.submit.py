...
#==> EDIT HERE
testname	= "sb_franklin2019_mpddg"
...
-in:file:s {rosetta_dir}/tests/scientific/data/mp_ddg/{target}/{target}_franklin_wt_{mutant}.pdb
-mp:setup:spanfiles {rosetta_dir}/tests/scientific/data/mp_ddg/{target}/{target}_opm_A.span
-nstruct {nstruct}
-parser:protocol {rosetta_dir}/tests/scientific/data/mp_ddg/ddg_f19_wt.xml
-parser:script_vars scorefxn=franklin2019
...
command_line_mut = '''
-database {rosetta_dir}/database
-in:file:s {rosetta_dir}/tests/scientific/data/mp_ddg/{target}/{target}_franklin_mut_{mutant}.pdb
-mp:setup:spanfiles {rosetta_dir}/tests/scientific/data/mp_ddg/{target}/{target}_opm_A.span
-nstruct {nstruct}
-parser:protocol {rosetta_dir}/tests/scientific/data/mp_ddg/ddg_f19_mut.xml
-parser:script_vars scorefxn=franklin2019
-mp:lipids:composition DMPC
-packing:resfile {rosetta_dir}/tests/scientific/data/mp_ddg/{target}/{target}_mut_{mutant}.res

...
#==> EDIT HERE
testname	= "sb_franklin2019_mpddg_cartesian"
...
-s {rosetta_dir}/tests/scientific/data/mp_ddg_cartesian/{target}/{target}_frcart.pdb 
...
-score:weights {rosetta_dir}/tests/scientific/data/mp_ddg_cartesian/franklin2019_cart_1.5.wts 
-in:membrane 
-fa_max_dis 9 

...
#==> EDIT HERE
testname	= "sb_ref2015mem_mpddg_cartesian"
...
-s {rosetta_dir}/tests/scientific/data/mp_ddg_cartesian/{target}/{target}_ref15memcart.pdb 
...
-score:weights {rosetta_dir}/tests/scientific/data/mp_ddg_cartesian/ref2015_memb_cart.wts
-in:membrane 
-fa_max_dis 9 

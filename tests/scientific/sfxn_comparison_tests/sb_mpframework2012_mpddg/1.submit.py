...
#==> EDIT HERE
testname	= "sb_mpframework2012_mpddg"
...
-in:file:s {rosetta_dir}/tests/scientific/data/mp_ddg/{target}/{target}_mpf_wt_{mutant}.pdb
...
-parser:script_vars scorefxn=mpframework_smooth_fa_2012.wts
...
command_line_mut = '''
-database {rosetta_dir}/database
-in:file:s {rosetta_dir}/tests/scientific/data/mp_ddg/{target}/{target}_mpf_mut_{mutant}.pdb
-mp:setup:spanfiles {rosetta_dir}/tests/scientific/data/mp_ddg/{target}/{target}_opm_A.span
-nstruct {nstruct}

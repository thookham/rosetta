...
#==> EDIT HERE
testname    = "sb_talaris13_loop_modeling_ngk_12res"
...
-in:file:s {rosetta_dir}/tests/scientific/data/loop_modeling_ngk_12res/{target}.pdb
-in:file:native {rosetta_dir}/tests/scientific/data/loop_modeling_ngk_12res/reference/{target}.pdb
-parser:script_vars loop={rosetta_dir}/tests/scientific/data/loop_modeling_ngk_12res/{target}.loop fast=0 loop_res=loop_res_holder
-loops:extended true
-ex1
-ex2
...
-nstruct {nstruct}
-parser:protocol {rosetta_dir}/tests/scientific/sfxn_comparison_tests/{testname}/loop_modeling_ngk_12res.xml
...
for target in targets:
    ...
    file = open(f'{rosetta_dir}/tests/scientific/data/loop_modeling_ngk_12res/{target}.loop', 'r')

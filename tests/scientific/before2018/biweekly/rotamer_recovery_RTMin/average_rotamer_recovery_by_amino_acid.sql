-- This query will return a table with the average rotamer recovery by
-- amino acid type for all residues with sidechain degrees of freedom
-- and maximum sidechain B-factor less than 30, where the criteria for
-- what counts as recovered is determined by the RRComparer used.

...
# inputs are header labels from the scorefile to plot, for instance "total_score" and "GDTMM_final"
...
benchmark.save_variables('debug targets nstruct working_dir testname results outfile cutoffs_gdt_dict cutoffs_score_dict failures')  # Python black magic: save all listed variable to json file for next script use (save all variables if called without argument)

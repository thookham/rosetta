...
## @file  ligand_scoring_ranking/9.finalize.py
...
# Cutoff is the percentage of Targets (57) where the spearman coorelation changed by a values greater than 0.2.
cutoff = 0.25
# read readme
...
_index_html_template_ += "<H2>Scientific test: " + testname

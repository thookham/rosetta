...
if 'mpi' not in config['platform']['extras']: benchmark.error(_S_build_failed_, 'This test requires the `mpi` platform.  Aborting...')
if 'cxx11thread' not in config['platform']['extras']: benchmark.error(_S_build_failed_, 'This test requires the `cxx11thread` platform.  Aborting...')
if 'serialization' not in config['platform']['extras']: benchmark.error(_S_build_failed_, 'This test requires the `serialization` platform.  Aborting...')

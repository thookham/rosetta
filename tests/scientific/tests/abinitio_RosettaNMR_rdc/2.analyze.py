...
## @file  abinitio_RosettaNMR_rdc/2.analyze.py
...
lambdas = {"2a7o": 6.0, "2k5u": 20.0, "2klc":4.0}
...
benchmark.save_variables('debug targets nstruct working_dir testname results scorefiles cutoffs_rmsd_dict cutoffs_score_dict failures lambdas Pnear')  # Python black magic: save all listed variable to json file for next script use (save all variables if called without argument)

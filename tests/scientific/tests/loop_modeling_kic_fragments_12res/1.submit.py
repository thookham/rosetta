...
#==> EDIT HERE
testname    = "loop_modeling_kic_fragments_12res"
...
-in:file:native {rosetta_dir}/tests/scientific/data/{testname}/reference/{target}.pdb
...
for target in targets:
    ...
    file = open(f'{rosetta_dir}/tests/scientific/data/{testname}/{target}.loop', 'r')

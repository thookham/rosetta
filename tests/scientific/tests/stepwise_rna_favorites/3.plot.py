...
benchmark.save_variables('targets nstruct working_dir testname results outfile min_e_cutoffs min_e_rmsd_cutoffs')  # Python black magic: save all listed variable to json file for next script use (save all variables if called without argument)

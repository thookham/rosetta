Integration tests for the PerturbBundle mover (namespace protocols::helical_bundle) when it is used to set parameter values.  Changes to this test mean that the

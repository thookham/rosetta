Integration test to confirm that the computation of interaction graphs in threads yields exactly the same interaction graph as would be produced in a single thread.

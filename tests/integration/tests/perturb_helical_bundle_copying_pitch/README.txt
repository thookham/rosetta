...
connection.  The test creates a four-helix bundle and perturbs r0 for two of the helices,
keeping their pitch (rise per turn) in line with the other two helices.  The structure is
more or less meaningless, but it confirms the proper functioning of the mover.

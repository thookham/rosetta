Integration test for the RosettaThreadManager's basic API.  This runs the test\_rosetta\_thread\_manager\_basic\_API application, which computes a table of random numbers in threads.

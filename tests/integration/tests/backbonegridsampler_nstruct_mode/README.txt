...
This version runs in nstruct mode, which means that every job samples a different set of mainchain torsion values.  This version also calls a pre-scoring mover.

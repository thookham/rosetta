...
cd ROSETTA/tests/integration/new/abinitio_with_trRosetta

[ -x ROSETTA/source/bin/minirosetta.tensorflow.macosclangrelease ] || exit 1
ROSETTA/source/bin/minirosetta.tensorflow.macosclangrelease  @flags -database ROSETTA/database -testing:INTEGRATION_TEST  2>&1 \
...
#
## ROSETTA/source/bin/MY_MINI_PROGRAM.tensorflow.macosclangrelease  @flags -database ROSETTA/database -testing:INTEGRATION_TEST  2>&1 \

...
run=function(self, sample_sources, output_dir, output_formats){
	...
	ggplot(data=f_first) + theme_bw() +
			...
			ggtitle(
							paste("Pi Stacking chiBDHO vs DHO Angles with Sequence Separation > 5\n",
...
#
#
#plot_id = "chiBDHO_cosDHO_eqpoldens_pi_stacking_cpisp2_all_3.5A"
#
#f_first <- f[ f$sample_source == levels(sample_sources$sample_source), ]
#
#ggplot(data=f_first) + theme_bw() +
...
#
#
#plot_id = "chiBDHO_cosDHO_eqpoldens_pi_stacking_cpisp2_phe_phe_3.5A"
#
#f_first <- f[ f$sample_source == levels(sample_sources$sample_source), ]
#
#ggplot(data=f_first) + theme_bw() +

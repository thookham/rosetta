...
d_ply(f, .(sample_source), function(sub_f){
	...
	#################
	plot_id = paste("AHchi_AHD_eq_polar_density_by_don_acc", ss_id, sep="_")
	sub_f$don_chem_type_name <- acc_chem_type_name_linear(sub_f$don_chem_type)
	sub_f$acc_chem_type_name <- acc_chem_type_name_linear(sub_f$acc_chem_type)

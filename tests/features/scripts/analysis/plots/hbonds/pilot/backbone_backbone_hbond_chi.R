...
#
#sele <- "
#CREATE TEMPORARY TABLE IF NOT EXISTS hbond_chi AS SELECT
...
#
#CREATE INDEX hbond_chi_don_site on
#  hbond_chi ( struct_id, don_resNum );
#
#CREATE INDEX hbond_chi_acc_site on
#  hbond_chi ( struct_id, acc_resNum );
#
#ANALYZE;
#
#SELECT
...
#  variable = "chi")
#
#plot_id <- "backbone_backbone_hbond_chi_trellis"
...
#  variable = "chi")
#
#plot_id <- "backbone_backbone_hbond_chi_diversity_acceptor"
...
#
#
#plot_id <- "backbone_backbone_hbond_chi_diversity_donor"

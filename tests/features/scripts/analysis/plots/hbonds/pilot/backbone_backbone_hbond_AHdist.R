...
#
#sele <- "
#CREATE TEMPORARY TABLE IF NOT EXISTS hbond_AHdist AS SELECT
...
#
#CREATE INDEX hbond_AHdist_don_site on
#  hbond_AHdist ( struct_id, don_resNum );
#
#CREATE INDEX hbond_AHdist_acc_site on
#  hbond_AHdist ( struct_id, acc_resNum );
#
#ANALYZE;
#
#SELECT
...
#
#plot_id <- "backbone_backbone_hbond_AHdist_trellis"
#p <- ggplot(data=dens)
...
#  weight_fun = radial_3d_normalization)
#
#plot_id <- "backbone_backbone_hbond_AHdist_diversity_acceptor"
...
#
#
#plot_id <- "backbone_backbone_hbond_AHdist_diversity_donor"

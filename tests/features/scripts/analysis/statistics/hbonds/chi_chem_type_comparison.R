...
comp_stats <- comparison_statistics(
	sample_sources, f, c(), "chi", tests)
table_id <- "chi_chem_type_comparison"
table_title <- "H-Bond chi Angle Distribution Comparison, B-Factor < 30"
save_tables(self,
	comp_stats, table_id,
...
comp_stats <- comparison_statistics(
	sample_sources, f, c("don_chem_type_name"), "chi", tests)
table_id <- paste("chi_chem_type_comparison", "by_don_chem_type", sep="_")
table_title <- "H-Bond chi Angle by Donor Chemical Type\nDistribution Comparison, B-Factor < 30"
save_tables(self,
	comp_stats, table_id, sample_sources, output_dir, output_formats,
	caption=table_title, caption.placement="top")

comp_stats <- comparison_statistics(
	sample_sources, f, c("acc_chem_type_name"), "chi", tests)
table_id <- paste("chi_chem_type_comparison", "by_acc_chem_type", sep="_")
table_title <- "H-Bond chi Angle by Acceptor Chemical Type\nDistribution Comparison, B-Factor < 30"
save_tables(self,
	comp_stats, table_id, sample_sources, output_dir, output_formats,
	caption=table_title, caption.placement="top")

comp_stats <- comparison_statistics(
	sample_sources, f, c("acc_hybrid"), "chi", tests)
table_id <- paste("chi_chem_type_comparison", "by_acc_hybrid", sep="_")
table_title <- "H-Bond chi Angle by Acceptor Hybrid\nDistribution Comparison, B-Factor < 30"
save_tables(self,
	comp_stats, table_id, sample_sources, output_dir, output_formats,
	caption=table_title, caption.placement="top")
...
comp_stats <- comparison_statistics(
	sample_sources, f, c("don_chem_type_name", "acc_chem_type_name"), "chi", tests)
table_id <- paste("chi_chem_type_comparison", "by_don_chem_type_acc_chem_type", sep="_")
table_title <- "H-Bond chi Angle by Donor and Acceptor Chemical Types\nDistribution Comparison, B-Factor < 30"
save_tables(self,
	comp_stats, table_id, sample_sources, output_dir, output_formats,
	caption=table_title, caption.placement="top")

...
comp_stats <- comparison_statistics(
	sample_sources, f, c(), "AHD", tests)
table_id <- "AHD_chem_type_comparison"
table_title <- "H-Bond AHD Angle Distribution Comparison, B-Factor < 30"
save_tables(self,
	comp_stats, table_id,
...
comp_stats <- comparison_statistics(
	sample_sources, f, c("don_chem_type_name"), "AHD", tests)
table_id <- paste("AHD_chem_type_comparison", "by_don_chem_type", sep="_")
table_title <- "H-Bond AHD Angle by Donor Chemical Type\nDistribution Comparison, B-Factor < 30"
save_tables(self,
	comp_stats, table_id, sample_sources, output_dir, output_formats,
	caption=table_title, caption.placement="top")

comp_stats <- comparison_statistics(
	sample_sources, f, c("acc_chem_type_name"), "AHD", tests)
table_id <- paste("AHD_chem_type_comparison", "by_acc_chem_type", sep="_")
table_title <- "H-Bond AHD Angle by Acceptor Chemical Type\nDistribution Comparison, B-Factor < 30"
save_tables(self,
	comp_stats, table_id, sample_sources, output_dir, output_formats,
	caption=table_title, caption.placement="top")

comp_stats <- comparison_statistics(
	sample_sources, f, c("acc_hybrid"), "AHD", tests)
table_id <- paste("AHD_chem_type_comparison", "by_acc_hybrid", sep="_")
table_title <- "H-Bond AHD Angle by Acceptor Hybrid\nDistribution Comparison, B-Factor < 30"
save_tables(self,
	comp_stats, table_id, sample_sources, output_dir, output_formats,
	caption=table_title, caption.placement="top")

comp_stats <- comparison_statistics(
	sample_sources, f, c("don_chem_type_name", "acc_chem_type_name"), "AHD", tests)
table_id <- paste("AHD_chem_type_comparison", "by_don_chem_type_acc_chem_type", sep="_")
table_title <- "H-Bond AHD Angle by Donor and Acceptor Chemical Types\nDistribution Comparison, B-Factor < 30"
save_tables(self,
	comp_stats, table_id, sample_sources, output_dir, output_formats,
	caption=table_title, caption.placement="top")

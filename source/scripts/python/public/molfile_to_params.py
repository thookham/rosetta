...
def write_ligand_kinemage(f, molfile): #{{{
    ...
    f.close()
#}}}
def write_param_file(f, molfile, name, frag_id, base_confs, max_confs, amino_acid=None,long_names=False,conformer_file=""): #{{{
    ...
    if conformer_file and os.path.exists(conformer_file):
        f.write("PDB_ROTAMERS %s\n" % conformer_file)
    #

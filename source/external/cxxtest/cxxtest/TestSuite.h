...
/// TS_ASSERT_FILE_EQ
#   define ___ETS_ASSERT_FILE_EQ(f,l,x,y,m) CxxTest::doAssertFileEQ( (f), (l), #x, (x), #y, (y), (m) )
#   define ___TS_ASSERT_FILE_EQ(f,l,x,y,m) { _TS_TRY { ___ETS_ASSERT_FILE_EQ(f,l,x,y,m); } __TS_CATCH(f,l) }

#   define _ETS_ASSERT_FILE_EQ(f,l,x,y) ___ETS_ASSERT_FILE_EQ(f,l,x,y,0)
#   define _TS_ASSERT_FILE_EQ(f,l,x,y) ___TS_ASSERT_FILE_EQ(f,l,x,y,0)

#   define ETS_ASSERT_FILE_EQ(x,y) _ETS_ASSERT_FILE_EQ(__FILE__,__LINE__,x,y)
#   define TS_ASSERT_FILE_EQ(x,y) _TS_ASSERT_FILE_EQ(__FILE__,__LINE__,x,y)

#   define _ETSM_ASSERT_FILE_EQ(f,l,m,x,y) ___ETS_ASSERT_FILE_EQ(f,l,x,y,TS_AS_STRING(m))
#   define _TSM_ASSERT_FILE_EQ(f,l,m,x,y) ___TS_ASSERT_FILE_EQ(f,l,x,y,TS_AS_STRING(m))
...
//                         double abs_p, double rel_p,
//                         const char *message )
#   define ___ETS_ASSERT_FILE_EQ_AS_DOUBLE(f,l,x,y, ap,rp, m) CxxTest::doAssertFileEQ_AsDouble( (f), (l), #x, (x), #y, (y),  (ap),(rp), (m) )
#   define ___TS_ASSERT_FILE_EQ_AS_DOUBLE(f,l,x,y, ap,rp, m) { _TS_TRY { ___ETS_ASSERT_FILE_EQ_AS_DOUBLE(f,l,x,y, ap,rp, m); } __TS_CATCH(f,l) }

#   define _ETS_ASSERT_FILE_EQ_AS_DOUBLE(f,l,x,y, ap,rp) ___ETS_ASSERT_FILE_EQ_AS_DOUBLE(f,l,x,y, ap,rp, 0)
#   define _TS_ASSERT_FILE_EQ_AS_DOUBLE(f,l,x,y, ap,rp) ___TS_ASSERT_FILE_EQ_AS_DOUBLE(f,l,x,y, ap,rp, 0)

#   define ETS_ASSERT_FILE_EQ_AS_DOUBLE(x,y, ap,rp) _ETS_ASSERT_FILE_EQ_AS_DOUBLE(__FILE__,__LINE__,x,y, ap,rp )
#   define TS_ASSERT_FILE_EQ_AS_DOUBLE(x,y, ap,rp) _TS_ASSERT_FILE_EQ_AS_DOUBLE(__FILE__,__LINE__,x,y, ap,rp )

#   define _ETSM_ASSERT_FILE_EQ_AS_DOUBLE(f,l,m,x,y, ap,rp) ___ETS_ASSERT_FILE_EQ_AS_DOUBLE(f,l,x,y, ap,rp, TS_AS_STRING(m))
#   define _TSM_ASSERT_FILE_EQ_AS_DOUBLE(f,l,m,x,y, ap,rp) ___TS_ASSERT_FILE_EQ_AS_DOUBLE(f,l,x,y, ap,rp, TS_AS_STRING(m))

#   define ETSM_ASSERT_FILE_EQ_AS_DOUBLE(m,x,y, ap,rp) _ETSM_ASSERT_FILE_EQ_AS_DOUBLE(__FILE__,__LINE__,m,x,y, ap,rp )
#   define TSM_ASSERT_FILE_EQ_AS_DOUBLE(m,x,y, ap,rp) _TSM_ASSERT_FILE_EQ_AS_DOUBLE(__FILE__,__LINE__,m,x,y, ap,rp )

 ...
 */
#ifndef NDARRAY_EIGEN_BP_Matrix_h_INCLUDED
#define NDARRAY_EIGEN_BP_Matrix_h_INCLUDED
...
class ToBoostPython< Eigen::Matrix<Scalar,Rows,Cols,Options,MaxRows,MaxCols> > {
public:

    typedef Eigen::Matrix<Scalar,Rows,Cols,Options,MaxRows,MaxCols> Input;
...
template <typename Scalar, int Rows, int Cols, int Options, int MaxRows, int  MaxCols>
class FromBoostPython< Eigen::Matrix<Scalar,Rows,Cols,Options,MaxRows,MaxCols> > {
public:

    typedef Eigen::Matrix<Scalar,Rows,Cols,Options,MaxRows,MaxCols> Output;

...
public:
	...
	/// @brief Test erase_index
	void test_vectorL_erase_index() {
		utility::vectorL< 10, int >  v10 = {1,2,3,4,5};
		v10.erase_index(12);
		TS_ASSERT_EQUALS( v10.size(), 4 );
		utility::vectorL< 10, int >  v10_ref = {1,2,4,5};
		TS_ASSERT_EQUALS( v10, v10_ref );

		utility::vectorL< 0, int >  v0 = {1,2,3,4,5};
		v0.erase_index(4);
		TS_ASSERT_EQUALS( v0.size(), 4 );
		utility::vectorL< 0, int > v0_ref = {1,2,3,4};
		TS_ASSERT_EQUALS( v0, v0_ref );

		utility::vectorL< 1, int >  v1 = {1,2,3,4,5};
		v1.erase_index(1); // {2,3,4,5}
		v1.erase_index(4);
		TS_ASSERT_EQUALS( v1.size(), 3 );
		utility::vectorL< 1, int >  v1_ref = {2,3,4};
		TS_ASSERT_EQUALS( v1, v1_ref );
	}

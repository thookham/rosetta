...
/// @file   core/io/pose_from_sfr/chirality_resolution.cxxtest.hh
/// @brief  test suite for functions associated with core/io/pose_from_sfr/chirality_resolution.hh
...
core::io::ResidueInformation create_ResidueInfo( std::string const & instring ) {
	import_pose::ImportPoseOptions options; //default options
	StructFileRep sfr( create_sfr_from_pdb_file_contents( instring, options ) );

...
/// @file   core/select/jump_selector/DummySelectors.hh
/// @brief  Two simple derived JumpSelectors to aid in unit testing
/// @author Andrew Leaver-Fay (aleaverfay@gmail.com)

#ifndef INCLUDED_test_core_pack_task_jump_selector_DummySelectors_HH
#define INCLUDED_test_core_pack_task_jump_selector_DummySelectors_HH
...
class XModYJumpSelector : public JumpSelector {
public:
	XModYJumpSelector( core::Size x, core::Size y ) :
		x_( x ),
		y_( y )
	{}

	XModYJumpSelector(XModYJumpSelector const &src):
		x_( src.x_ ),
		y_( src.y_ )
	{}
	...
	virtual
	JumpSubset apply( core::pose::Pose const & pose ) const
	{
		JumpSubset subset( pose.num_jump(), false );

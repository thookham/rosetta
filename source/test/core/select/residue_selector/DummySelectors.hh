...
public:
	...
	ResidueSelectorOP clone() const { return utility::pointer::make_shared< OddResidueSelector >(*this); }
...
public:
	...
	ResidueSelectorOP clone() const { return utility::pointer::make_shared< XModYResidueSelector >(*this); }

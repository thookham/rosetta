...
/// @file   core/select/residue_selector/InterGroupInterfaceByVectorSelector.cxxtest.hh
/// @brief  test suite for core::select::residue_selector::InterGroupInterfaceByVectorSelector
...
#include <iostream> // AUTO IWYU For operator<<, basic_ostream
...
public:
	...
	gold_result( core::pose::Pose const & pose ) {
		...
		return core::select::util::calc_interacting_vector(

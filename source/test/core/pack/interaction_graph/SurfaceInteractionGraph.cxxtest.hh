...
#include <core/scoring/Energies.hh> // MANUAL IWYU
...
public:
	...
	void initialize_suite() {
		...
		annealer = annealer::AnnealerFactory::create_annealer(
			pose, designtask, rot_to_pack, bestrotamer_at_seqpos, bestenergy, start_with_current, utility::pointer::dynamic_pointer_cast<interaction_graph::AnnealableGraphBase>(pdsig), rotsets, current_rot_index, calc_rot_freq, rot_freq );
...
public:
	...
	void x_test_partial_redesign_using_linmem_ig() {
		...
		annealer::SimAnnealerBaseOP redesign_annealer = annealer::AnnealerFactory::create_annealer(
			pose, designtask, rot_to_pack, bestrotamer_at_seqpos, bestenergy, start_with_current, utility::pointer::dynamic_pointer_cast<interaction_graph::AnnealableGraphBase>(lmsolig),

...
public:
	...
	void test_symm_minimalist_ig() {
		...
		pose.add_constraint( utility::pointer::make_shared< core::scoring::constraints::AtomPairConstraint >( core::id::AtomID( 4, 11 ), core::id::AtomID( 4, 12 ), utility::pointer::make_shared< core::scoring::func::HarmonicFunc >( 5.0, 1.0 )));

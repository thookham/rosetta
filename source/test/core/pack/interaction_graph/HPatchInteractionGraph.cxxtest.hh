...
public:
	...
	void initialize_suite() {
		...
		pdhig = utility::pointer::make_shared< interaction_graph::PDHPatchInteractionGraph >( designtask->num_to_be_packed() );
		pdhig->set_pose( pose );
...
public:
	...
	void test_partial_redesign_using_linmem_ig() {
		...
		lmhig = utility::pointer::make_shared< interaction_graph::LinearMemoryHPatchInteractionGraph >( designtask->num_to_be_packed() );
		lmhig->set_pose( pose );

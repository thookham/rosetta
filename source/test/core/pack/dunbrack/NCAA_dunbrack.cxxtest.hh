...
/// @file   test/core/pack/dunbrack/NCAA_dunbrack.cxxtest.hh
/// @brief  Test suite for loading custom noncanonical rotamer libraries.
...
class NCAADunbrackTests : public CxxTest::TestSuite {
...
public:
	...
	void test_score_with_ncaa()
	{
		...
		TR << "Completed NCAADunbrackTests:test_score_with_ncaa()." << std::endl;
	}

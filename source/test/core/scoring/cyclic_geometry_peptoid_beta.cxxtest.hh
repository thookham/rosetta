...
/// @brief Unit tests for cyclic peptide pose scoring, with the current beta scorefunction (beta_nov16 when this test was written) and peptoid residues.
...
static basic::Tracer TR("core.scoring.CyclicGeometry_peptoid_beta_Tests.cxxtest");

class CyclicGeometry_peptoid_beta_Tests : public CxxTest::TestSuite {

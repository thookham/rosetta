...
/// @file test/core/scoring/SymmDL_beta.cxxtest.hh
...
static basic::Tracer TR("core.scoring.SymmDL_beta_Tests.cxxtest");

class SymmDL_beta_Tests : public CxxTest::TestSuite {
...
public:
	...
	/// @author Vikram K. Mulligan (vmullig@uw.edu)
	void test_symm_DL_beta_default_scorefxn() {
		//Set up the scorefunction

...
/// @file   core/scoring/constaints/SumFunc.hh.cxxtest.hh
/// @brief  test suite for SumFunc
/// @author Andrew Leaver-Fay (aleaverfay@gmail.com)

// Test headers
#include <cxxtest/TestSuite.h>

#include <core/scoring/func/SumFunc.hh> // DO NOT AUTO-REMOVE
...
class SumFuncTests : public CxxTest::TestSuite
{
public:


	void test_serialize_SumFunc() {
		...
		// make sure the deserialized base class pointer points to a SumFunc
		TS_ASSERT( utility::pointer::dynamic_pointer_cast< SumFunc > ( instance2 ));

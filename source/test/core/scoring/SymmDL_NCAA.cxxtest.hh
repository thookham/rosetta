...
/// @file test/core/scoring/SymmDL_NCAA.cxxtest.hh
/// @brief Unit tests for symmetric pose scoring with the --symmetric_gly_tables option and noncanonicals.
...
static basic::Tracer TR("core.scoring.SymmDL_NCAATests.cxxtest");

class SymmDL_NCAATests : public CxxTest::TestSuite {

...
/// @file test/core/scoring/SymmDLMin_peptoid.cxxtest.hh
/// @brief Unit tests for minimiziation of mirror-image poses with the --symmetric_gly_tables option and peptoids.
...
static basic::Tracer TR("core.scoring.SymmDLMin_peptoid_Tests.cxxtest");

class SymmDLMin_peptoid_Tests : public CxxTest::TestSuite {

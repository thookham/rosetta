...
/// @brief Unit tests for cyclic peptide pose scoring with 2 chains in the peptide and the current default score function (ref2015 when
/// this test was written), with peptoid residues.
...
static basic::Tracer TR("core.scoring.CyclicGeometry_peptoid_TwoChainTests.cxxtest");

class CyclicGeometry_peptoid_TwoChainTests : public CxxTest::TestSuite {

...
/// @file test/core/scoring/SymmDLMin_beta.cxxtest.hh
...
static basic::Tracer TR("core.scoring.SymmDLMin_beta_Tests.cxxtest");

class SymmDLMin_beta_Tests : public CxxTest::TestSuite {

...
/// @file   test/core/energy_methods/ProClosureEnergy.cxxtest.hh
...
public:
	...
	void test_eval_energy()
	{
		...
		*/
		...
		}
		{
			...
			TS_ASSERT_DELTA( emap[ cart_bonded ], 1.578362520553334, 1e-12 );
		}
	...
	void test_cartbonded_start_score_start_func_match_w_total_flexibility()
	{
		...
		adv.validate_start_func_matches_start_score( 30.81905264781152, false );
	}

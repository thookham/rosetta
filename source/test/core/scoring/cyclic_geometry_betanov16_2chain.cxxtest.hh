...
/// @file test/core/scoring/cyclic_geometry_betanov16_2chain.cxxtest.hh
/// @brief Unit tests for cyclic peptide pose scoring with 2 chains in the peptide and the beta_nov16 score function.
...
static basic::Tracer TR("core.scoring.CyclicGeometry_betanov16_Tests.cxxtest");

class CyclicGeometry_betanov16_TwoChainTests : public CxxTest::TestSuite {

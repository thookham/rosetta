...
/// @file  core/scoring/RamaPrePro_util.hh
/// @brief  Utilities for the RamaPrePro energy tests
/// @author Vikram K. Mulligan (vmullig@u.washington.edu)

#ifndef INCLUDED_test_core_scoring_RamaPrePro_util_hh
#define INCLUDED_test_core_scoring_RamaPrePro_util_hh

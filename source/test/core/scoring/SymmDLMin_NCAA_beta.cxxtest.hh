...
/// @file test/core/scoring/SymmDLMin_NCAA_beta.cxxtest.hh
/// @brief Unit tests for minimiziation of mirror-image poses with the --symmetric_gly_tables option and noncanonicals.  This test
/// tests the beta scorefunction.
...
static basic::Tracer TR("core.scoring.SymmDLMin_NCAA_betaTests.cxxtest");

class SymmDLMin_NCAA_betaTests : public CxxTest::TestSuite {
...
public:
	...
	/// @author Vikram K. Mulligan (vmullig@uw.edu)
	void test_symm_DL_min_current_beta_default_scorefxn() {
		//Set up the scorefunction
		core::scoring::ScoreFunctionOP scorefxn( core::scoring::get_score_function() );
		TR << "Testing full beta (default) score function." << std::endl;
		mirror_pose_test(scorefxn, false);
		return;
	}

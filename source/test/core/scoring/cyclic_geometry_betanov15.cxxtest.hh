...
public:
	...
	void setUp() {
		core_init_with_additional_options( "-score:weights beta_nov15.wts -symmetric_gly_tables true -write_all_connect_info -connect_info_cutoff 0.0 -output_virtual true" );

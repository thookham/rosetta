...
/// @file test/core/scoring/cyclic_geometry_nmethyl_2chain.cxxtest.hh
/// @brief Unit tests for cyclic peptide pose scoring with 2 chains in the peptide, with N-methylation.
...
static basic::Tracer TR("core.scoring.CyclicGeometryTwoChain_nmethyl_Tests.cxxtest");

class CyclicGeometryTwoChain_nmethyl_Tests : public CxxTest::TestSuite {

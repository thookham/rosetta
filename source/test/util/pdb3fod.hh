...
/// @file   test/util/pdb3fod.hh
/// @brief  create an eight chain pose
/// @author Kyle Barlow (kb@kylebarlow.com)

#ifndef INCLUDED_util_pdb3fod_HH
#define INCLUDED_util_pdb3fod_HH
...
pdb3fod_pose()
{
	return fullatom_pose_from_string( pdb3fod() );
}
...
pdb3fod_poseop()
{
	return fullatom_poseop_from_string( pdb3fod() );
}

...
/// @file   numeric/numeric.cxxtest.hh
/// @brief  numeric.cxxtest: placeholder for main() function when creating unit test executable
/// @author Ron Jacak (ron.jacak@gmail.com)


#ifndef INCLUDED_numeric_numeric_cxxtest_HH
#define INCLUDED_numeric_numeric_cxxtest_HH

...
static basic::Tracer TR("GeneralizedKIC_Tests_ramaprepro_NCAA");


// --------------- Test Class --------------- //

class GeneralizedKIC_Tests_ramaprepro_NCAA : public CxxTest::TestSuite {
...
public:
	...
	/// @brief Test GeneralizedKIC randomizing using RamaPrePro tables, for a noncanonical L-amino
	/// acid that is not adjacent to a proline.
	void test_GeneralizedKIC_ramaprepro_perturbation_noncanonical() {
		do_ramaprepro_test( "AAAAWAAAAAAAAAA", 5, true, false );
	}

	/// @brief Test GeneralizedKIC randomizing using RamaPrePro tables, for a noncanonical D-amino
	/// acid that is not adjacent to a proline.
	void test_GeneralizedKIC_ramaprepro_perturbation_noncanonical_D() {
		do_ramaprepro_test( "AAAAWAAAAAAAAAA", 5, true, true );
	}

	/// @brief Test GeneralizedKIC randomizing using RamaPrePro tables, for a noncanonical L-amino
	/// acid that is adjacent to a proline.
	void test_GeneralizedKIC_ramaprepro_perturbation_noncanonical_beforepro() {
		do_ramaprepro_test( "AAAAWPAAAAAAAAA", 5, true, false );
	}

	/// @brief Test GeneralizedKIC randomizing using RamaPrePro tables, for a noncanonical D-amino
	/// acid that is adjacent to a proline.
	void test_GeneralizedKIC_ramaprepro_perturbation_noncanonical_D_beforepro() {
		do_ramaprepro_test( "AAAAWPAAAAAAAAA", 5, true, true );
	}

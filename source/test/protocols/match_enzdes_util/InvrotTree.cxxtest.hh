...
public:
	...
	void setUp() {
		...
		protocols_init_with_additional_options("-run::preserve_header -extra_res_fa protocols/match_enzdes_util/1n1.params");
		/*
	...
	void test_invrot_tree()
	{
		...
		tim_pose.append_residue_by_jump( *ligres, tim_pose.size() );
		...
		TS_ASSERT_DELTA(1194.8835,  tim_pose.energies().total_energies()[ core::scoring::coordinate_constraint ], 1e-2 );

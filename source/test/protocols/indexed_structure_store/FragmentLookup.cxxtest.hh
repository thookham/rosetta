...
/// @file protocols/indexed_structure_store/FragmentLookup.cxxtest.hh
/// @brief Test suite for protocols/indexed_structure_store/FragmentLookup
...
public:
	...
	void test_read_store()
	{
		...
		FragmentLookupOP full_lookup = FragmentStoreManager::get_instance()->load_fragment_lookup(
			"full_test_fragments", "protocols/indexed_structure_store/test_store");
		FragmentLookupOP partial_lookup = FragmentStoreManager::get_instance()->load_fragment_lookup(
			"partial_test_fragments", "protocols/indexed_structure_store/test_store");

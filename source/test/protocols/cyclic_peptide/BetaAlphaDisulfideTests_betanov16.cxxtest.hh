...
/// @file  protocols/cyclic_peptide/BetaAlphaDisulfideTests_betanov16.cxxtest.hh
...
static basic::Tracer TR("protocols.cyclic_peptide.BetaAlphaDisulfide_betanov16_Tests");

class BetaAlphaDisulfide_betanov16_Tests : public CxxTest::TestSuite {

public:

	void setUp(){
		core_init_with_additional_options("-write_all_connect_info -beta_nov16");
	}

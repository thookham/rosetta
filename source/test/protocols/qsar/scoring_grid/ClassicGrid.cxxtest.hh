...
/// @file   qsar/scoring_grid/ClassicGrid.cxxtest.hh
/// @brief  test suite for ClassicGrid setup and scoring
...
static basic::Tracer TR("protocols.qsar.scoring_grid.ClassicGrid.cxxtest");

class ClassicGridTests : public CxxTest::TestSuite {
public:
	...
	void test_score_function() {
		...
		std::string xmlfile = " <ClassicGrid grid_name=classic/>\n";

...
/// @file   protocols/task_operations/ProteinInterfaceDesignOperation.cxxtest.hh
...
public:
	...
	void test_ProteinInterfaceDesignOperation_all() {
		...
		test::UTracer UT_PID("protocols/task_operations/ProteinInterfaceDesignOperation_all.u");
		UT_PID << *(PID_factory.create_task_and_apply_taskoperations( *pose ) ) << std::endl;

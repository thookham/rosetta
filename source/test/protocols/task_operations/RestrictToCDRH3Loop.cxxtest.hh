...
/// @file   protocols/task_operations/RestrictNonSurfaceToRepackingOperation.cxxtest.hh
...
public:
	...
	void test_RestrictToCDRH3Loop() {
		...
		using protocols::task_operations::RestrictToCDRH3Loop;
		...
		tf.push_back( utility::pointer::make_shared< RestrictToCDRH3Loop >() );

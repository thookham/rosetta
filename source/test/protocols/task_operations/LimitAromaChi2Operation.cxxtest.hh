...
public: //typedef
	...
	typedef protocols::task_operations::LimitAromaChi2Operation LimitAromaChi2Operation;
	typedef protocols::task_operations::LimitAromaChi2OperationOP LimitAromaChi2OperationOP;

...
/// @file   protocols/task_operations/RestrictToInterfaceOperation.cxxtest.hh
...
#include <protocols/task_operations/RestrictInterGroupVectorOperation.hh>
...
public:
	...
	void test_RestrictToInterfaceVectorOperation(){
		...
		//set up test
		using namespace core::pack::task;
		using protocols::task_operations::RestrictToInterfaceVectorOperation;
		using core::pack::task::operation::TaskOperationCOP;
		...
		test::UTracer UT_RTIVO2("protocols/task_operations/RestrictToInterfaceVectorOperation.u");
		RTIVO_factory.clear();
	...
	void test_RestrictInterGroupVectorOperation(){
		//set up test
		using namespace core::pack::task;
		using protocols::task_operations::RestrictInterGroupVectorOperation;
		using core::pack::task::operation::TaskOperationCOP;
		TaskFactory RIGV_factory;
		test::UTracer UT_RIGV("protocols/task_operations/RestrictInterGroupVector.u");
		//make a few groups
	...
	void test_RestrictToMoveMapChiOperation() {
		...
		task->show(TR);
		test::UTracer UT_MMNEI("protocols/task_operations/RestrictToMoveMapChiWNeighbors.u");

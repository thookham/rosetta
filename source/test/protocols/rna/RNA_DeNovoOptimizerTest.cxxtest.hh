...
/// @file  protocols/rna/denovo//RNA_DeNovoOptimizerTest.cxxtest.hh
/// @brief  test RNA_DeNovoOptimizer, wrapper for calling FARNA inside stepwise
...
public:
	...
	void setUp(){
		core_init_with_additional_options( "-s protocols/rna/srl_fixed_START1_1q9a_RNA.pdb -terminal_res  A:651 A:669  -extra_min_res  A:652 A:658 A:663 A:668  -jump_res  A:651 A:669 A:652 A:668 A:658 A:663 A:659 A:662  -cutpoint_closed  A:651 A:658-659  -fasta protocols/rna/farna_rebuild.fasta" );
	}
	...
	void test_sarcin_ricin_loop_buildup(){
		...
		Pose start_pose = pose;
		{
			...
			RNA_DeNovoOptimizer farna_optimizer( pose_list, lores_scorefxn, 5 /* cycles */ );

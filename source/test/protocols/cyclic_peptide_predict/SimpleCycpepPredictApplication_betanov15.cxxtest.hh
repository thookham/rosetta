...
/// @file   protocols/cyclic_peptide_predict/SimpleCycpepPredictApplication_betanov15.cxxtest.hh.
/// @brief  Unit tests for the simple_cycpep_predict application with the beta_nov15 scorefunction.
...
class SimpleCycpepPredictApplication_betanov15_Tests : public CxxTest::TestSuite {

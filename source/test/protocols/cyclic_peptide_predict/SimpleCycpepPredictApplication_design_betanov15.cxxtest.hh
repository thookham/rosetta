...
class SimpleCycpepPredictApplication_design_betanov15_Tests : public CxxTest::TestSuite {
...
public:
	...
	void test_simple_cycpep_predict() {
		TR << "Running SimpleCycpepPredictApplication_design_betanov15_Tests::test_simple_cycpep_predict()." << std::endl;
	...
	void test_simple_cycpep_predict_withfile() {
		TR << "Running SimpleCycpepPredictApplication_design_betanov15_Tests::test_simple_cycpep_predict_withfile()." << std::endl;
		TR << "This simply runs the SimpleCycpepPredictApplication in design mode and checks for crashes." << std::endl;
		TR << "For questions, contact Vikram K. Mulligan (vmullig@uw.edu)." << std::endl;

...
#ifndef INCLUDED_devel_replica_docking_CaIrmsdFilter_hh
#define INCLUDED_devel_replica_docking_CaIrmsdFilter_hh

#include <devel/replica_docking/CaIrmsdFilter.fwd.hh>
...
class CaIrmsdFilter : public protocols::filters::Filter
{
public:
	CaIrmsdFilter();
	CaIrmsdFilter( core::scoring::ScoreFunctionOP sfxn, core::Size const rb_jump=1, core::Real const lower_threshold=0, core::Real const upper_threshold=9999 );

...
#ifndef INCLUDED_devel_replica_docking_FnonnatFilter_hh
#define INCLUDED_devel_replica_docking_FnonnatFilter_hh
...
class FnonnatFilter : public protocols::filters::Filter
{
public:
	FnonnatFilter();
	FnonnatFilter( core::scoring::ScoreFunctionOP sfxn, core::Size const rb_jump=1, core::Real const lower_threshold=0, core::Real const upper_threshold=1 );
...
private:
	...
	mutable std::string native_contacts_;

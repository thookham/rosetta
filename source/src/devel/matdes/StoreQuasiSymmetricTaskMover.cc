...
static basic::Tracer TR( "devel.matdes.StoreQuasiSymmetricTaskMover" );
...
void
StoreQuasiSymmetricTaskMover::parse_my_tag( TagCOP const tag, basic::datacache::DataMap & data_map )
{

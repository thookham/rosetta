...
/// @file protocols/splice/AddFoldUnitMoverCreator.hh
/// @brief This class will create instances of protocols::moves::Mover AddFoldUnitMover for the protocols::moves::MoverFactory

#ifndef INCLUDED_protocols_splice_AddFoldUnitMoverCreator_hh
#define INCLUDED_protocols_splice_AddFoldUnitMoverCreator_hh

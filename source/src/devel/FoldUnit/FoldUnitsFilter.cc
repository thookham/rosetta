...
//Unit Headers
#include <protocols/splice/FoldUnitsFilter.hh>
#include <protocols/splice/FoldUnitsFilterCreator.hh>
...
void
FoldUnitsFilter::parse_my_tag( utility::tag::TagCOP tag, basic::datacache::DataMap & )
{

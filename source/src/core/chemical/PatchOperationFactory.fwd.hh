...
/// @file   core/chemical/PatchOperationFactory.fwd.hh
/// @brief
/// @author Rocco Moretti (rmorettiase@gmail.com)

#ifndef INCLUDED_core_chemical_PatchOperationFactory_fwd_hh
#define INCLUDED_core_chemical_PatchOperationFactory_fwd_hh

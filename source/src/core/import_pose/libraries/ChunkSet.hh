...
/// @file core/import_pose/libraries/ChunkSet.hh
/// @brief
/// @details
...
public:
	...
	void
	insert_protein_chunk_into_pose( core::pose::Pose & pose, Size const & chunk_pose_index, core::pose::toolbox::AtomLevelDomainMapCOP atom_level_domain_map,
		bool do_rosetta_library_domain_check = true ) const;
...
private:
	...
	get_atom_id_domain_map_for_rosetta_library_chunk(
		...
		core::pose::Pose const & pose, core::pose::toolbox::AtomLevelDomainMap const & atom_level_domain_map,
		bool do_rosetta_library_domain_check = true ) const;

...
#ifndef INCLUDED_core_import_pose_RNA_JumpLibrary_HH
#define INCLUDED_core_import_pose_RNA_JumpLibrary_HH
...
public:
	...
	bool
	has_template( BasePairType const & base_pair_type ) const;

	RNA_PairingTemplateList const &
	rna_pairing_template_map( BasePairType const & base_pair_type) const;

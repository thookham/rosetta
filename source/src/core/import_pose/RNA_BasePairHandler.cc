...
/// @file core/import_pose/RNA_BasePairHandler.cc
/// @brief
/// @details
...
static basic::Tracer TR( "core.import_pose.RNA_BasePairHandler" );
...
RNA_BasePairHandler::RNA_BasePairHandler( core::import_pose::RNA_DeNovoParameters const & rna_params )
{
	...
	Real const suppress_bp_constraint /* = 1.0 */ ) const
{
	...
	core::pose::rna::setup_base_pair_constraints( pose, pairings, suppress_bp_constraint );
}

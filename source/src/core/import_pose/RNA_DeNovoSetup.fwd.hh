...
/// @file core/import_pose/RNA_DeNovoSetup.fwd.hh
/// @brief
/// @detailed
/// @author Rhiju Das, rhiju@stanford.edu


#ifndef INCLUDED_core_import_pose_RNA_DeNovoSetup_FWD_HH
#define INCLUDED_core_import_pose_RNA_DeNovoSetup_FWD_HH

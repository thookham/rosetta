...
ScoreFileSilentStruct::ScoreFileSilentStruct( SilentFileOptions const & opts ) :
	SilentStruct( opts )
{
	decoy_tag( "empty_tag" );
}
...
ScoreFileSilentStruct::ScoreFileSilentStruct(
	...
	SilentStruct( opts )
{
	ScoreFileSilentStruct::fill_struct( pose, tag ); // Virtual dispatch doesn't work fully in constructor
	decoy_tag( tag );

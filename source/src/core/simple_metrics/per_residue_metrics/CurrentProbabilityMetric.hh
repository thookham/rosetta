...
/// @file core/simple_metrics/per_residue_metrics/CurrentProbabilityMetric.hh
...
#ifndef INCLUDED_core_simple_metrics_per_residue_metrics_CurrentProbabilityMetric_HH
#define INCLUDED_core_simple_metrics_per_residue_metrics_CurrentProbabilityMetric_HH

#include <core/simple_metrics/per_residue_metrics/CurrentProbabilityMetric.fwd.hh>
...
class CurrentProbabilityMetric : public core::simple_metrics::PerResidueRealMetric{
...
public:
	...
	CurrentProbabilityMetric(core::simple_metrics::PerResidueProbabilitiesMetricCOP metric );

	/// @brief Copy constructor (not needed unless you need deep copies)
	CurrentProbabilityMetric(CurrentProbabilityMetric const & src );

	/// @brief Destructor (important for properly forward-declaring smart-pointer members)
	~CurrentProbabilityMetric() override;
...
public:
	...
	static std::map<core::Size, core::Real> get_current_probabilities( std::map<core::Size, std::map<core::chemical::AA, core::Real>> const & values, core::pose::Pose const & pose ) ;
...
#ifdef    SERIALIZATION
CEREAL_FORCE_DYNAMIC_INIT( core_simple_metrics_per_residue_metrics_CurrentProbabilityMetric )
#endif // SERIALIZATION


#endif //INCLUDED_core_simple_metrics_per_residue_metrics_CurrentProbabilityMetric_HH

...
void
DihedralDistanceMetric::set_comparison_pose(PoseCOP pose){
	ref_pose_ = pose;
}
...
void
DihedralDistanceMetric::provide_citation_info(basic::citation_manager::CitationCollectionList & citations ) const {
	citations.add(

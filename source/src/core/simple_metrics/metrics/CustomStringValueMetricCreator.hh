...
/// @file core/simple_metrics/metrics/CustomStringValueMetricCreator.hh
/// @brief A simple metric that allows an arbitrary, user- or developer-set string to be cached in a pose.
/// @author Vikram K. Mulligan (vmulligan@flatironinstitute.org)

#ifndef INCLUDED_core_simple_metrics_metrics_CustomStringValueMetricCreator_HH
#define INCLUDED_core_simple_metrics_metrics_CustomStringValueMetricCreator_HH
...
class CustomStringValueMetricCreator : public core::simple_metrics::SimpleMetricCreator {
public:
...
#endif //INCLUDED_core_simple_metrics_metrics_CustomStringValueMetricCreator_HH

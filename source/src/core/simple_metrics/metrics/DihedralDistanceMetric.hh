...
#ifndef INCLUDED_core_simple_metrics_metrics_DihedralDistanceMetric_HH
#define INCLUDED_core_simple_metrics_metrics_DihedralDistanceMetric_HH
...
///@brief A metric to calculate the dihedral distance between two poses.  Can set a subset of residues to calculate via ResidueSelector.
///

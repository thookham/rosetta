...
/// @file core/simple_metrics/metrics/AverageProbabilitiesMetricCreator.hh
/// @brief A metric for averaging multiple PerResidueProbabilitiesMetrics
/// @author Moritz Ertelt (moritz.ertelt@googlemail.com)

#ifndef INCLUDED_core_simple_metrics_metrics_AverageProbabilitiesMetricCreator_HH
#define INCLUDED_core_simple_metrics_metrics_AverageProbabilitiesMetricCreator_HH
...
class AverageProbabilitiesMetricCreator : public core::simple_metrics::SimpleMetricCreator {
public:
...
#endif //INCLUDED_core_simple_metrics_metrics_AverageProbabilitiesMetricCreator_HH

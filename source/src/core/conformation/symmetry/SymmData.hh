...
private:
	...
	std::map< core::Size, WtedClones > jump_clones_;
	std::map< core::Size, SymDof > dofs_;
	std::vector< core::Size > allow_virtual_;
	utility::vector1< core::Size > score_multiply_subunit_;

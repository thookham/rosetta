...
/// @file   core/conformation/parameters/SizeValuedParameter.hh
/// @brief  Prototypes and method declarations for the SizeValuedParameter class, a class for holding a single core::Size-valued parameter for parametric backbone generation.
/// @author Vikram K. Mulligan (vmullig@uw.edu)


#ifndef INCLUDED_core_conformation_parametric_SizeValuedParameter_hh
#define INCLUDED_core_conformation_parametric_SizeValuedParameter_hh
...
/// @brief  SizeValuedParameter class, used to store a single core::Size-valued parameter for parametric backbone generation.
///
class SizeValuedParameter : public Parameter
{
public:
...
public: //Getters
	...
	inline core::Size value() const { return value_; }

	/// @brief Get the default value of this parameter.
	inline core::Size default_value() const { return default_value_; }

public: //Setters

	/// @brief Set the value of this parameter.
	void set_value( core::Size const value_in );
	...
	void set_default_value( core::Size const value_in );
...
private:
	...
	*********************************************************************************/
	...
	/// @brief Default value if value is not set.
	core::Size default_value_;
...
#ifdef    SERIALIZATION
CEREAL_FORCE_DYNAMIC_INIT( core_conformation_parametric_SizeValuedParameter )
#endif // SERIALIZATION

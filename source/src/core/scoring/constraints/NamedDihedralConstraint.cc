...
ConstraintOP
NamedDihedralConstraint::remap_resid(
	core::id::SequenceMapping const &seqmap
) const {
	if ( seqmap[named_atom1_.rsd()] !=0 && seqmap[named_atom2_.rsd()] !=0 && seqmap[named_atom3_.rsd()] !=0 && seqmap[named_atom4_.rsd()] !=0 ) {
		...
		core::id::NamedAtomID newat4( named_atom4_.atom(), seqmap[named_atom4_.rsd()] );
		NamedDihedralConstraintOP new_cst( new NamedDihedralConstraint( newat1, newat2, newat3, newat4, func()->clone(), score_type() ) );

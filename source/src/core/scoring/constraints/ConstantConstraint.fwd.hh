...
/// @file core/scoring/constraints/ConstantConstraint.fwd.hh

#ifndef INCLUDED_core_scoring_constraints_ConstantConstraint_FWD_hh
#define INCLUDED_core_scoring_constraints_ConstantConstraint_FWD_hh

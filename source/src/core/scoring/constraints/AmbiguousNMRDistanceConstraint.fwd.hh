...
#ifndef INCLUDED_core_scoring_constraints_AmbiguousNMRDistanceConstraint_fwd_hh
#define INCLUDED_core_scoring_constraints_AmbiguousNMRDistanceConstraint_fwd_hh

...
#ifndef INCLUDED_core_scoring_constraints_BackboneStubLinearConstraint_fwd_hh
#define INCLUDED_core_scoring_constraints_BackboneStubLinearConstraint_fwd_hh

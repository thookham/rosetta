...
/// @file   core/scoring/TenANeighborGraph.fwd.hh
/// @brief  Ten Angstrom Neighbor graph class forward declaration
/// @author Andrew Leaver-Fay (aleaverfay@gmail.com)

#ifndef INCLUDED_core_scoring_TenANeighborGraph_fwd_hh
#define INCLUDED_core_scoring_TenANeighborGraph_fwd_hh

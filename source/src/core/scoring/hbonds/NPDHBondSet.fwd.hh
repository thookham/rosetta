...
/// @file   core/scoring/hbonds/NPDHBondSet.fwd.hh
/// @brief  Hydrogen bond set for a pose forward declaration
/// @author Andrew Leaver-Fay (aleaverfay@gmail.com)


#ifndef INCLUDED_core_scoring_hbonds_NPDHBondSet_fwd_hh
#define INCLUDED_core_scoring_hbonds_NPDHBondSet_fwd_hh

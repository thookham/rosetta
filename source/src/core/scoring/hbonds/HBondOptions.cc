...
HBondOptions::append_schema_attributes( utility::tag::AttributeList & attributes )
{
	...
	attributes
		+ XMLSchemaAttribute( "exclude_DNA_DNA_hbond", xsct_rosetta_bool , "Do not score hydrogen bonds between DNA residues" )
		+ XMLSchemaAttribute( "use_hb_env_dep_DNA", xsct_rosetta_bool , "Enable environmental dependent weighting of hydrogen bonds involving DNA" )
		...
		+ XMLSchemaAttribute( "hbonds__exclude_self_hbonds", xsct_rosetta_bool , "Do not include intra-residue hydrogen bonds" )
		+ XMLSchemaAttribute( "hbonds__use_hb_env_dep", xsct_rosetta_bool , "Same as use_hb_env_dep" )
		+ XMLSchemaAttribute( "hbonds__smooth_hb_env_dep", xsct_rosetta_bool , "Same as smooth_hb_env_dep" )
		+ XMLSchemaAttribute( "hbonds__decompose_bb_hb_into_pair_energies", xsct_rosetta_bool , "Same as decompose_bb_hb_into_pair_energies" )
		+ XMLSchemaAttribute( "hbonds__exclude_intra_res_protein", xsct_rosetta_bool , "Do not include intra-residue protein hydrogen bonds" )
		+ XMLSchemaAttribute( "hbonds__exclude_intra_res_RNA", xsct_rosetta_bool , "exclude intra-residue RNA hydrogen bonds" )
		//+ XMLSchemaAttribute( "hbonds__put_intra_into_total", xsct_rosetta_bool , "XRW TO DO" )
		+ XMLSchemaAttribute( "hbonds__bb_donor_acceptor_check", xsct_rosetta_bool , "XRW TO DO" )
		+ XMLSchemaAttribute( "hbonds__params_database_tag", xs_string , "XRW TO DO" )
		+ XMLSchemaAttribute( "hbonds__use_sp2_chi_penalty", xsct_rosetta_bool , "XRW TO DO" )
		+ XMLSchemaAttribute( "hbonds__sp2_BAH180_rise", xsct_real , "XRW TO DO" )

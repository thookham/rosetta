...
FullatomDisulfidePotential::FullatomDisulfidePotential() :
	...
	cbsg_dihedral_func_( utility::pointer::make_shared< CBSG_Dihedral_Func >() ),
	sgsg_dihedral_func_( utility::pointer::make_shared< SGSG_Dihedral_Func >() ),
	cb_angle_func_( utility::pointer::make_shared< CB_Angle_Func >() ),
	sg_dist_func_( utility::pointer::make_shared< SG_Dist_Func >() ),
	wt_dihSS_(0.1),
	wt_dihCS_(0.1),
	wt_ang_(0.1),
	wt_len_(0.1),

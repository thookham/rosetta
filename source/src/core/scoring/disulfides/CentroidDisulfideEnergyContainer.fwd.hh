...
#ifndef INCLUDED_core_scoring_disulfides_CentroidDisulfideEnergyContainer_fwd_hh
#define INCLUDED_core_scoring_disulfides_CentroidDisulfideEnergyContainer_fwd_hh

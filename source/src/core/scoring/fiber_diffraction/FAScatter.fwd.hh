...
/// @file core/scoring/fiber_diffraction/FAScatter.fwd.hh
/// @brief Cache for scattering factors in all-atom mode
/// @author Wojciech Potrzebowski and Ingemar Andre

#ifndef INCLUDED_core_scoring_fiber_diffraction_FAScatter_fwd_hh
#define INCLUDED_core_scoring_fiber_diffraction_FAScatter_fwd_hh

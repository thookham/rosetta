...
ScoreTypeManager::setup_score_type_names()
{
	...
	name2score_type_[ "gen_bonded" ] = gen_bonded;
	name2score_type_[ "gen_bonded_bond" ] = gen_bonded_bond;
	name2score_type_[ "gen_bonded_angle" ] = gen_bonded_angle;
	name2score_type_[ "gen_bonded_torsion" ] = gen_bonded_torsion;
	name2score_type_[ "gen_bonded_improper" ] = gen_bonded_improper;
	...
	name2score_type_[ "motif_dock" ] = motif_dock;
	...
	name2score_type_[ "covalent_labeling" ] = covalent_labeling;
	...
	name2score_type_[ "fa_stack_rna_protein"]    = fa_stack_rna_protein;
	name2score_type_[ "fa_stack_rna_protein_aro"]    = fa_stack_rna_protein_aro;
	...
	name2score_type_[ "sap_constraint" ] = sap_constraint;

	name2score_type_[ "approximate_buried_unsat_penalty" ] = approximate_buried_unsat_penalty;

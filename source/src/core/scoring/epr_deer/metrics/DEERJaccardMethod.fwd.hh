...
/// @file    core/scoring/epr_deer/metrics/DEERJaccardMethod.fwd.hh
/// @brief   Container for scoring method for DEER distributions
/// @author   Diego del Alamo ( del.alamo@vanderbilt.edu )

#ifndef INCLUDED_core_scoring_epr_deer_metrics_DEERJaccardMethod_fwd_hh
#define INCLUDED_core_scoring_epr_deer_metrics_DEERJaccardMethod_fwd_hh

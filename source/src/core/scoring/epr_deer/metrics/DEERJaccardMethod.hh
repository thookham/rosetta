...
#ifndef INCLUDED_core_scoring_epr_deer_metrics_DEERJaccardMethod_hh
#define INCLUDED_core_scoring_epr_deer_metrics_DEERJaccardMethod_hh
...
class DEERJaccardMethod : public DEERDistanceDistribution {
public:

...
/// @file   core/scoring/HydroxylTorsionPotential.fwd.hh
/// @brief
/// @author

#ifndef INCLUDED_core_scoring_HydroxylTorsionPotential_fwd_hh
#define INCLUDED_core_scoring_HydroxylTorsionPotential_fwd_hh

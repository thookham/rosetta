...
/// @file core/scoring/methods/WholeStructureEnergy.fwd.hh
/// @brief EnergyMethod that applies to a whole structure and not on a residue-by-residue basis
/// @author Andrew Leaver-Fay


#ifndef INCLUDED_core_scoring_methods_WholeStructureEnergy_fwd_hh
#define INCLUDED_core_scoring_methods_WholeStructureEnergy_fwd_hh

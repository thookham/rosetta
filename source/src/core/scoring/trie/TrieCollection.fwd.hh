...
/// @file   core/scoring/trie/TrieCollection.fwd.hh
/// @brief
/// @author Andrew Leaver-Fay (aleaverfay@gmail.com)

#ifndef INCLUDED_core_scoring_trie_TrieCollection_fwd_hh
#define INCLUDED_core_scoring_trie_TrieCollection_fwd_hh

...
/// @file    core/scoring/nmr/rdc/RDCData.fwd.hh
/// @brief   forward declaration for RDCData.hh
/// @details last Modified: 07/31/16
/// @author  Georg Kuenze (georg.kuenze@vanderbilt.edu)

#ifndef INCLUDED_core_scoring_nmr_rdc_RDCData_FWD_HH
#define INCLUDED_core_scoring_nmr_rdc_RDCData_FWD_HH
...
#endif // INCLUDED_core_scoring_nmr_rdc_RDCData_FWD_HH

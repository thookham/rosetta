...
) const
{
	...
	int const mmtype1(conformation.residue_type(atomid1.rsd()).mm_atom_type_index(atomid1.atomno()));
	int const mmtype2(conformation.residue_type(atomid2.rsd()).mm_atom_type_index(atomid2.atomno()));
	int const mmtype3(conformation.residue_type(atomid3.rsd()).mm_atom_type_index(atomid3.atomno()));

...
/// @file   core/scoring/ChemicalShiftAnisotropy.fwd.hh
/// @brief
/// @author Lei Shi


#ifndef INCLUDED_core_scoring_ChemicalShiftAnisotropy_fwd_hh
#define INCLUDED_core_scoring_ChemicalShiftAnisotropy_fwd_hh

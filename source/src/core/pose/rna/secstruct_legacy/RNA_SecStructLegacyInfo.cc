...
void
core::pose::rna::secstruct_legacy::RNA_SecStructLegacyInfo::save( Archive & arc ) const {
...
template< class Archive >
void
core::pose::rna::secstruct_legacy::RNA_SecStructLegacyInfo::load( Archive & arc ) {
	arc( cereal::base_class< basic::datacache::CacheableData >( this ) );
	arc( rna_secstruct_legacy_ ); // std::string
}

SAVE_AND_LOAD_SERIALIZABLE( core::pose::rna::secstruct_legacy::RNA_SecStructLegacyInfo );
CEREAL_REGISTER_TYPE( core::pose::rna::secstruct_legacy::RNA_SecStructLegacyInfo )

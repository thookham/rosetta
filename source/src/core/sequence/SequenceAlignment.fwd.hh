...
/// @brief forward declaration for SequenceAlignment class.
/// @author James Thompson

#ifndef INCLUDED_core_sequence_SequenceAlignment_fwd_hh
#define INCLUDED_core_sequence_SequenceAlignment_fwd_hh

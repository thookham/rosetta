...
/// @file   core/select/residue_selector/LogicResidueSelector.hh
...
#ifndef INCLUDED_core_select_residue_selector_LogicResidueSelector_HH
#define INCLUDED_core_select_residue_selector_LogicResidueSelector_HH

// Unit headers
#include <core/select/residue_selector/LogicResidueSelector.fwd.hh>
...
/// @brief A residue selector that takes arbitrarily many residue selectors and performs and/or/not boolean logic within the "residue_selectors" option.
class LogicResidueSelector : public core::select::residue_selector::ResidueSelector {
public:
...
public:
	...
	//LogicResidueSelector(LogicResidueSelector const & src);

public:

	/// @brief Destructor.
	~LogicResidueSelector() override;
...
private:
	ResidueSelectorCOP selector_ = nullptr;
...
#ifdef    SERIALIZATION
CEREAL_FORCE_DYNAMIC_INIT( core_select_residue_selector_LogicResidueSelector )
#endif // SERIALIZATION

#endif //INCLUDEDcore_select_residue_selector_LogicResidueSelector_HH

...
/// @file   core/select/residue_selector/ResidueIndexSelector.fwd.hh
/// @brief  Forward declaration of a class that selects residues using a string containing pose indices
/// @author Robert Lindner (rlindner@mpimf-heidelberg.mpg.de)

#ifndef INCLUDED_core_select_residue_selector_ResidueIndexSelector_FWD_HH
#define INCLUDED_core_select_residue_selector_ResidueIndexSelector_FWD_HH

...
/// @file   core/select/residue_selector/ResidueNameSelector.fwd.hh
/// @brief  Forward declaration of a class that selects residues using their names
/// @author Tom Linsky (tlinsky@uw.edu)

#ifndef INCLUDED_core_select_residue_selector_ResidueNameSelector_FWD_HH
#define INCLUDED_core_select_residue_selector_ResidueNameSelector_FWD_HH

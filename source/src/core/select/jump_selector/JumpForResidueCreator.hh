...
/// @file   core/select/jump_selector/JumpForResidueCreator.hh
/// @brief  JumpForResidue selects the jump that builds the residues passed in
/// @author Jack Maguire

#ifndef INCLUDED_core_select_jump_selector_JumpForResidueCreator_HH
#define INCLUDED_core_select_jump_selector_JumpForResidueCreator_HH
...
class JumpForResidueCreator : public core::select::jump_selector::JumpSelectorCreator {
public:

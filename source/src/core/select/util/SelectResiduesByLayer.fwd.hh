...
/// @file   core/select/util/SelectResiduesByLayer.fwd.hh.
...
#ifndef INCLUDED_core_select_util_SelectResiduesByLayer_fwd_hh
#define INCLUDED_core_select_util_SelectResiduesByLayer_fwd_hh

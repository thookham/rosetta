...
/// @file core/pack/hbonds/HBondGraphInitializerIG.hh
...
#ifndef INCLUDED_core_pack_hbonds_HBondGraphInitializerIG_HH
#define INCLUDED_core_pack_hbonds_HBondGraphInitializerIG_HH
...
public:
	...
	PackerEnergy get_two_body_energy( int const, int const ) const override {
		utility_exit_with_message( "HBondGraphInitializerIG should not be treated like an actual interaction graph" );
	}
...
class HBondGraphInitializerIG : public interaction_graph::PDInteractionGraph {

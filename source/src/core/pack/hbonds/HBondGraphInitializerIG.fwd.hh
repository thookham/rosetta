...
/// @file core/pack/hbonds/HBondGraphInitializerIG.fwd.hh
...
#ifndef INCLUDED_core_pack_hbonds_HBondGraphInitializerIG_FWD_HH
#define INCLUDED_core_pack_hbonds_HBondGraphInitializerIG_FWD_HH

...
/// @file core/pack/guidance_scoreterms/sap/SapScoreMetricCreator.hh
/// @brief Creators for SapScoreMetric
/// @author Brian Coventry (bcov@uw.edu)

#ifndef INCLUDED_core_pack_guidance_scoreterms_sap_SapScoreMetricCreator_hh
#define INCLUDED_core_pack_guidance_scoreterms_sap_SapScoreMetricCreator_hh
...
class SapScoreMetricCreator : public core::simple_metrics::SimpleMetricCreator {
public:

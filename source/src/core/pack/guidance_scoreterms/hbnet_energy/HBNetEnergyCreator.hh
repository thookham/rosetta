...
/// @file core/pack/guidance_scoreterms/hbnet_energy/HBNetEnergyCreator.hh
...
#ifndef INCLUDED_core_pack_guidance_scoreterms_hbnet_energy_HBNetEnergyCreator_hh
#define INCLUDED_core_pack_guidance_scoreterms_hbnet_energy_HBNetEnergyCreator_hh

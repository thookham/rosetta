...
/// @file core/pack/guidance_scoreterms/buried_unsat_penalty/BuriedUnsatPenaltyCreator.hh
/// @brief Creator for an EnergyMethod that gives a penalty for buried unsatisfied hydrogen bond donors and acceptors.
...
#ifndef INCLUDED_core_pack_guidance_scoreterms_buried_unsat_penalty_BuriedUnsatPenaltyCreator_hh
#define INCLUDED_core_pack_guidance_scoreterms_buried_unsat_penalty_BuriedUnsatPenaltyCreator_hh
...
class BuriedUnsatPenaltyCreator : public core::scoring::methods::EnergyMethodCreator
{
public:

	/// @brief Instantiate a new BuriedUnsatPenalty.
	///

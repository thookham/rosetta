...
/// @file   core/pack/palette/DefaultPackerPaletteCreator.hh
/// @brief  Declaration of the creator for DefaultPackerPalette.
/// @author Vikram K. Mulligan (vmullig@uw.edu)

#ifndef INCLUDED_core_pack_palette_DefaultPackerPaletteCreator_hh
#define INCLUDED_core_pack_palette_DefaultPackerPaletteCreator_hh
...
/// requests one.
class DefaultPackerPaletteCreator : public PackerPaletteCreator
{
public:
	~DefaultPackerPaletteCreator() override {}

	/// @brief Instantiate a new PackerPalette
	PackerPaletteOP create_packer_palette() const override;
	std::string keyname() const override { return "DefaultPackerPalette"; }

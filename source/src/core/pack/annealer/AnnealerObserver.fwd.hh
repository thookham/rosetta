...
/// @file   core/pack/annealer/AnnealerObserver.fwd.hh
/// @author Jack Maguire

#ifndef INCLUDED_core_pack_annealer_AnnealerObserver_fwd_hh
#define INCLUDED_core_pack_annealer_AnnealerObserver_fwd_hh

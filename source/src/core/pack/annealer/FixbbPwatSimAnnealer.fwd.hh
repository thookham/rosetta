...
/// @file   core/pack/annealer/FixbbPwatSimAnnealer.fwd.hh
/// @brief  Packer's standard annealer class forward declaration
/// @author Andrew Leaver-Fay (aleaverfay@gmail.com)


#ifndef INCLUDED_core_pack_annealer_FixbbPwatSimAnnealer_fwd_hh
#define INCLUDED_core_pack_annealer_FixbbPwatSimAnnealer_fwd_hh

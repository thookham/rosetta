...
/// @file   core/pack/task/operation/OperateOnCertainResidues.fwd.hh
...
#ifndef INCLUDED_core_pack_task_operation_OperateOnCertainResidues_fwd_hh
#define INCLUDED_core_pack_task_operation_OperateOnCertainResidues_fwd_hh

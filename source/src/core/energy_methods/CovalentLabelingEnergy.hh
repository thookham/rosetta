...
/// @file   core/energy_methods/CovalentLabelingEnergy.hh
/// @brief  energy term use for scoring predicted CovalentLabeling
/// @author Melanie Aprahamian

#ifndef INCLUDED_core_energy_methods_CovalentLabelingEnergy_hh
#define INCLUDED_core_energy_methods_CovalentLabelingEnergy_hh
...
class CovalentLabelingEnergy : public core::scoring::methods::ContextDependentOneBodyEnergy {
public:
...
public:
	...
	CovalentLabelingEnergy( core::scoring::methods::EnergyMethodOptions const & options );
...
#endif // INCLUDED_core_energy_methods_CovalentLabelingEnergy_HH

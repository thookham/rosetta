...
/// @file   core/energy_methods/RamaPreProEnergy.fwd.hh
/// @brief
/// @author Frank DiMaio

#ifndef INCLUDED_core_energy_methods_RamaPreProEnergy_fwd_hh
#define INCLUDED_core_energy_methods_RamaPreProEnergy_fwd_hh

...
#ifndef INCLUDED_core_energy_methods_AromaticBackboneRestraintEnergy_hh
#define INCLUDED_core_energy_methods_AromaticBackboneRestraintEnergy_hh
...
class AromaticBackboneRestraintEnergy : public core::scoring::methods::ContextIndependentOneBodyEnergy  {
public:

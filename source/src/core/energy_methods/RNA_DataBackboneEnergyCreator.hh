...
/// @file src/core/energy_methods/data/RNA_DataBackboneEnergyCreator.hh
...
class RNA_DataBackboneEnergyCreator : public core::scoring::methods::EnergyMethodCreator
{
public:
	/// @brief Instantiate a new RNA_DataBackboneEnergy

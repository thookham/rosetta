...
#ifndef INCLUDED_core_energy_methods_VdWTinkerEnergy_hh
#define INCLUDED_core_energy_methods_VdWTinkerEnergy_hh

// Unit Headers
#include <core/energy_methods/VdWTinkerEnergy.fwd.hh>
...
///
class VdWTinkerEnergy : public core::scoring::methods::ContextIndependentLRTwoBodyEnergy  {
public:
	typedef core::scoring::methods::ContextIndependentLRTwoBodyEnergy  parent;
public:

	/// for use by core::scoring::ScoringManager
	VdWTinkerEnergy( core::scoring::methods::EnergyMethodOptions const & options );
	...
	{
		return core::scoring::methods::vdw_tinker_lr;
	}
...
private:
	...
	core::scoring::VdWTinkerPotential const & potential_;

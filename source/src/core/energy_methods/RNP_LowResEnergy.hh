...
// Unit Headers
#include <core/energy_methods/RNP_LowResEnergy.fwd.hh>
...
class RNP_LowResEnergy : public core::scoring::methods::ContextIndependentTwoBodyEnergy  {
public:
...
private:
	...
	core::scoring::rna::RNP_LowResPotential const & potential_;

...
/// @file src/core/energy_methods/RG_Energy_RNACreator.hh
...
class RG_Energy_RNACreator : public core::scoring::methods::EnergyMethodCreator
{
public:
	/// @brief Instantiate a new RG_Energy_RNA

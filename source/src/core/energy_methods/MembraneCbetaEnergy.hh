...
#ifndef INCLUDED_core_energy_methods_MembraneCbetaEnergy_hh
#define INCLUDED_core_energy_methods_MembraneCbetaEnergy_hh
...
class MembraneCbetaEnergy : public core::scoring::methods::ContextDependentOneBodyEnergy  {
public:

...
#ifndef INCLUDED_core_energy_methods_HydroxylTorsionEnergy_fwd_hh
#define INCLUDED_core_energy_methods_HydroxylTorsionEnergy_fwd_hh
...
#endif // INCLUDED_core_scoring_HydroxylTorsionEnergy_fwd_hh

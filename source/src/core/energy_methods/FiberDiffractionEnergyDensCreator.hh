...
#ifndef INCLUDED_core_scoring_fiber_diffraction_FiberDiffractionEnergyCreatorDens_hh
#define INCLUDED_core_scoring_fiber_diffraction_FiberDiffractionEnergyCreatorDens_hh

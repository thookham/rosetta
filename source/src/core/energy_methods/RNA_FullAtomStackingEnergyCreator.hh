...
/// @file src/core/energy_methods/RNA_FullAtomStackingEnergyCreator.hh
...
class RNA_FullAtomStackingEnergyCreator : public core::scoring::methods::EnergyMethodCreator
{
public:

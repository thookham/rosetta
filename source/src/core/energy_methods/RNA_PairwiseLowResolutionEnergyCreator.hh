...
/// @file src/core/energy_methods/RNA_PairwiseLowResolutionEnergyCreator.hh
...
class RNA_PairwiseLowResolutionEnergyCreator : public core::scoring::methods::EnergyMethodCreator
{
public:
	/// @brief Instantiate a new RNA_PairwiseLowResolutionEnergy

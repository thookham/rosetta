...
/// @file   core/energy_methods/DipolarCouplingEnergy.hh
/// @brief  CSP energy
/// @author Lei Shi


#ifndef INCLUDED_core_energy_methods_DipolarCouplingEnergy_hh
#define INCLUDED_core_energy_methods_DipolarCouplingEnergy_hh
...
class DipolarCouplingEnergy : public core::scoring::methods::WholeStructureEnergy  {
public:
...
private:
	...
	core::scoring::DipolarCoupling& dc_from_pose(
		pose::Pose & pose
	) const;

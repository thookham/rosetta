...
/// @file src/core/energy_methods/RNA_BulgeEnergyCreator.hh
...
class RNA_BulgeEnergyCreator : public core::scoring::methods::EnergyMethodCreator
{
public:
	/// @brief Instantiate a new RNA_BulgeEnergy

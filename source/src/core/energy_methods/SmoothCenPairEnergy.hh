...
#ifndef INCLUDED_core_energy_methods_SmoothCenPairEnergy_hh
#define INCLUDED_core_energy_methods_SmoothCenPairEnergy_hh
...
class SmoothCenPairEnergy : public core::scoring::methods::ContextIndependentTwoBodyEnergy  {
public:

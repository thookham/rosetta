...
#ifndef INCLUDED_core_energy_methods_DistanceChainbreakEnergy_hh
#define INCLUDED_core_energy_methods_DistanceChainbreakEnergy_hh
...
class DistanceChainbreakEnergy : public core::scoring::methods::WholeStructureEnergy  {
public:

...
#ifndef INCLUDED_core_scoring_fiber_diffraction_FiberDiffractionEnergyCreator_hh
#define INCLUDED_core_scoring_fiber_diffraction_FiberDiffractionEnergyCreator_hh
...
class FiberDiffractionEnergyCreator : public core::scoring::methods::EnergyMethodCreator {
public:

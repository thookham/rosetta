...
#ifndef INCLUDED_core_energy_methods_BranchEnergy_hh
#define INCLUDED_core_energy_methods_BranchEnergy_hh
...
class BranchEnergy : public core::scoring::methods::WholeStructureEnergy  {
public:

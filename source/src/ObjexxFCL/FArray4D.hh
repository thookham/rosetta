#ifndef INCLUDED_ObjexxFCL_FArray4D_hh
#define INCLUDED_ObjexxFCL_FArray4D_hh
...
/// @brief FArray4D: Fortran-Compatible 4D Array
template< typename T >
class FArray4D :
	public FArray4< T >,
...
public: // Creation
	...
	inline
	FArray4D( IR const & I1_a, IR const & I2_a, IR const & I3_a, IR const & I4_a ) :
	...
	inline
	FArray4D( IR const & I1_a, IR const & I2_a, IR const & I3_a, IR const & I4_a, T const & t ) :
	...
	inline
	FArray4D( IR const & I1_a, IR const & I2_a, IR const & I3_a, IR const & I4_a, InitializerFunction const & function_a ) :
		Super( size_of( I1_a, I2_a, I3_a, I4_a ), InitializerSentinel() ),
		I1_( I1_a ),
		I2_( I2_a ),
		I3_( I3_a ),
	...
	template< typename U >
	inline
	FArray4D( FArray4< U > const & a, IR const & I1_a, IR const & I2_a, IR const & I3_a, IR const & I4_a ) :
		Super( size_of( I1_a, I2_a, I3_a, I4_a ) ),
		I1_( I1_a ),
		I2_( I2_a ),
		I3_( I3_a ),
	...
	template< typename U >
	inline
	FArray4D( FArray4< U > const & a, IR const & I1_a, IR const & I2_a, IR const & I3_a, IR const & I4_a, T const & t ) :
		Super( size_of( I1_a, I2_a, I3_a, I4_a ) ),
		I1_( I1_a ),
		I2_( I2_a ),
		I3_( I3_a ),
...
public: // Predicate
	...
	inline
	bool
	contains( int const i1, int const i2, int const i3, int const i4 ) const override
	{
...
public: // Modifier
	...
	{
		FArray4D( *this, I1_a, I2_a, I3_a, I4_a ).swap( *this );
		return *this;
	}
	...
	{
		FArray4D( *this, I1_a, I2_a, I3_a, I4_a, t ).swap( *this );
		return *this;
	}
	...
	{
		FArray4D( *this, a.I1(), a.I2(), a.I3(), a.I4() ).swap( *this );
		return *this;
	}
	...
	{
		FArray4D( *this, a.I1(), a.I2(), a.I3(), a.I4(), t ).swap( *this );
		return *this;
	}
...
protected: // Functions
	...
	inline
	void
	dimension_assign( SIR const & I1_a, SIR const & I2_a, SIR const & I3_a, SIR const & I4_a ) override
	{
		initializer_.clear();
		I1_.assign_no_notify( I1_a );
		I2_.assign_no_notify( I2_a );
...
private: // Functions
	...
	dimension_real()
	{
		...
		s3_ = I3_.size();
		if ( dimensions_initialized() ) {
			this->resize( size_of( s1_, s2_, s3_, I4_.size() ) );
			shift_set( ( ( ( ( ( I4_.lz() * s3_ ) + I3_.lz() ) * s2_ ) + I2_.lz() ) * s1_ ) + I1_.lz() );
...
/// @brief std::swap( FArray4D, FArray4D )
template< typename T >
inline
void
swap( ObjexxFCL::FArray4D< T > & a, ObjexxFCL::FArray4D< T > & b )
{
	a.swap( b );
}
...
#endif // INCLUDED_ObjexxFCL_FArray4D_HH

#ifndef INCLUDED_ObjexxFCL_FArray5_io_hh
#define INCLUDED_ObjexxFCL_FArray5_io_hh


// FArray5 Input/Output Functions
//
...
/// @brief Read an FArray5 from a binary file
template< typename T >
std::istream &
read_binary( std::istream & stream, FArray5< T > & a )
{
								...
								for ( int i2 = a.l2(), e2 = a.u2(); i2 <= e2; ++i2 ) {
									if ( stream ) {
										for ( int i1 = a.l1(), e1 = a.u1(); i1 <= e1; ++i1 ) {
											if ( stream ) stream.read( ( std::istream::char_type * )&a( i1, i2, i3, i4, i5 ), type_size );
										}
									}
								}
							}
...
/// @brief Write an FArray5 to a binary file
template< typename T >
std::ostream &
write_binary( std::ostream & stream, FArray5< T > const & a )
{
						...
						for ( int i3 = a.l3(), e3 = a.u3(); i3 <= e3; ++i3 ) {
							if ( stream ) {
								for ( int i2 = a.l2(), e2 = a.u2(); i2 <= e2; ++i2 ) {
									if ( stream ) {
										for ( int i1 = a.l1(), e1 = a.u1(); i1 <= e1; ++i1 ) {
											if ( stream ) stream.write( ( std::ostream::char_type const * )&a( i1, i2, i3, i4, i5 ), type_size );
										}
									}
								}
							}
...
/// @brief stream << FArray5
template< typename T >
std::ostream &
operator <<( std::ostream & stream, FArray5< T > const & a )
{
...
#endif // INCLUDED_ObjexxFCL_FArray5_io_HH

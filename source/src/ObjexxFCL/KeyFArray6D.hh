#ifndef INCLUDED_ObjexxFCL_KeyFArray6D_hh
#define INCLUDED_ObjexxFCL_KeyFArray6D_hh
...
/// @brief KeyFArray6D: Key-Access Fortran-Compatible 6D Array
template< typename T >
class KeyFArray6D :
	public FArray6< T >,
...
public: // Subscript
	...
	inline
	T const &
	operator ()( K1 const & i1, K2 const & i2, K3 const & i3, K4 const & i4, K5 const & i5, K6 const & i6 ) const
	{
	...
	inline
	T &
	operator ()( K1 const & i1, K2 const & i2, K3 const & i3, K4 const & i4, K5 const & i5, K6 const & i6 )
	{
		assert( ( I1_.contains( i1 ) ) && ( I2_.contains( i2 ) ) && ( I3_.contains( i3 ) ) && ( I4_.contains( i4 ) ) && ( I5_.contains( i5 ) ) && ( I6_.contains( i6 ) ) );
		return sarray_[ ( ( ( ( ( ( ( ( ( i6 * s5_ ) + i5 ) * s4_ ) + i4 ) * s3_ ) + i3 ) * s2_ ) + i2 ) * s1_ ) + i1 ];
	}
	...
	inline
	Section const
	a( K1 const & i1, K2 const & i2, K3 const & i3, K4 const & i4, K5 const & i5, K6 const & i6 ) const
	{
		assert( ( I1_.contains( i1 ) ) && ( I2_.contains( i2 ) ) && ( I3_.contains( i3 ) ) && ( I4_.contains( i4 ) ) && ( I5_.contains( i5 ) ) && ( I6_.contains( i6 ) ) );
	...
	inline
	size_type
	index( K1 const & i1, K2 const & i2, K3 const & i3, K4 const & i4, K5 const & i5, K6 const & i6 ) const
	{
...
public: // Predicate
	...
	inline
	bool
	contains( K1 const & i1, K2 const & i2, K3 const & i3, K4 const & i4, K5 const & i5, K6 const & i6 ) const
	{
...
public: // Modifier
	...
	{
		KeyFArray6D( *this, I1_a, I2_a, I3_a, I4_a, I5_a, I6_a ).swap( *this );
		return *this;
	}
	...
	{
		KeyFArray6D( *this, I1_a, I2_a, I3_a, I4_a, I5_a, I6_a, t ).swap( *this );
		return *this;
	}
	...
	{
		KeyFArray6D( *this, a.I1(), a.I2(), a.I3(), a.I4(), a.I5(), a.I6() ).swap( *this );
		return *this;
	}
	...
	{
		KeyFArray6D( *this, a.I1(), a.I2(), a.I3(), a.I4(), a.I5(), a.I6(), t ).swap( *this );
		return *this;
	}
...
public: // Friend
	...
	inline
	void
	swap( KeyFArray6D & a, KeyFArray6D & b )
	{
		a.swap( b );
	}
...
public: // Generator
	...
	inline
	KeyFArray6D
	operator +( KeyFArray6D const & a, KeyFArray6D const & b )
	{
		KeyFArray6D r( a );
		r += b;
		return r;
	...
	inline
	KeyFArray6D
	operator +( KeyFArray6D const & a, T const & t )
	{
		KeyFArray6D r( a );
		r += t;
		return r;
	...
	inline
	KeyFArray6D
	operator +( T const & t, KeyFArray6D const & a )
	{
		KeyFArray6D r( a );
		r += t;
		return r;
...
private: // Functions
	...
	dimension_real()
	{
		...
		s5_ = I5_.size();
		if ( dimensions_initialized() ) {
			resize( size_of( s1_, s2_, s3_, s4_, s5_, I6_.size() ) );
			shift_set( ( ( ( ( ( ( ( ( ( I6_.lz() * s5_ ) +  I5_.lz() ) * s4_ ) +  I4_.lz() ) * s3_ ) + I3_.lz() ) * s2_ ) + I2_.lz() ) * s1_ ) + I1_.lz() );
...
template< typename T >
void
swap( KeyFArray6D< T > & a, KeyFArray6D< T > & b );


/// @brief -Array
template< typename T >
KeyFArray6D< T >
operator -( KeyFArray6D< T > const & a );


/// @brief Array + Array
template< typename T >
KeyFArray6D< T >
operator +( KeyFArray6D< T > const & a, KeyFArray6D< T > const & b );
...
template< typename T >
KeyFArray6D< T >
operator +( KeyFArray6D< T > const & a, T const & t );


/// @brief Value + Array
template< typename T >
KeyFArray6D< T >
operator +( T const & t, KeyFArray6D< T > const & a );
...
/// @brief std::swap( KeyFArray6D, KeyFArray6D )
template< typename T >
inline
void
swap( ObjexxFCL::KeyFArray6D< T > & a, ObjexxFCL::KeyFArray6D< T > & b )
{
	a.swap( b );
}
...
#endif // INCLUDED_ObjexxFCL_KeyFArray6D_HH

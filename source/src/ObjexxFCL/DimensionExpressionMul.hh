#ifndef INCLUDED_ObjexxFCL_DimensionExpressionMul_hh
#define INCLUDED_ObjexxFCL_DimensionExpressionMul_hh
...
/// @brief DimensionExpressionMul: DimensionExpression Binary Product
...
public: // Creation
	...
	/// @brief Destructor
	inline
	~DimensionExpressionMul() override
	{
		assert( exp1_p_ );
		assert( exp2_p_ );
		delete exp1_p_;
...
#endif // INCLUDED_ObjexxFCL_DimensionExpressionMul_HH

#ifndef INCLUDED_ObjexxFCL_KeyFArray5D_hh
#define INCLUDED_ObjexxFCL_KeyFArray5D_hh
...
/// @brief KeyFArray5D: Key-Access Fortran-Compatible 5D Array
template< typename T >
class KeyFArray5D :
	public FArray5< T >,
...
public: // Types
	...
	typedef  FArrayInitializer< T, ObjexxFCL::KeyFArray5D >  Initializer;
...
public: // Subscript
	...
	inline
	T const &
	operator ()( K1 const & i1, K2 const & i2, K3 const & i3, K4 const & i4, K5 const & i5 ) const
	{
	...
	inline
	T &
	operator ()( K1 const & i1, K2 const & i2, K3 const & i3, K4 const & i4, K5 const & i5 )
	{
		assert( ( I1_.contains( i1 ) ) && ( I2_.contains( i2 ) ) && ( I3_.contains( i3 ) ) && ( I4_.contains( i4 ) ) && ( I5_.contains( i5 ) ) );
		return sarray_[ ( ( ( ( ( ( ( i5 * s4_ ) + i4 ) * s3_ ) + i3 ) * s2_ ) + i2 ) * s1_ ) + i1 ];
	}
	...
	inline
	Section const
	a( K1 const & i1, K2 const & i2, K3 const & i3, K4 const & i4, K5 const & i5 ) const
	{
		assert( ( I1_.contains( i1 ) ) && ( I2_.contains( i2 ) ) && ( I3_.contains( i3 ) ) && ( I4_.contains( i4 ) ) && ( I5_.contains( i5 ) ) );
	...
	inline
	size_type
	index( K1 const & i1, K2 const & i2, K3 const & i3, K4 const & i4, K5 const & i5 ) const
	{
...
public: // Predicate
	...
	inline
	bool
	contains( K1 const & i1, K2 const & i2, K3 const & i3, K4 const & i4, K5 const & i5 ) const
	{
...
public: // Modifier
	...
	{
		KeyFArray5D( *this, I1_a, I2_a, I3_a, I4_a, I5_a ).swap( *this );
		return *this;
	}
	...
	{
		KeyFArray5D( *this, I1_a, I2_a, I3_a, I4_a, I5_a, t ).swap( *this );
		return *this;
	}
	...
	{
		KeyFArray5D( *this, a.I1(), a.I2(), a.I3(), a.I4(), a.I5() ).swap( *this );
		return *this;
	}
	...
	{
		KeyFArray5D( *this, a.I1(), a.I2(), a.I3(), a.I4(), a.I5(), t ).swap( *this );
		return *this;
	}
...
public: // Friend
	...
	inline
	void
	swap( KeyFArray5D & a, KeyFArray5D & b )
	{
		a.swap( b );
	}
...
public: // Generator
	...
	inline
	KeyFArray5D
	operator +( KeyFArray5D const & a, KeyFArray5D const & b )
	{
		KeyFArray5D r( a );
		r += b;
		return r;
	...
	inline
	KeyFArray5D
	operator +( KeyFArray5D const & a, T const & t )
	{
		KeyFArray5D r( a );
		r += t;
		return r;
	...
	inline
	KeyFArray5D
	operator +( T const & t, KeyFArray5D const & a )
	{
		KeyFArray5D r( a );
		r += t;
		return r;
...
private: // Functions
	...
	dimension_real()
	{
		...
		s4_ = I4_.size();
		if ( dimensions_initialized() ) {
			resize( size_of( s1_, s2_, s3_, s4_, I5_.size() ) );
			shift_set( ( ( ( ( ( ( ( I5_.lz() * s4_ ) +  I4_.lz() ) * s3_ ) + I3_.lz() ) * s2_ ) + I2_.lz() ) * s1_ ) + I1_.lz() );
...
template< typename T >
void
swap( KeyFArray5D< T > & a, KeyFArray5D< T > & b );


/// @brief -Array
template< typename T >
KeyFArray5D< T >
operator -( KeyFArray5D< T > const & a );


/// @brief Array + Array
template< typename T >
KeyFArray5D< T >
operator +( KeyFArray5D< T > const & a, KeyFArray5D< T > const & b );
...
template< typename T >
KeyFArray5D< T >
operator +( KeyFArray5D< T > const & a, T const & t );


/// @brief Value + Array
template< typename T >
KeyFArray5D< T >
operator +( T const & t, KeyFArray5D< T > const & a );
...
/// @brief std::swap( KeyFArray5D, KeyFArray5D )
template< typename T >
inline
void
swap( ObjexxFCL::KeyFArray5D< T > & a, ObjexxFCL::KeyFArray5D< T > & b )
{
	a.swap( b );
}
...
#endif // INCLUDED_ObjexxFCL_KeyFArray5D_HH

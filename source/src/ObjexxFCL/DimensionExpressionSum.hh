#ifndef INCLUDED_ObjexxFCL_DimensionExpressionSum_hh
#define INCLUDED_ObjexxFCL_DimensionExpressionSum_hh
...
/// @brief DimensionExpressionSum: DimensionExpression Binary Sum
...
public: // Creation
	...
	clone() const override
	{
		...
		if ( constant() ) {
			...
			return new DimensionExpressionSum( exp1_p_->clone(), exp2_p_->clone() );
		}
	}
	...
	clone( Dimension const & dim ) const override
	{
		...
		if ( constant() ) {
			...
			return new DimensionExpressionSum( exp1_p_->clone( dim ), exp2_p_->clone( dim ) );
		}
	}
	...
	/// @brief Destructor
	inline
	~DimensionExpressionSum() override
	{
		assert( exp1_p_ );
		assert( exp2_p_ );
		delete exp1_p_;
...
#endif // INCLUDED_ObjexxFCL_DimensionExpressionSum_HH

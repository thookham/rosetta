...
/// @file   utility/vectorL_bool.hh
/// @brief  vectorL: std::vector with L-based indexing: bool specialization
/// @author Stuart G. Mentzer (Stuart_Mentzer@objexx.com)


#ifndef INCLUDED_utility_vectorL_bool_hh
#define INCLUDED_utility_vectorL_bool_hh


// Unit headers
// Guarantee vectorL's presence but avoid circular dependency
...
/// @brief std::vector with L-based indexing: bool specialization
/// @note
...
#endif // INCLUDED_utility_vectorL_bool_HH

...
/// @file   protocols/task_operations/CrystalContactsOperation.hh
/// @brief  Exclude crystal contacts from design
/// @author Patrick Conway (ptconway@uw.edu)

#ifndef INCLUDED_protocols_task_operations_CrystalContactsOperation_hh
#define INCLUDED_protocols_task_operations_CrystalContactsOperation_hh
...
public:
	...
	~CrystalContactsOperation() override;

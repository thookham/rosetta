...
/// @file protocols/task_operations/RestrictNativeResiduesOperation.cc
...
// Unit Headers
#include <protocols/task_operations/RestrictNativeResiduesOperation.hh>
...
RestrictNativeResiduesOperation::apply( Pose const & pose, PackerTask & task ) const
{
	...
	for ( core::Size ir = total_residue+1; ir <= pose.size(); ++ir ) {

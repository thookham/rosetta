...
#ifndef INCLUDED_protocols_task_operations_ConservativeDesignOperation_fwd_hh
#define INCLUDED_protocols_task_operations_ConservativeDesignOperation_fwd_hh

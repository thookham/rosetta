...
/// @file protocols/task_operations/StoreTaskMover.hh
/// @brief Headers for StoreTaskMover class
/// @author Neil King (neilking@uw.edu)

#ifndef INCLUDED_protocols_task_operations_StoreTaskMover_hh
#define INCLUDED_protocols_task_operations_StoreTaskMover_hh

//unit headers
#include <protocols/task_operations/StoreTaskMover.fwd.hh>

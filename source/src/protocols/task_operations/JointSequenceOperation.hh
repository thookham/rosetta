...
/// @file protocols/task_operations/JointSequenceOperation.hh
/// @brief set every position to be designable to residues observed in a set of structures
/// @author Rocco Moretti, rmoretti@u.washington.edu

#ifndef INCLUDED_protocols_task_operations_JointSequenceOperation_hh
#define INCLUDED_protocols_task_operations_JointSequenceOperation_hh

// unit headers
#include <protocols/task_operations/JointSequenceOperation.fwd.hh>

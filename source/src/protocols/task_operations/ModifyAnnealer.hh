...
#ifndef INCLUDED_protocols_task_operations_ModifyAnnealer_HH
#define INCLUDED_protocols_task_operations_ModifyAnnealer_HH

// Unit Headers
#include <protocols/task_operations/ModifyAnnealer.fwd.hh>

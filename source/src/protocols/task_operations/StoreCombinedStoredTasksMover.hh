...
/// @file protocols/task_operations/StoreCombinedStoredTasksMover.hh
/// @brief Headers for StoreCombinedStoredTasksMover class -- DEPRECATED (see .cc file)
/// @author Jacob Bale (balej@uw.edu)

#ifndef INCLUDED_protocols_task_operations_StoreCombinedStoredTasksMover_hh
#define INCLUDED_protocols_task_operations_StoreCombinedStoredTasksMover_hh

//unit headers
#include <protocols/task_operations/StoreCombinedStoredTasksMover.fwd.hh>

...
/// @file   protocols/task_operations/RestrictIdentitiesOperation.cc
/// @brief Restricts specified residue types to only repack, no design.
/// @author Neil King (neilking@uw.edu)

// Unit Headers
#include <protocols/task_operations/RestrictIdentitiesOperation.hh>
...
RestrictIdentitiesOperation::apply( core::pose::Pose const & pose, core::pack::task::PackerTask & task ) const
{
	...
	for ( core::Size j=1; j<=identities_.size(); j++ ) {

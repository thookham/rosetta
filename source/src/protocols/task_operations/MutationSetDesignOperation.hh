...
#ifndef INCLUDED_protocols_task_operations_MutationSetDesignOperation_hh
#define INCLUDED_protocols_task_operations_MutationSetDesignOperation_hh

#include <protocols/task_operations/MutationSetDesignOperation.fwd.hh>

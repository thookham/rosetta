...
/// @file   protocols/task_operations/RestrictToNeighborhoodOperation.hh
/// @brief  TaskOperation class that finds a neighborhood and makes it mobile in the PackerTask
/// @author Steven Lewis smlewi@gmail.com

#ifndef INCLUDED_protocols_task_operations_RestrictToNeighborhoodOperation_hh
#define INCLUDED_protocols_task_operations_RestrictToNeighborhoodOperation_hh

// Unit Headers
#include <protocols/task_operations/RestrictToNeighborhoodOperation.fwd.hh>
...
public:
	...
	protocols::pose_metric_calculators::NeighborhoodByDistanceCalculatorCOP get_calculator() const;
...
#endif // INCLUDED_protocols_TaskOperations_RestrictToNeighborhoodOperation_HH

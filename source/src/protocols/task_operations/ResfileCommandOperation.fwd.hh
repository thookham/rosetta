...
/// @file protocols/task_operations/ResfileCommandOperation.fwd.hh
/// @brief Applies the equivalent of a resfile line (without the resnums) to residues specified in a residue selector.
/// @author Jared Adolf-Bryfogle (jadolfbr@gmail.com)

#ifndef INCLUDED_protocols_task_operations_ResfileCommandOperation_fwd_hh
#define INCLUDED_protocols_task_operations_ResfileCommandOperation_fwd_hh
...
#endif //INCLUDED_protocols_task_operations_ResfileCommandOperation_fwd_hh

...
/// @file   protocols/task_operations/InteractingRotamerExplosion.cc
/// @brief
...
InteractingRotamerExplosion::apply( core::pose::Pose const & pose, core::pack::task::PackerTask & task ) const
{
	...
	for ( core::Size i(1); i <= pose.size(); ++i ) {
		...
		toolbox::rotamer_set_operations::AddGood2BPairEnergyRotamersOP rotsetop( new toolbox::rotamer_set_operations::AddGood2BPairEnergyRotamers(i, ex_level_, target_seqpos, score_cutoff_, false ) );

...
#ifndef INCLUDED_protocols_task_operations_StoreCompoundTaskMover_hh
#define INCLUDED_protocols_task_operations_StoreCompoundTaskMover_hh

//unit headers
#include <protocols/task_operations/StoreCompoundTaskMover.fwd.hh>

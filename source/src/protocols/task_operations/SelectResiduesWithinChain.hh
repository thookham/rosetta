...
/// @file   protocols/task_operations/SelectResiduesWithinChainOperation.hh
/// @brief  TaskOperation class that restricts a chain to repacking
/// @author Sarel Fleishman sarelf@uw.edu

#ifndef INCLUDED_protocols_task_operations_SelectResiduesWithinChainOperation_hh
#define INCLUDED_protocols_task_operations_SelectResiduesWithinChainOperation_hh

// Unit Headers
#include <protocols/task_operations/SelectResiduesWithinChain.fwd.hh>
...
#endif // INCLUDED_protocols_TaskOperations_SelectResiduesWithinChainOperation_HH

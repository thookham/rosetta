...
#ifndef INCLUDED_protocols_task_operations_ResidueProbDesignOperation_fwd_hh
#define INCLUDED_protocols_task_operations_ResidueProbDesignOperation_fwd_hh

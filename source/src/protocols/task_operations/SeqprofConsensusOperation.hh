...
/// @file protocols/task_operations/SeqprofConsensus.hh
...
#ifndef INCLUDED_protocols_task_operations_SeqprofConsensusOperation_hh
#define INCLUDED_protocols_task_operations_SeqprofConsensusOperation_hh

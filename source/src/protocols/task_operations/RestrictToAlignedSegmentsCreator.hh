...
#ifndef INCLUDED_protocols_task_operations_RestrictToAlignedSegmentsCreator_hh
#define INCLUDED_protocols_task_operations_RestrictToAlignedSegmentsCreator_hh

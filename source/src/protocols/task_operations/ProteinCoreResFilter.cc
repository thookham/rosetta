...
/// @file   protocols/task_operations/RestrictToInterfaceOperation.cc
/// @brief  TaskOperation class that finds an interface and leaves it mobile in the PackerTask
/// @author Steven Lewis smlewi@gmail.com

// Unit Headers
#include <protocols/task_operations/ProteinCoreResFilter.hh>
...
static basic::Tracer TR( "protocols.TaskOperations.ProteinCore" );

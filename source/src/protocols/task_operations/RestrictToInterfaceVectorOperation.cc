...
/// @file   protocols/task_operations/RestrictToInterfaceVectorOperation.cc
...
//#include <protocols/simple_task_operations/InterfaceTaskOperation.hh> //shouldn't need this
// Project Headers
...
//#include <protocols/pose_metric_calculators/InterfaceVectorDefinitionCalculator.hh>

...
#ifndef INCLUDED_protocols_task_operations_SelectByDeltaScoreOperationCreator_hh
#define INCLUDED_protocols_task_operations_SelectByDeltaScoreOperationCreator_hh

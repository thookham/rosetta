...
#ifndef INCLUDED_protocols_task_operations_RestrictToInterfaceOperationCreator_hh
#define INCLUDED_protocols_task_operations_RestrictToInterfaceOperationCreator_hh

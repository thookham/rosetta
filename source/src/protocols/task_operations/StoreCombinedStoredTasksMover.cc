...
/// @file protocols/task_operations/StoreCombinedStoredTasksMover.cc
/// @brief The StoreCombinedStoredTasksMover HAS BEEN DEPRECATED. It was used to combine
/// several STMStoredTasks (protocols/task_operations/STMStoredTask.cc), but has been
/// replaced by the StoreCompoundTaskMover
/// (protocols/task_operations/StoreCompoundTaskMover.cc), which is much more flexible.
/// It is being moved out of devel/matdes/ into protocols/task_operations/ to support
/// the publication King et al., Nature 2014.
/// @author Jacob Bale (balej@uw.edu)

// Unit Headers
#include <protocols/task_operations/StoreCombinedStoredTasksMover.hh>
...
static basic::Tracer TR( "protocols.task_operations.StoreCombinedStoredTasksMover" );

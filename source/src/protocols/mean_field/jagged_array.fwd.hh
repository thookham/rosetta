...
typedef  jagged_array< platform::Size >      jagged_array_size_t;
typedef  jagged_array< platform::Size >      jagged_array_size;
typedef  jagged_array< platform::SSize >     jagged_array_ssize_t;
typedef  jagged_array< platform::SSize >     jagged_array_ssize;

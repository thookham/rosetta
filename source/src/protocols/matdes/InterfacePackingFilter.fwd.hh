...
/// @file   protocols/matdes/InterfacePackingFilter.fwd.hh
/// @brief  forward declaration for InterfacePackingFilter
/// @author  Jacob Bale balej@uw.edu


#ifndef INCLUDED_protocols_matdes_InterfacePackingFilter_fwd_hh
#define INCLUDED_protocols_matdes_InterfacePackingFilter_fwd_hh

...
public:
	...
	protocols::moves::MoverOP fresh_instance() const override { return utility::pointer::make_shared< MatDesGreedyOptMutationMover >(); }
	...
	~MatDesGreedyOptMutationMover() override;

...
/// @file   protocols/multistage_rosetta_scripts/cluster/ClusterMetric.fwd.hh
/// @brief
/// @author Jack Maguire

#ifndef INCLUDED_protocols_multistage_rosetta_scripts_cluster_ClusterMetric_FWD_HH

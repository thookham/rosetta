...
#define INCLUDED_protocols_carbohydrates_GlycanTreeModelerCreator_HH
...
class GlycanTreeModelerCreator : public protocols::moves::MoverCreator {
public:
...
#endif //INCLUDED_protocols_carbohydrates_GlycanTreeModelerCreator_HH

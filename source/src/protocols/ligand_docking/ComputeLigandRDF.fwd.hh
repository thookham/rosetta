...
/// @file   protocols/ligand_docking/ComputeLigandRDF.fwd.hh
///
/// @brief
/// @author Sam DeLuca


#ifndef INCLUDED_protocols_ligand_docking_ComputeLigandRDF_fwd_hh
#define INCLUDED_protocols_ligand_docking_ComputeLigandRDF_fwd_hh

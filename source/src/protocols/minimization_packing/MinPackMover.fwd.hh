...
/// @file   src/protocols/minimization_packing/MinPackMover.fwd.hh
/// @brief  Forward declaration of the mover class to both pack and minimize rotamers
/// @author Andrew Leaver-Fay (aleaverfay@gmail.com)

#ifndef INCLUDED_protocols_minimization_packing_MinPackMover_fwd_hh
#define INCLUDED_protocols_minimization_packing_MinPackMover_fwd_hh

...
#ifndef INCLUDED_protocols_minimization_packing_PackRotamersMoverLazy_fwd_hh
#define INCLUDED_protocols_minimization_packing_PackRotamersMoverLazy_fwd_hh

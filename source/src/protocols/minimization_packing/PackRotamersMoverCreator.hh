...
#ifndef INCLUDED_protocols_minimization_packing_PackRotamersMoverCreator_hh
#define INCLUDED_protocols_minimization_packing_PackRotamersMoverCreator_hh
...
class PackRotamersMoverCreator : public protocols::moves::MoverCreator {
public:

...
#ifndef INCLUDED_protocols_minimization_packing_symmetry_SymPackRotamersMoverCreator_hh
#define INCLUDED_protocols_minimization_packing_symmetry_SymPackRotamersMoverCreator_hh

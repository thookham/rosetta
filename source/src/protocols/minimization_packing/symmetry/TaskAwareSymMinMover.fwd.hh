...
#ifndef INCLUDED_protocols_minimization_packing_symmetry_TaskAwareSymMinMover_fwd_HH
#define INCLUDED_protocols_minimization_packing_symmetry_TaskAwareSymMinMover_fwd_HH

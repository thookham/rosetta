...
#ifndef INCLUDED_protocols_minimization_packing_symmetry_SymRotamerTrialsMover_fwd_hh
#define INCLUDED_protocols_minimization_packing_symmetry_SymRotamerTrialsMover_fwd_hh

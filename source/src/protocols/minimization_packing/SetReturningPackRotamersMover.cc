...
// Unit headers
#include <protocols/minimization_packing/SetReturningPackRotamersMover.hh>
...
static basic::Tracer TR( "protocols.minimization_packing.SetReturningPackRotamersMover" );

...
/// @file protocols/minimization_packing/BoltzmannRotamerMover.hh
/// @brief definition of BoltzmannRotamerMover class and functions
/// @author Noah Ollikainen (nollikai@gmail.com)

#ifndef INCLUDED_protocols_minimization_packing_BoltzmannRotamerMover_hh
#define INCLUDED_protocols_minimization_packing_BoltzmannRotamerMover_hh

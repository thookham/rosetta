...
#ifndef INCLUDED_protocols_minimization_packing_RotamerTrialsMinMover_hh
#define INCLUDED_protocols_minimization_packing_RotamerTrialsMinMover_hh
...
class EnergyCutRotamerTrialsMinMover : public protocols::minimization_packing::RotamerTrialsMinMover {
public:

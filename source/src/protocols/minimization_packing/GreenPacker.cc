...
/// @file   protocols/minimization_packing/GreenPacker.cc
...
void
GreenPacker::set_group_discriminator( protocols::minimization_packing::GroupDiscriminatorOP discriminator )
{

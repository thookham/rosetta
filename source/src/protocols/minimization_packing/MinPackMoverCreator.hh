...
/// @file protocols/minimization_packing/MinPackMoverCreator.hh
...
#ifndef INCLUDED_protocols_minimization_packing_MinPackMoverCreator_hh
#define INCLUDED_protocols_minimization_packing_MinPackMoverCreator_hh

...
/// @file protocols/minimization_packing/BoltzmannRotamerMover.fwd.hh
/// @brief
/// @author Noah Ollikainen (nollikai@gmail.com)

#ifndef INCLUDED_protocols_minimization_packing_BoltzmannRotamerMover_fwd_hh
#define INCLUDED_protocols_minimization_packing_BoltzmannRotamerMover_fwd_hh

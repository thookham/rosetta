...
/// @file /src/protocols/minimization_packing/Rotamerize.hh
/// @brief class declaration for RotamerizeMover
/// @author Jim Havranek

#ifndef INCLUDED_protocols_minimization_packing_RotamerizeMover_HH
#define INCLUDED_protocols_minimization_packing_RotamerizeMover_HH

// Unit headers
#include <protocols/minimization_packing/RotamerizeMover.fwd.hh>

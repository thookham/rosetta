...
static basic::Tracer TR( "protocols.minimization_packing.RotamerTrialsMinMover" );
...
) : protocols::minimization_packing::RotamerTrialsMinMover(scorefxn_in, task_in), mc_(std::move( mc_in )), energycut_( energycut_in )
{
	protocols::moves::Mover::type( "EnergyCutRotamerTrialsMin" );
	init();
}
...
EnergyCutRotamerTrialsMinMover::EnergyCutRotamerTrialsMinMover(
	...
	protocols::moves::MonteCarloOP mc_in,
	core::Real energycut_in
) : protocols::minimization_packing::RotamerTrialsMinMover(scorefxn_in, factory_in), mc_(std::move( mc_in )), energycut_( energycut_in )
{
	protocols::moves::Mover::type( "EnergyCutRotamerTrialsMin" );
	init();
}

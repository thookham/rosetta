...
/// @file LegacySegmentDsspRequirementCreator.hh
///
/// @brief
/// @author Tim Jacobs

#ifndef INCLUDED_protocols_legacy_sewing_sampling_requirements_LegacySegmentDsspRequirementCreator_hh
#define INCLUDED_protocols_legacy_sewing_sampling_requirements_LegacySegmentDsspRequirementCreator_hh

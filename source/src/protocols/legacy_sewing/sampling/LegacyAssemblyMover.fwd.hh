...
/// @file LegacyAssemblyMover.fwd.hh
///
/// @brief
/// @author Tim Jacobs
...
#ifndef INCLUDED_protocols_legacy_sewing_sampling_LegacyAssemblyMover_FWD_HH
#define INCLUDED_protocols_legacy_sewing_sampling_LegacyAssemblyMover_FWD_HH

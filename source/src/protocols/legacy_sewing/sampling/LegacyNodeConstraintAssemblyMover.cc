...
/// @file LegacyNodeConstraintAssemblyMover.cc
///
/// @brief
/// @author Tim Jacobs
...
// Unit Headers
#include <protocols/legacy_sewing/sampling/LegacyNodeConstraintAssemblyMover.hh>
#include <protocols/legacy_sewing/sampling/LegacyNodeConstraintAssemblyMoverCreator.hh>
...
static basic::Tracer TR( "protocols.legacy_sewing.LegacyNodeConstraintAssemblyMover" );
...
LegacyNodeConstraintAssemblyMoverCreator::create_mover() const
{
	return new LegacyNodeConstraintAssemblyMover;
}

std::string
LegacyNodeConstraintAssemblyMoverCreator::keyname() const
{
	return LegacyNodeConstraintAssemblyMoverCreator::mover_name();
}

std::string
LegacyNodeConstraintAssemblyMoverCreator::mover_name()
{
	return "LegacyNodeConstraintAssemblyMover";
}
...
std::string
LegacyNodeConstraintAssemblyMover::get_name() const {
	return "LegacyNodeConstraintAssemblyMover";
}

LegacyNodeConstraintAssemblyMover::LegacyNodeConstraintAssemblyMover():
	parent()
{}


bool
LegacyNodeConstraintAssemblyMover::check_constraints(
	core::Size index,
...
bool
LegacyNodeConstraintAssemblyMover::check_all_nodes() const {
...
///that won't work
ModelNode const *
LegacyNodeConstraintAssemblyMover::get_starting_model_node() {
...
///class method
void
LegacyNodeConstraintAssemblyMover::apply(
	core::pose::Pose & pose
) {
...
bool
LegacyNodeConstraintAssemblyMover::check_edge(
	AssemblyOP assembly,

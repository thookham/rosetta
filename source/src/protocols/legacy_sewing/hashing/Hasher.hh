...
/// @file protocols/legacy_sewing/hashing/Hasher.hh
///
...
#ifndef INCLUDED_protocols_legacy_sewing_hashing_Hasher_hh
#define INCLUDED_protocols_legacy_sewing_hashing_Hasher_hh

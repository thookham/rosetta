...
void SymSidechainMinMover::set_minmover( protocols::minimization_packing::MinMoverOP minmover_in ){ minmover_ = minmover_in; }
...
{
	interface_ = utility::pointer::make_shared< protocols::scoring::Interface >( 1 );

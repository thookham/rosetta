...
public:
	...
	inline void set_rama_cutoff_energy( core::Real const &val ) { rama_threshold_=val; return; }

	/// @brief Get the alpha_aa_rama_check or rama_prepro_check filter's rama term cutoff energy.
	/// @details Only used by alpha_aa_rama_check and rama_prepro_check filters.
	inline core::Real rama_cutoff_energy( ) const { return rama_threshold_; }
...
private:
	...
	/// @brief Should poses generated by this filter during processing be used for the BOINC "ghost" display?
	/// @brief Only does anytihng in the BOINC build.

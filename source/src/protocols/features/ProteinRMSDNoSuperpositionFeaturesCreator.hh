...
/// @file   protocols/features/ProteinRMSDNoSuperpositionFeaturesCreator.hh
...
#ifndef INCLUDED_protocols_features_ProteinRMSDNoSuperpositionFeaturesCreator_hh
...
/// @brief creator for the ProteinRMSDNoSuperpositionFeatures class

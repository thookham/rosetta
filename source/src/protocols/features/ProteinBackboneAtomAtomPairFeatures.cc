...
ProteinBackboneAtomAtomPairFeatures::write_protein_backbone_atom_atom_pairs_table_schema(
	...
	Column N_N_dist("N_N_dist", utility::pointer::make_shared< DbReal >());
	Column N_Ca_dist("N_Ca_dist", utility::pointer::make_shared< DbReal >());
	Column N_C_dist("N_C_dist", utility::pointer::make_shared< DbReal >());
	Column N_O_dist("N_O_dist", utility::pointer::make_shared< DbReal >());
	Column N_Ha_dist("N_Ha_dist", utility::pointer::make_shared< DbReal >());
	Column Ca_N_dist("Ca_N_dist", utility::pointer::make_shared< DbReal >());
	Column Ca_Ca_dist("Ca_Ca_dist", utility::pointer::make_shared< DbReal >());
	Column Ca_C_dist("Ca_C_dist", utility::pointer::make_shared< DbReal >());
	Column Ca_O_dist("Ca_O_dist", utility::pointer::make_shared< DbReal >());
	Column Ca_Ha_dist("Ca_Ha_dist", utility::pointer::make_shared< DbReal >());
	Column C_N_dist("C_N_dist", utility::pointer::make_shared< DbReal >());
	Column C_Ca_dist("C_Ca_dist", utility::pointer::make_shared< DbReal >());
	Column C_C_dist("C_C_dist", utility::pointer::make_shared< DbReal >());
	Column C_O_dist("C_O_dist", utility::pointer::make_shared< DbReal >());
	Column C_Ha_dist("C_Ha_dist", utility::pointer::make_shared< DbReal >());
	Column O_N_dist("O_N_dist", utility::pointer::make_shared< DbReal >());
	Column O_Ca_dist("O_Ca_dist", utility::pointer::make_shared< DbReal >());
	Column O_C_dist("O_C_dist", utility::pointer::make_shared< DbReal >());
	Column O_O_dist("O_O_dist", utility::pointer::make_shared< DbReal >());
	Column O_Ha_dist("O_Ha_dist", utility::pointer::make_shared< DbReal >());
	Column Ha_N_dist("Ha_N_dist", utility::pointer::make_shared< DbReal >());
	Column Ha_Ca_dist("Ha_Ca_dist", utility::pointer::make_shared< DbReal >());
	Column Ha_C_dist("Ha_C_dist", utility::pointer::make_shared< DbReal >());
	Column Ha_O_dist("Ha_O_dist", utility::pointer::make_shared< DbReal >());
	Column Ha_Ha_dist("Ha_Ha_dist", utility::pointer::make_shared< DbReal >());
...
ProteinBackboneAtomAtomPairFeaturesCreator::create_features_reporter() const {
	return utility::pointer::make_shared< ProteinBackboneAtomAtomPairFeatures >();
}

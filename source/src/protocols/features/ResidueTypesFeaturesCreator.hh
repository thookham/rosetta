...
/// @file   protocols/features/ResidueTypesFeaturesCreator.hh
/// @brief  Header for ResidueTypesFeaturesCreator for the ResidueTypesFeatures load-time factory registration scheme
/// @author Matthew O'Meara

#ifndef INCLUDED_protocols_features_ResidueTypesFeaturesCreator_hh
...
/// @brief creator for the ResidueTypesFeatures class
class ResidueTypesFeaturesCreator : public FeaturesReporterCreator
{
public:

...
/// @file   protocols/features/ResidueBurialFeatures.fwd.hh
/// @brief  report residue level geometry and scores to features Statistics Scientific Benchmark
/// @author Matthew O'Meara

#ifndef INCLUDED_protocols_features_ResidueBurialFeatures_fwd_hh
#define INCLUDED_protocols_features_ResidueBurialFeatures_fwd_hh

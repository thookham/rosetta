...
/// @file SecondaryStructureSegmentFeatures.fwd.hh
///
/// @brief
/// @author Tim Jacobs

#ifndef INCLUDED_protocols_features_SecondaryStructureSegmentFeatures_fwd_hh
#define INCLUDED_protocols_features_SecondaryStructureSegmentFeatures_fwd_hh

...
/// @file   protocols/features/RadiusOfGyrationFeatures.fwd.hh
/// @brief  report the radius of gyration to features Statistics Scientific Benchmark
/// @author Matthew O'Meara

#ifndef INCLUDED_protocols_features_RadiusOfGyrationFeatures_fwd_hh
#define INCLUDED_protocols_features_RadiusOfGyrationFeatures_fwd_hh

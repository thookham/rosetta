...
/// @file   protocols/features/ScoreTypeFeatures.fwd.hh
/// @brief  Structure scores to features Statistics Scientific Benchmark
/// @author Matthew O'Meara

#ifndef INCLUDED_protocols_features_ScoreTypeFeatures_fwd_hh
#define INCLUDED_protocols_features_ScoreTypeFeatures_fwd_hh

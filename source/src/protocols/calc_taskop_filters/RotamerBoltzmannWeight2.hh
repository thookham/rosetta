...
/// @file protocols/calc_taskop_filters/RotamerBoltzmannWeight2.hh
...
// Unit headers
#include <protocols/calc_taskop_filters/RotamerBoltzmannWeight2.fwd.hh>
...
private:
	...
	compute_score(
		...
		pose_metric_calculators::RotamerProbabilities const & probabilities ) const;

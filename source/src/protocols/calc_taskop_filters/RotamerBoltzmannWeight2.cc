...
/// @file protocols/calc_taskop_filters/RotamerBoltzmannWeight2.cc
...
RotamerBoltzmannWeight2::RotamerBoltzmannWeight2():
	...
	calculator_( new protocols::pose_metric_calculators::RotamerBoltzCalculator( core::scoring::get_score_function(), default_temperature_ ) )
{
...
{
	using protocols::pose_metric_calculators::RotamerProbabilities;
...
core::Real
compute_mean_probability( protocols::pose_metric_calculators::RotamerProbabilities const & probs )
{
	using protocols::pose_metric_calculators::RotamerProbabilities;
...
core::Real
compute_probability( protocols::pose_metric_calculators::RotamerProbabilities const & probs )
{
	using protocols::pose_metric_calculators::RotamerProbabilities;
...
core::Real
compute_max_probability( protocols::pose_metric_calculators::RotamerProbabilities const & probs )
{
	using protocols::pose_metric_calculators::RotamerProbabilities;
...
core::Real
compute_min_probability( protocols::pose_metric_calculators::RotamerProbabilities const & probs )
{
	using protocols::pose_metric_calculators::RotamerProbabilities;
...
RotamerBoltzmannWeight2::compute_modified_residue_energy(
	pose_metric_calculators::RotamerProbability const & probability ) const
{
	using protocols::pose_metric_calculators::RotamerProbability;
...
RotamerBoltzmannWeight2::compute_modified_ddg(
	...
	pose_metric_calculators::RotamerProbabilities const & probs ) const
{
	using protocols::pose_metric_calculators::RotamerProbability;
	using protocols::pose_metric_calculators::RotamerProbabilities;
...
RotamerBoltzmannWeight2::compute_ddg( core::pose::Pose const & pose ) const
{
	...
	protocols::simple_ddg::DdgFilter ddg_filter( 100/*ddg_threshold*/, scorefxn_->clone(), jump, nrepeats );
...
RotamerBoltzmannWeight2::compute_score(
	core::pose::Pose const & pose,
	protocols::pose_metric_calculators::RotamerProbabilities const & probabilities ) const
{

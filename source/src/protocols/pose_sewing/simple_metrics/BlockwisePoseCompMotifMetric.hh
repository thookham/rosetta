...
/// @file protocols/pose_sewing/simple_metrics/BlockwisePoseCompMotifMetric.hh
/// @brief composite metric returning motif scores that pass per block
/// @author frankdt (frankdt@email.unc.edu)

#ifndef INCLUDED_protocols_pose_sewing_simple_metrics_BlockwisePoseCompMotifMetric_HH
#define INCLUDED_protocols_pose_sewing_simple_metrics_BlockwisePoseCompMotifMetric_HH

#include <protocols/pose_sewing/simple_metrics/BlockwisePoseCompMotifMetric.fwd.hh>
...
///@brief composite metric returning motif scores that pass per block
class BlockwisePoseCompMotifMetric : public core::simple_metrics::CompositeRealMetric{
...
public:
	...
	void
	set_normalize_by_residues(bool in);

	void
	set_drop_best(bool in);
...
#endif //protocols_pose_sewing_simple_metrics_BlockwisePoseCompMotifMetric_HH

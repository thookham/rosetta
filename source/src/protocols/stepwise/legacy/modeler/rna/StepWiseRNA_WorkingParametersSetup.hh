...
public:
	...
	//constructor!
	StepWiseWorkingParametersSetup( utility::vector1< core::Size > const & moving_res_list,
...
private:
	...
	void
	figure_out_prepend_internal( core::Size const root_res, stepwise::modeler::rna::InternalWorkingResidueParameter const & internal_params );

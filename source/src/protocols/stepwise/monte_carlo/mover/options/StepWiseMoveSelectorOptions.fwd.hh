...
#ifndef INCLUDED_protocols_stepwise_monte_carlo_mover_options_StepWiseMoveSelectorOptions_FWD_HH
#define INCLUDED_protocols_stepwise_monte_carlo_mover_options_StepWiseMoveSelectorOptions_FWD_HH

...
/// @file protocols/stepwise/sampler/StepWiseSamplerSizedAny.fwd.hh
...
class StepWiseSamplerSizedAny;
typedef utility::pointer::shared_ptr< StepWiseSamplerSizedAny > StepWiseSamplerSizedAnyOP;

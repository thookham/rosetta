...
#ifndef INCLUDED_protocols_stepwise_StepWiseLegacyClustererSilentBased_HH
#define INCLUDED_protocols_stepwise_StepWiseLegacyClustererSilentBased_HH
...
public:
	...
	//constructor!
	StepWiseLegacyClustererSilentBased( utility::vector1< std::string > const & silent_files_in );

	StepWiseLegacyClustererSilentBased( std::string const & silent_file_in );

	StepWiseLegacyClustererSilentBased(  core::io::silent::SilentFileDataOP & sfd );
	...
	~StepWiseLegacyClustererSilentBased() override;

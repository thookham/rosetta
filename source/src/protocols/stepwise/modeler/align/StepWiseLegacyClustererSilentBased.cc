...
//  that we were keeping track of -- see StepWiseLegacyClusterer.
...
//  of modeler, but should be very memory efficient.
//
//         -- rhiju, 2014
//////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////
//constructor!
StepWiseLegacyClustererSilentBased::StepWiseLegacyClustererSilentBased( utility::vector1< std::string > const & silent_files_in )
{
...
StepWiseLegacyClustererSilentBased::StepWiseLegacyClustererSilentBased( std::string const & silent_file_in )
{
	initialize_parameters_and_input();
	input_->set_record_source( true );
...
StepWiseLegacyClustererSilentBased::StepWiseLegacyClustererSilentBased( core::io::silent::SilentFileDataOP & sfd )
{
	initialize_parameters_and_input();
	...
	bool const force_align )
{
	...
	set_max_decoys( options->sampler_num_pose_kept() );
	...
	Real cluster_radius = options->cluster_rmsd();
...
//////////////////////////////////////////////////////////////////////////
void
StepWiseLegacyClustererSilentBased::initialize_parameters_and_input(){
	max_decoys_ = 400;
	cluster_radius_ = 1.5;
...
/////////////////////////////////////////////////////////////////////
void
StepWiseLegacyClustererSilentBased::initialize_corresponding_atom_id_map( core::pose::Pose const & pose ){
	using namespace core::scoring;
...
/////////////////////////////////////////////////////////////////////
void
StepWiseLegacyClustererSilentBased::do_some_clustering() {
	...
	while ( input_->has_another_pose() ) {
		...
		Real score( 0.0 );
		getPoseExtraScore( pose, "score", score );
...
/////////////////////////////////////////////////////////////////////
void
StepWiseLegacyClustererSilentBased::initialize_cluster_list() {
...
/////////////////////////////////////////////////////////////////////
void
StepWiseLegacyClustererSilentBased::recluster_current_pose_list() {
...
///////////////////////////////////////////////////////////////
Size
StepWiseLegacyClustererSilentBased::check_for_closeness( core::pose::PoseOP const & pose_op )
{
	using namespace core::scoring;
...
//////////////////////////////////////////////////////////////////////////
// new -- this will be deprecated after we transition StepWiseLegacyClustererSilentBased
...
//////////////////////////////////////////////////////////////////////////
void
StepWiseLegacyClustererSilentBased::set_calc_rms_res( utility::vector1< core::Size > const & calc_rms_res ){
	calc_rms_res_ = calc_rms_res;
}

//////////////////////////////////////////////////////////////////////////
void
StepWiseLegacyClustererSilentBased::set_silent_file_data( core::io::silent::SilentFileDataOP & sfd ){
	input_->set_silent_file_data( sfd );
}

//////////////////////////////////////////////////////////////////////////
void
StepWiseLegacyClustererSilentBased::initialize_auto_tune_cluster_rmsds(){

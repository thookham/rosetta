...
#ifndef INCLUDED_protocols_stepwise_rna_checker_RNA_ChainClosableGeometryChecker_FWD_HH
#define INCLUDED_protocols_stepwise_rna_checker_RNA_ChainClosableGeometryChecker_FWD_HH

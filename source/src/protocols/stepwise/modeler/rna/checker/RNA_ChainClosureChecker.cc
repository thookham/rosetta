...
static basic::Tracer TR( "protocols.stepwise.modeler.rna.checker.RNA_ChainClosureChecker" );
...
RNA_ChainClosureChecker::RNA_ChainClosureChecker( pose::Pose const & pose, core::Size const five_prime_res ):
	...
	verbose_( false )
{
	chain_break_scorefxn_ = utility::pointer::make_shared< core::scoring::ScoreFunction >();

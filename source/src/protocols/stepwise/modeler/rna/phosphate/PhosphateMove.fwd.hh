...
#ifndef INCLUDED_protocols_stepwise_modeler_rna_phosphate_PhosphateMove_FWD_HH
#define INCLUDED_protocols_stepwise_modeler_rna_phosphate_PhosphateMove_FWD_HH

...
#ifndef INCLUDED_protocols_stepwise_modeler_rna_sugar_SugarVirtualizeMover_FWD_HH
#define INCLUDED_protocols_stepwise_modeler_rna_sugar_SugarVirtualizeMover_FWD_HH

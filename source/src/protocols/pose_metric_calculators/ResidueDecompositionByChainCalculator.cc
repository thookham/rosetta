...
ResidueDecompositionByChainCalculator::clone() const {
	return utility::pointer::make_shared< ResidueDecompositionByChainCalculator >(*this);
}
...
void
protocols::pose_metric_calculators::ResidueDecompositionByChainCalculator::save( Archive & arc ) const {
	arc( cereal::base_class< protocols::pose_metric_calculators::ResidueDecompositionCalculator >( this ) );
...
template< class Archive >
void
protocols::pose_metric_calculators::ResidueDecompositionByChainCalculator::load( Archive & arc ) {
	arc( cereal::base_class< protocols::pose_metric_calculators::ResidueDecompositionCalculator >( this ) );
...
SAVE_AND_LOAD_SERIALIZABLE( protocols::pose_metric_calculators::ResidueDecompositionByChainCalculator );
CEREAL_REGISTER_TYPE( protocols::pose_metric_calculators::ResidueDecompositionByChainCalculator )

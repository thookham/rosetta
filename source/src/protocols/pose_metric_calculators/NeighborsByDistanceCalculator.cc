...
protocols::pose_metric_calculators::NeighborsByDistanceCalculator::NeighborsByDistanceCalculator() :
	central_residue_( 0 ),
	dist_cutoff_( 0.0 ),
	num_neighbors_( 0 )
{}
...
void
protocols::pose_metric_calculators::NeighborsByDistanceCalculator::save( Archive & arc ) const {
...
template< class Archive >
void
protocols::pose_metric_calculators::NeighborsByDistanceCalculator::load( Archive & arc ) {
	arc( cereal::base_class< core::pose::metrics::StructureDependentCalculator >( this ) );
...
SAVE_AND_LOAD_SERIALIZABLE( protocols::pose_metric_calculators::NeighborsByDistanceCalculator );
CEREAL_REGISTER_TYPE( protocols::pose_metric_calculators::NeighborsByDistanceCalculator )

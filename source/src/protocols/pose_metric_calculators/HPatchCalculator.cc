...
void
protocols::pose_metric_calculators::HPatchCalculator::save( Archive & arc ) const {
...
template< class Archive >
void
protocols::pose_metric_calculators::HPatchCalculator::load( Archive & arc ) {
	arc( cereal::base_class< core::pose::metrics::StructureDependentCalculator >( this ) );
...
CEREAL_REGISTER_TYPE( protocols::pose_metric_calculators::HPatchCalculator )

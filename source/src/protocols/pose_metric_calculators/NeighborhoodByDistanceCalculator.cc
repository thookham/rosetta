...
protocols::pose_metric_calculators::NeighborhoodByDistanceCalculator::NeighborhoodByDistanceCalculator() :
	dist_cutoff_( 0 )
{}
...
void
protocols::pose_metric_calculators::NeighborhoodByDistanceCalculator::save( Archive & arc ) const {
...
template< class Archive >
void
protocols::pose_metric_calculators::NeighborhoodByDistanceCalculator::load( Archive & arc ) {
	arc( cereal::base_class< core::pose::metrics::StructureDependentCalculator >( this ) );
...
SAVE_AND_LOAD_SERIALIZABLE( protocols::pose_metric_calculators::NeighborhoodByDistanceCalculator );
CEREAL_REGISTER_TYPE( protocols::pose_metric_calculators::NeighborhoodByDistanceCalculator )

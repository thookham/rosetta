...
protocols::pose_metric_calculators::ClashCountCalculator::ClashCountCalculator() :
	vdw_scale_factor_( 0 )
{}
...
void
protocols::pose_metric_calculators::ClashCountCalculator::save( Archive & arc ) const {
...
template< class Archive >
void
protocols::pose_metric_calculators::ClashCountCalculator::load( Archive & arc ) {
...
SAVE_AND_LOAD_SERIALIZABLE( protocols::pose_metric_calculators::ClashCountCalculator );
CEREAL_REGISTER_TYPE( protocols::pose_metric_calculators::ClashCountCalculator )

...
void
protocols::pose_metric_calculators::NonlocalContactsCalculator::save( Archive & arc ) const {
...
template< class Archive >
void
protocols::pose_metric_calculators::NonlocalContactsCalculator::load( Archive & arc ) {
	arc( cereal::base_class< core::pose::metrics::EnergyDependentCalculator >( this ) );
...
SAVE_AND_LOAD_SERIALIZABLE( protocols::pose_metric_calculators::NonlocalContactsCalculator );
CEREAL_REGISTER_TYPE( protocols::pose_metric_calculators::NonlocalContactsCalculator )

...
void
protocols::pose_metric_calculators::ResidueDecompositionCalculator::save( Archive & arc ) const {
...
template< class Archive >
void
protocols::pose_metric_calculators::ResidueDecompositionCalculator::load( Archive & arc ) {
	arc( cereal::base_class< core::pose::metrics::StructureDependentCalculator >( this ) );
...
SAVE_AND_LOAD_SERIALIZABLE( protocols::pose_metric_calculators::ResidueDecompositionCalculator );
CEREAL_REGISTER_TYPE( protocols::pose_metric_calculators::ResidueDecompositionCalculator )

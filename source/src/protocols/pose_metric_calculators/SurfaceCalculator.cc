...
void
protocols::pose_metric_calculators::SurfaceCalculator::save( Archive & arc ) const {
...
template< class Archive >
void
protocols::pose_metric_calculators::SurfaceCalculator::load( Archive & arc ) {
	arc( cereal::base_class< core::pose::metrics::StructureDependentCalculator >( this ) );
...
SAVE_AND_LOAD_SERIALIZABLE( protocols::pose_metric_calculators::SurfaceCalculator );
CEREAL_REGISTER_TYPE( protocols::pose_metric_calculators::SurfaceCalculator )

...
template< class Archive >
void
protocols::pose_metric_calculators::EnergiesData::save( Archive & arc ) const {
...
template< class Archive >
void
protocols::pose_metric_calculators::EnergiesData::load( Archive & arc ) {
...
SAVE_AND_LOAD_SERIALIZABLE( protocols::pose_metric_calculators::EnergiesData );
...
template< class Archive >
void
protocols::pose_metric_calculators::DecomposeAndReweightEnergiesCalculator::save( Archive & arc ) const {
	...
	arc( CEREAL_NVP( other_energies_ ) ); // class protocols::pose_metric_calculators::EnergiesData
...
template< class Archive >
void
protocols::pose_metric_calculators::DecomposeAndReweightEnergiesCalculator::load( Archive & arc ) {
	arc( cereal::base_class< core::pose::metrics::EnergyDependentCalculator >( this ) );
	arc( name_of_ResidueDecompositionCalculator_ ); // std::string
	arc( original_weights_ ); // core::scoring::EnergyMap
	arc( other_energies_ ); // class protocols::pose_metric_calculators::EnergiesData
...
SAVE_AND_LOAD_SERIALIZABLE( protocols::pose_metric_calculators::DecomposeAndReweightEnergiesCalculator );
CEREAL_REGISTER_TYPE( protocols::pose_metric_calculators::DecomposeAndReweightEnergiesCalculator )

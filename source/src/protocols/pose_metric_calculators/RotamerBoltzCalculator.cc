	...
	core::pack::task::PackerTaskOP task ) const
{
	...
	protocols::score_filters::ScoreTypeFilter stf( scorefxn_, core::scoring::total_score, 0 );
...
protocols::pose_metric_calculators::RotamerBoltzCalculator::RotamerBoltzCalculator() {}

/// @brief Automatically generated serialization method
template< class Archive >
void
protocols::pose_metric_calculators::RotamerBoltzCalculator::save( Archive & arc ) const {
...
template< class Archive >
void
protocols::pose_metric_calculators::RotamerBoltzCalculator::load( Archive & arc ) {
	arc( selector_ );
	arc( evaluator_ );
	arc( lazy_ );
...
SAVE_AND_LOAD_SERIALIZABLE( protocols::pose_metric_calculators::RotamerBoltzCalculator );
CEREAL_REGISTER_TYPE( protocols::pose_metric_calculators::RotamerBoltzCalculator )

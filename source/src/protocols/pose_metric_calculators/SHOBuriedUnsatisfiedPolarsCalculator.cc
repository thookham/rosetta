...
protocols::pose_metric_calculators::SHOBuriedUnsatisfiedPolarsCalculator::SHOBuriedUnsatisfiedPolarsCalculator() {}

/// @brief Automatically generated serialization method
template< class Archive >
void
protocols::pose_metric_calculators::SHOBuriedUnsatisfiedPolarsCalculator::save( Archive & arc ) const {
	arc( cereal::base_class< core::pose::metrics::StructureDependentCalculator >( this ) );
	arc( CEREAL_NVP( search_typ_ ) ); // enum protocols::pose_metric_calculators::SHOBuriedUnsatisfiedPolarsCalculator::SearchTyp
...
template< class Archive >
void
protocols::pose_metric_calculators::SHOBuriedUnsatisfiedPolarsCalculator::load( Archive & arc ) {
	arc( cereal::base_class< core::pose::metrics::StructureDependentCalculator >( this ) );
	arc( search_typ_ ); // enum protocols::pose_metric_calculators::SHOBuriedUnsatisfiedPolarsCalculator::SearchTyp
...
SAVE_AND_LOAD_SERIALIZABLE( protocols::pose_metric_calculators::SHOBuriedUnsatisfiedPolarsCalculator );
CEREAL_REGISTER_TYPE( protocols::pose_metric_calculators::SHOBuriedUnsatisfiedPolarsCalculator )

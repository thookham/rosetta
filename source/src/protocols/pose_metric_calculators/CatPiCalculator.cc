...
/// core::pose::metrics::PoseMetricCalculatorOP cat_pi_calculator = new protocols::pose_metric_calculators::SaltBridgeCalculator();
...
void
protocols::pose_metric_calculators::CatPiCalculator::save( Archive & arc ) const {
...
template< class Archive >
void
protocols::pose_metric_calculators::CatPiCalculator::load( Archive & arc ) {
	arc( cereal::base_class< core::pose::metrics::StructureDependentCalculator >( this ) );
	arc( distance_cutoff_ ); // core::Real
	arc( cat_pi_total_ ); // core::Size
}

SAVE_AND_LOAD_SERIALIZABLE( protocols::pose_metric_calculators::CatPiCalculator );
CEREAL_REGISTER_TYPE( protocols::pose_metric_calculators::CatPiCalculator )

...
#ifndef INCLUDED_protocols_scoring_methods_pcsTs1_PseudocontactShiftTensor_hh
#define INCLUDED_protocols_scoring_methods_pcsTs1_PseudocontactShiftTensor_hh
...
public:
	...
	PCS_tensor_Ts1(PCS_tensor_Ts1 const & other);

	PCS_tensor_Ts1 &
	operator=(PCS_tensor_Ts1 const & other);

	PCS_tensor_Ts1(  core::Real const chi_xx,
	...
	void
	copy_from_ref(PCS_tensor_Ts1 & other);

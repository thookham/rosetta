...
#ifndef INCLUDED_protocols_scoring_methods_pcsTs1_PseudocontactShiftEnergy_hh
#define INCLUDED_protocols_scoring_methods_pcsTs1_PseudocontactShiftEnergy_hh
...
#include <protocols/scoring/methods/pcsTs1/PseudocontactShiftEnergy.fwd.hh>
...
class PCS_Energy_Ts1 : public core::scoring::methods::WholeStructureEnergy {
public:
...
public:
	...
	~PCS_Energy_Ts1() override;

	PCS_Energy_Ts1 &
	operator=(PCS_Energy_Ts1 const & other);

	PCS_Energy_Ts1(PCS_Energy_Ts1 const & other);
	...
	PCS_tensor_Ts1 & PCS_t,
	PCS_data_per_lanthanides_Ts1 & pcs_d_p_l
	) const; */
...
class PCS_Energy_parameters_manager_Ts1 : public utility::SingletonBase< PCS_Energy_parameters_manager_Ts1 > {
public:
	friend class utility::SingletonBase< PCS_Energy_parameters_manager_Ts1 >;

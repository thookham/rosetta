...
#ifndef INCLUDED_protocols_scoring_methods_pcsTs1_GridSearchIterator_hh
#define INCLUDED_protocols_scoring_methods_pcsTs1_GridSearchIterator_hh
...
class GridSearchIterator_Ts1 : public utility::VirtualBase {
public:
	GridSearchIterator_Ts1();

	~GridSearchIterator_Ts1() override;

	GridSearchIterator_Ts1(GridSearchIterator_Ts1 const & other);

	GridSearchIterator_Ts1 &
	operator=(GridSearchIterator_Ts1 const & other);

	GridSearchIterator_Ts1(numeric::xyzVector< core::Real > const coo1,

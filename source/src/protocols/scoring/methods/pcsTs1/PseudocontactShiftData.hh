...
#ifndef INCLUDED_protocols_scoring_methods_pcsTs1_PseudocontactShiftData_hh
#define INCLUDED_protocols_scoring_methods_pcsTs1_PseudocontactShiftData_hh

// Package headers
#include <protocols/scoring/methods/pcsTs1/PseudocontactShiftTensor.fwd.hh>
...
public:
	//PCS_data_per_lanthanides_Ts1(std::string, PCS_file_data_Ts1 & P_f_d, core::Real const weight);

	PCS_data_per_lanthanides_Ts1(std::string const &, core::Real const weight, utility::vector1< PCS_line_data_Ts1 > & PCS_d_l_a);

private:
	PCS_data_per_lanthanides_Ts1(); // Must construct with initializer

public:
	~PCS_data_per_lanthanides_Ts1();

	PCS_data_per_lanthanides_Ts1(PCS_data_per_lanthanides_Ts1 const &other);

	PCS_data_per_lanthanides_Ts1 &
	operator=( PCS_data_per_lanthanides_Ts1 const & other );
	...
	*/
	...
	core::Real
	calculate_tensor_and_cost_with_svd(PCS_tensor_Ts1 &PCS_t);
...
private:
	...
	utility::vector1<PCS_line_data_Ts1> PCS_data_line_all_spin_;
	utility::vector1<PCS_data_per_lanthanides_Ts1> PCS_data_per_lanthanides_all_;
...
public:
	...
	PCS_data_Ts1(PCS_data_input_Ts1 & P_d_i);

	PCS_data_Ts1(PCS_data_input_Ts1 & P_d_i, utility::vector1< bool > const exclude_residues );
	...
	core::Size
	where_is_line(PCS_line_data_Ts1 & P_l_d);

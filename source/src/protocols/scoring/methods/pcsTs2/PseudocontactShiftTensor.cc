...
PCS_tensor_Ts2::PCS_tensor_Ts2(){
	utility_exit_with_message( "You shouldn't call the empty constructor for PCS_tensor_Ts2" );
}

PCS_tensor_Ts2::~PCS_tensor_Ts2()= default;

PCS_tensor_Ts2::PCS_tensor_Ts2(PCS_tensor_Ts2 const & other){
	a_ = other.a_;
	b_ = other.b_;
	g_ = other.g_;
	ax_ = other.ax_;
...
PCS_tensor_Ts2 &
PCS_tensor_Ts2::operator=(PCS_tensor_Ts2 const & other){
...
///////////////////////////////////////////////
PCS_tensor_Ts2::PCS_tensor_Ts2(core::Real const chi_xx,
...
void
PCS_tensor_Ts2::reset_tensor(core::Real const chi_xx,
	core::Real const chi_xy,
	core::Real const chi_xz,
	core::Real const chi_yy,
	core::Real const chi_yz){
...
void
PCS_tensor_Ts2::copy_from_ref(PCS_tensor_Ts2 & other){
	a_ = other.a_;
	b_ = other.b_;
	g_ = other.g_;
	ax_ = other.ax_;
...
std::string const &
PCS_tensor_Ts2::get_label() const{
	return label_;
}

core::Real
PCS_tensor_Ts2::delta_X_xx() const{
	return(rh_ / 2.0 - ax_ / 3.0);
}

core::Real
PCS_tensor_Ts2::delta_X_yy() const{
	return(-rh_ / 2.0 - ax_ / 2.0);
}

core::Real
PCS_tensor_Ts2::delta_X_zz() const{
	return(2.0/3.0 * ax_);
}

core::Real
PCS_tensor_Ts2::delta_chi_zz() const{
	return(-chi_xx_ -chi_yy_);
}


core::Real
PCS_tensor_Ts2::chi_xx() const{
	return(chi_xx_);
}

core::Real
PCS_tensor_Ts2::chi_yy() const{
	return(chi_yy_);
}

core::Real
PCS_tensor_Ts2::chi_xy() const{
	return(chi_xy_);
}

core::Real
PCS_tensor_Ts2::chi_xz() const{
	return(chi_xz_);
}

core::Real
PCS_tensor_Ts2::chi_yz() const{
	return(chi_yz_);
}

...
#define INCLUDED_protocols_scoring_methods_pcsTs2_PseudocontactShiftInput_hh
...
//////////////////////////////////////////////////////////
/// @brief PCS_file_data_Ts2 contain all the information of a .npc file
/// one per lanthanide.
class PCS_file_data_Ts2 {
private:
	std::string const filename_;
	utility::vector1<PCS_line_data_Ts2> PCS_data_line_all_;
...
public:
	...
	PCS_file_data_Ts2(PCS_file_data_Ts2 const & other);

	PCS_file_data_Ts2 &
	operator=( PCS_file_data_Ts2 const & other );

	PCS_file_data_Ts2(std::string const & filename, core::Real const my_weight );
...
//////////////////////////////////////////////////////////////
/// @brief PCS_data_input_Ts2 contain all the input information for the PCS.
/// This includes all the information from the .npc files
class PCS_data_input_Ts2 {
private:
	std::map< std::string, PCS_file_data_Ts2 > PCS_filename_and_data_;
...
public:
	...
	PCS_data_input_Ts2 &
	operator=( PCS_data_input_Ts2 const & other );
...
class PCS_data_input_manager_Ts2 {

private:
	PCS_data_input_manager_Ts2();

	static PCS_data_input_manager_Ts2 * instance_;
	std::map<std::string, PCS_data_input_Ts2> file_2_data_map_;

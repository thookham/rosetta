...
#ifndef INCLUDED_protocols_scoring_methods_pcsTs2_PseudocontactShiftData_hh
...
public:
	//PCS_data_per_lanthanides_Ts2(std::string, PCS_file_data_Ts2 & P_f_d, core::Real const weight);

	PCS_data_per_lanthanides_Ts2(std::string const &, core::Real const weight, utility::vector1< PCS_line_data_Ts2 > & PCS_d_l_a);

private:
	PCS_data_per_lanthanides_Ts2(); // Must initialize in constructor
...
public:
	...
	PCS_data_per_lanthanides_Ts2 &
	operator=( PCS_data_per_lanthanides_Ts2 const & other );
	...
	*/
	...
	core::Real
	calculate_tensor_and_cost_with_svd(PCS_tensor_Ts2 &PCS_t);

	//core::Real calculate_tensor_and_cost_with_svd_precalc(PCS_tensor_Ts2 &PCS_t);
};


class PCS_data_Ts2 : public basic::datacache::CacheableData {
private:
	core::Size n_lanthanides_;
	core::Size n_pcs_spin_;
	utility::vector1<PCS_line_data_Ts2> PCS_data_line_all_spin_;
	utility::vector1<PCS_data_per_lanthanides_Ts2> PCS_data_per_lanthanides_all_;
...
public:
	...
	core::Size
	where_is_line(PCS_line_data_Ts2 & P_l_d);

...
#ifndef INCLUDED_protocols_scoring_methods_pcsTs2_PseudocontactShiftEnergy_hh
#define INCLUDED_protocols_scoring_methods_pcsTs2_PseudocontactShiftEnergy_hh
...
#include <protocols/scoring/methods/pcsTs2/PseudocontactShiftEnergy.fwd.hh>
...
class PCS_Energy_Ts2 : public core::scoring::methods::WholeStructureEnergy {
public:
...
public:
	...
	~PCS_Energy_Ts2() override;

	PCS_Energy_Ts2 &
	operator=(PCS_Energy_Ts2 const & other);

	PCS_Energy_Ts2(PCS_Energy_Ts2 const & other);
	...
	PCS_tensor_Ts2 & PCS_t,
	PCS_data_per_lanthanides_Ts2 & pcs_d_p_l
	) const; */

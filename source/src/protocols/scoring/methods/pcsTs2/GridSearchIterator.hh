...
#ifndef INCLUDED_protocols_scoring_methods_pcsTs2_GridSearchIterator_hh
#define INCLUDED_protocols_scoring_methods_pcsTs2_GridSearchIterator_hh
...
class GridSearchIterator_Ts2 : public utility::VirtualBase {
public:
	GridSearchIterator_Ts2();

	~GridSearchIterator_Ts2() override;

	GridSearchIterator_Ts2(GridSearchIterator_Ts2 const & other);

	GridSearchIterator_Ts2 &
	operator=(GridSearchIterator_Ts2 const & other);

	GridSearchIterator_Ts2(numeric::xyzVector< core::Real > const coo1,

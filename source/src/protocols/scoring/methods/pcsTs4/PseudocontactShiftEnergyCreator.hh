...
#ifndef INCLUDED_protocols_scoring_methods_pcsTs4_PseudocontactShiftEnergyCreator_hh
#define INCLUDED_protocols_scoring_methods_pcsTs4_PseudocontactShiftEnergyCreator_hh

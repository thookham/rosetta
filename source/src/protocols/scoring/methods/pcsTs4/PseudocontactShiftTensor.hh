...
#define INCLUDED_protocols_scoring_methods_pcsTs4_PseudocontactShiftTensor_hh
...
public:
	...
	PCS_tensor_Ts4(PCS_tensor_Ts4 const & other);
	...
	void
	copy_from_ref(PCS_tensor_Ts4 & other);

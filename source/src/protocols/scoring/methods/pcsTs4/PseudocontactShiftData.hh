...
#ifndef INCLUDED_protocols_scoring_methods_pcsTs4_PseudocontactShiftData_hh
#define INCLUDED_protocols_scoring_methods_pcsTs4_PseudocontactShiftData_hh
...
public:
	...
	PCS_data_per_lanthanides_Ts4 &
	operator=( PCS_data_per_lanthanides_Ts4 const & other );
...
class PCS_data_Ts4 : public basic::datacache::CacheableData {
private:
	core::Size n_lanthanides_;
	core::Size n_pcs_spin_;
	utility::vector1<PCS_line_data_Ts4> PCS_data_line_all_spin_;
	utility::vector1<PCS_data_per_lanthanides_Ts4> PCS_data_per_lanthanides_all_;
...
public:
	...
	core::Size
	where_is_line(PCS_line_data_Ts4 & P_l_d);

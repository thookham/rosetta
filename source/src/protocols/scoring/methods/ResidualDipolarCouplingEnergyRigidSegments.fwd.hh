...
#ifndef INCLUDED_protocols_scoring_methods_ResidualDipolarCouplingEnergyRigidSegments_fwd_hh
#define INCLUDED_protocols_scoring_methods_ResidualDipolarCouplingEnergyRigidSegments_fwd_hh

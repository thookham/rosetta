...
typedef utility::pointer::shared_ptr< GridSearchIterator_Ts3 > GridSearchIterator_Ts3OP;
typedef utility::pointer::shared_ptr< GridSearchIterator_Ts3 const > GridSearchIterator_Ts3COP;

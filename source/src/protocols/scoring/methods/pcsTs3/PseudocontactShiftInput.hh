...
#ifndef INCLUDED_protocols_scoring_methods_pcsTs3_PseudocontactShiftInput_hh
#define INCLUDED_protocols_scoring_methods_pcsTs3_PseudocontactShiftInput_hh
...
///////////////////////////////////////////////////////////////////////////
/// @brief PCS_line_data_Ts3 class: hold a line of the input file information (.npc format)
...
public:
	...
	PCS_line_data_Ts3 &
	operator=( PCS_line_data_Ts3 const & other );
...
//////////////////////////////////////////////////////////
/// @brief PCS_file_data_Ts3 contain all the information of a .npc file
/// one per lanthanide.
class PCS_file_data_Ts3 {
private:
	std::string const filename_;
	utility::vector1<PCS_line_data_Ts3> PCS_data_line_all_;
...
public:
	...
	PCS_file_data_Ts3(PCS_file_data_Ts3 const & other);

	PCS_file_data_Ts3 &
	operator=( PCS_file_data_Ts3 const & other );

	PCS_file_data_Ts3(std::string const & filename, core::Real const my_weight );
...
//////////////////////////////////////////////////////////////
/// @brief PCS_data_input_Ts3 contain all the input information for the PCS.
/// This includes all the information from the .npc files
class PCS_data_input_Ts3 {
private:
	std::map< std::string, PCS_file_data_Ts3 > PCS_filename_and_data_;
...
public:
	...
	PCS_data_input_Ts3(PCS_data_input_Ts3 const & other);

	PCS_data_input_Ts3 &
	operator=( PCS_data_input_Ts3 const & other );

	PCS_data_input_Ts3(utility::vector1<std::string> const & filenames,  utility::vector1<core::Real> const & weight);
...
class PCS_data_input_manager_Ts3 {

private:
	PCS_data_input_manager_Ts3();

	static PCS_data_input_manager_Ts3 * instance_;
	std::map<std::string, PCS_data_input_Ts3> file_2_data_map_;

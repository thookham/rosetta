...
#ifndef INCLUDED_protocols_scoring_methods_pcsTs3_PseudocontactShiftEnergy_hh
#define INCLUDED_protocols_scoring_methods_pcsTs3_PseudocontactShiftEnergy_hh
...
#include <protocols/scoring/methods/pcsTs3/PseudocontactShiftEnergy.fwd.hh>
...
class PCS_Energy_Ts3 : public core::scoring::methods::WholeStructureEnergy {
public:
...
public:
	...
	~PCS_Energy_Ts3() override;

	PCS_Energy_Ts3 &
	operator=(PCS_Energy_Ts3 const & other);

	PCS_Energy_Ts3(PCS_Energy_Ts3 const & other);
	...
	PCS_tensor_Ts3 & PCS_t,
	PCS_data_per_lanthanides_Ts3 & pcs_d_p_l
	) const; */
...
class PCS_Energy_parameters_manager_Ts3 : public utility::SingletonBase< PCS_Energy_parameters_manager_Ts3 > {
public:
	friend class utility::SingletonBase< PCS_Energy_parameters_manager_Ts3 >;

private:
	PCS_Energy_parameters_manager_Ts3();

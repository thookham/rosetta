...
#ifndef INCLUDED_protocols_scoring_methods_pcsTs3_PseudocontactShiftTensor_hh
#define INCLUDED_protocols_scoring_methods_pcsTs3_PseudocontactShiftTensor_hh
...
public:
	...
	PCS_tensor_Ts3 &
	operator=(PCS_tensor_Ts3 const & other);

	PCS_tensor_Ts3(  core::Real const chi_xx,
	...
	void
	copy_from_ref(PCS_tensor_Ts3 & other);

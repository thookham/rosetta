...
static basic::Tracer TR_tsr_opt_Ts3( "protocols.scoring.methods.pcsTs3.TensorsOptimizer_Ts3" );
...
TensorsOptimizer_Ts3::~TensorsOptimizer_Ts3()= default;

core::Real
TensorsOptimizer_Ts3::operator ()( core::optimization::Multivec const & vars ) const{
	core::Size i, j, idx;
	...
	for ( i = 1; i <= n_la; i++ ) {
		...
		PCS_data_per_lanthanides_Ts3 const & pcs_d_p_l(pcs_d_p_l_a[i]);

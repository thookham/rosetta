...
PCS_Energy::PCS_Energy(PCS_Energy const & /*src*/ ) = default;

PCS_Energy::~PCS_Energy()= default;
...
void
PCS_Energy::show_additional_info(std::ostream & out, core::pose::Pose & pose, bool verbose ) const {
	core::Size i, j;
	...
	PCS_data &pcs_d = PCS_data_from_pose(pose);

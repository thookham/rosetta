...
/// @file   protocols/rotamer_recovery/RRProtocolReferenceStructure.fwd.hh
/// @brief  Preform the rotamer recovery after applying mover
/// @author Matthew O'Meara

#ifndef INCLUDED_protocols_rotamer_recovery_RRProtocolReferenceStructure_fwd_hh
#define INCLUDED_protocols_rotamer_recovery_RRProtocolReferenceStructure_fwd_hh

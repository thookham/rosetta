...
#ifndef INCLUDED_protocols_sewing_scoring_MotifScorerCreator_hh
#define INCLUDED_protocols_sewing_scoring_MotifScorerCreator_hh

// Unit Headers
#include <protocols/sewing/scoring/AssemblyScorerCreator.hh>
#include <protocols/sewing/scoring/MotifScorerCreator.fwd.hh>
...
class MotifScorerCreator : public AssemblyScorerCreator
{
public:

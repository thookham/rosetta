...
/// @file   protocols/sewing/InterModelMotifScorerCreator.hh
/// @brief  Base class for AssemblyScorerCreators for the AssemblyScorer load-time factory registration scheme
/// @author Matthew O'Meara

#ifndef INCLUDED_protocols_sewing_scoring_InterModelMotifScorerCreator_hh
#define INCLUDED_protocols_sewing_scoring_InterModelMotifScorerCreator_hh

// Unit Headers
#include <protocols/sewing/scoring/AssemblyScorerCreator.hh>
#include <protocols/sewing/scoring/InterModelMotifScorerCreator.fwd.hh>

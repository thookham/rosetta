...
/// @file   protocols/sewing/PartnerMotifScorerCreator.hh
/// @brief  Base class for AssemblyScorerCreators for the AssemblyScorer load-time factory registration scheme
/// @author Matthew O'Meara

#ifndef INCLUDED_protocols_sewing_scoring_PartnerMotifScorerCreator_hh
#define INCLUDED_protocols_sewing_scoring_PartnerMotifScorerCreator_hh

// Unit Headers
#include <protocols/sewing/scoring/AssemblyScorerCreator.hh>
#include <protocols/sewing/scoring/PartnerMotifScorerCreator.fwd.hh>
...
class PartnerMotifScorerCreator : public AssemblyScorerCreator
{
public:

...
#ifndef INCLUDED_protocols_sewing_scoring_LigandScorerCreator_hh
#define INCLUDED_protocols_sewing_scoring_LigandScorerCreator_hh

// Unit Headers
#include <protocols/sewing/scoring/AssemblyScorerCreator.hh>
#include <protocols/sewing/scoring/LigandScorerCreator.fwd.hh>
...
class LigandScorerCreator : public AssemblyScorerCreator
{
public:

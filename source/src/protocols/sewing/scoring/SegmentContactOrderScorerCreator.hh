...
/// @file   protocols/sewing/SegmentContactOrderScorerCreator.hh
/// @brief  Base class for AssemblyScorerCreators for the AssemblyScorer load-time factory registration scheme
/// @author Matthew O'Meara

#ifndef INCLUDED_protocols_sewing_scoring_SegmentContactOrderScorerCreator_hh
#define INCLUDED_protocols_sewing_scoring_SegmentContactOrderScorerCreator_hh

// Unit Headers
#include <protocols/sewing/scoring/AssemblyScorerCreator.hh>
#include <protocols/sewing/scoring/SegmentContactOrderScorerCreator.fwd.hh>
...
class SegmentContactOrderScorerCreator : public AssemblyScorerCreator
{
public:

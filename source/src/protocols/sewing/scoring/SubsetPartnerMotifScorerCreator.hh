...
/// @file   protocols/sewing/SubsetPartnerMotifScorerCreator.hh
/// @brief  Base class for AssemblyScorerCreators for the AssemblyScorer load-time factory registration scheme
/// @author Matthew O'Meara

#ifndef INCLUDED_protocols_sewing_scoring_SubsetPartnerMotifScorerCreator_hh
#define INCLUDED_protocols_sewing_scoring_SubsetPartnerMotifScorerCreator_hh

// Unit Headers
#include <protocols/sewing/scoring/AssemblyScorerCreator.hh>
#include <protocols/sewing/scoring/SubsetPartnerMotifScorerCreator.fwd.hh>
...
class SubsetPartnerMotifScorerCreator : public AssemblyScorerCreator
{
public:

...
#ifndef INCLUDED_protocols_sewing_scoring_TopNMotifScorerCreator_hh
#define INCLUDED_protocols_sewing_scoring_TopNMotifScorerCreator_hh

// Unit Headers
#include <protocols/sewing/scoring/AssemblyScorerCreator.hh>
#include <protocols/sewing/scoring/TopNMotifScorerCreator.fwd.hh>
...
class TopNMotifScorerCreator : public AssemblyScorerCreator
{
public:

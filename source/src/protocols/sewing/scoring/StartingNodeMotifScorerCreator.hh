...
/// @file   protocols/sewing/StartingNodeMotifScorerCreator.hh
/// @brief  Base class for AssemblyScorerCreators for the AssemblyScorer load-time factory registration scheme
/// @author Matthew O'Meara

#ifndef INCLUDED_protocols_sewing_scoring_StartingNodeMotifScorerCreator_hh
#define INCLUDED_protocols_sewing_scoring_StartingNodeMotifScorerCreator_hh

// Unit Headers
#include <protocols/sewing/scoring/AssemblyScorerCreator.hh>
#include <protocols/sewing/scoring/StartingNodeMotifScorerCreator.fwd.hh>

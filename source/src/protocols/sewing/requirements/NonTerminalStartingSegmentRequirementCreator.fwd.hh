...
#ifndef INCLUDED_protocols_sewing_requirements_NonTerminalStartingSegmentRequirementCreator_fwd_hh
#define INCLUDED_protocols_sewing_requirements_NonTerminalStartingSegmentRequirementCreator_fwd_hh
...
typedef utility::pointer::shared_ptr< NonTerminalStartingSegmentRequirementCreator > NonTerminalStartingSegmentRequirementCreatorOP;

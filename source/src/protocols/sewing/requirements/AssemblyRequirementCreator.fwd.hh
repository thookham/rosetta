...
#ifndef INCLUDED_protocols_sewing_requirements_AssemblyRequirementCreator_fwd_hh
#define INCLUDED_protocols_sewing_requirements_AssemblyRequirementCreator_fwd_hh
...
typedef utility::pointer::shared_ptr< AssemblyRequirementCreator > AssemblyRequirementCreatorOP;

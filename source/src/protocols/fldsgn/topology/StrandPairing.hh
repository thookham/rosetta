...
class StrandPairing : public utility::VirtualBase {
public:
...
public: //accessors
	...
	inline utility::vector1< core::Size > pleats1() const { return pleats1_; }

	/// @brief the pleating at the end of strand_pairing
	inline utility::vector1< core::Size > pleats2() const { return pleats2_; }
	...
	bool is_bulge( core::Size const resid ) const { return ( bulges1_.find( resid ) != bulges1_.end() ) || ( bulges2_.find( resid ) != bulges2_.end() ); }
...
private:  // data
	...
	utility::vector1< core::Size > pleats1_, pleats2_;
...
private:// data
	...
	mutable std::map< core::Size, VecSize > neighbor_strands_;

...
/// @file   src/protocols/fldsgn/filters/SecondaryStructureHasResidueFilter.fwd.hh
/// @brief
/// @author Chris King (chrisk1@uw.edu)


#ifndef INCLUDED_protocols_fldsgn_filters_SecondaryStructureHasResidueFilter_fwd_hh
#define INCLUDED_protocols_fldsgn_filters_SecondaryStructureHasResidueFilter_fwd_hh

...
/// @file protocols/fldsgn/filters/StrandCurvatureByLevelsCreator.hh
/// @brief Newer version of filter used in Marcos & Basanta et al. 2017
/// @author Benjamin Basanta (basantab@uw.edu)

#ifndef INCLUDED_protocols_fldsgn_filters_StrandCurvatureByLevelsCreator_hh
#define INCLUDED_protocols_fldsgn_filters_StrandCurvatureByLevelsCreator_hh
...
class StrandCurvatureByLevelsCreator : public protocols::filters::FilterCreator {
public:

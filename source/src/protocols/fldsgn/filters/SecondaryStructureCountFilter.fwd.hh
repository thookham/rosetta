...
/// @file   src/protocols/fldsgn/filters/SecondaryStructureCountFilter.fwd.hh
/// @brief
/// @author Lei Shi (shilei@uw.edu)


#ifndef INCLUDED_protocols_fldsgn_filters_SecondaryStructureCountFilter_fwd_hh
#define INCLUDED_protocols_fldsgn_filters_SecondaryStructureCountFilter_fwd_hh

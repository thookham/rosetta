...
/// @file protocols/docking/EnsureExclusivelySharedJumpMover.fwd.hh
/// @brief forward declarations for EnsureExclusivelySharedJumpMover
/// @author Jack Maguire

#ifndef INCLUDED_protocols_docking_EnsureExclusivelySharedJumpMover_fwd_hh
#define INCLUDED_protocols_docking_EnsureExclusivelySharedJumpMover_fwd_hh

...
/// @file   protocols/parser/ScoreFunctionLoader.hh
...
#ifndef INCLUDED_protocols_parser_ScoreFunctionLoader_hh
#define INCLUDED_protocols_parser_ScoreFunctionLoader_hh

...
#ifndef INCLUDED_protocols_parser_JumpSelectorLoaderCreator_hh
#define INCLUDED_protocols_parser_JumpSelectorLoaderCreator_hh
...
class JumpSelectorLoaderCreator : public DataLoaderCreator
{
public:

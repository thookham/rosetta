...
/// @file   protocols/parser/SimpleMetricLoader.hh
/// @brief  Declartion of the XML parser's SimpleMetricLoader class for adding named SimpleMetrics to the basic::datacache::DataMap
/// @author Andrew Leaver-Fay (aleaverfay@gmail.com)

#ifndef INCLUDED_protocols_parser_SimpleMetricLoader_hh
#define INCLUDED_protocols_parser_SimpleMetricLoader_hh
...
class SimpleMetricLoader : public DataLoader
{
public:
	SimpleMetricLoader();

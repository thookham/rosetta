...
/// @file   protocols/frag_picker/BuriedUnsatHbondFilter.fwd.hh
/// @brief
/// @author Cody Krivacic (krivacic@berkeley.edu)

#ifndef INCLUDED_protocols_frag_picker_FragmentScoreFilter_fwd_hh
#define INCLUDED_protocols_frag_picker_FragmentScoreFilter_fwd_hh

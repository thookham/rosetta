...
/// @file   protocols/frag_picker/scores/AtomBasedConstraintsScore.fwd.hh
/// @brief  AtomBasedConstraintsScore forward declaration
/// @author Dominik Gront (dgront@chem.uw.edu.pl)

#ifndef INCLUDED_protocols_frag_picker_scores_AtomBasedConstraintsScore_fwd_hh
#define INCLUDED_protocols_frag_picker_scores_AtomBasedConstraintsScore_fwd_hh

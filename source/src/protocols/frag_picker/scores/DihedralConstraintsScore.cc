...
DihedralConstraintsScore::DihedralConstraintsScore(core::Size priority,
	...
	factory_.add_type("PERIODIC", utility::pointer::make_shared< core::scoring::func::PeriodicFunc >(
		0, 0, 0, 0));
...
FragmentScoringMethodOP MakeDihedralConstraintsScore::make(core::Size priority,
	...
	if ( option[constraints::cst_file].user() ) {
		...
		return (FragmentScoringMethodOP) utility::pointer::make_shared< DihedralConstraintsScore >(priority,

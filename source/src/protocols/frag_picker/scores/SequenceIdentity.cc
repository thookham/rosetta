...
/// @file   protocols/frag_picker/scores/SequenceIdentity.cc
...
bool SequenceIdentity::score(FragmentCandidateOP f,
...
bool SequenceIdentity::describe_score(FragmentCandidateOP f,

...
public:
	...
	SequenceIdentity(core::Size priority, core::Real lowest_acceptable_value, bool use_lowest,
...
public:
	...
	FragmentScoringMethodOP make(core::Size priority, core::Real lowest_acceptable_value, bool use_lowest,
		...
		return (FragmentScoringMethodOP) utility::pointer::make_shared< SequenceIdentity >(priority,

...
/// @brief  FragmentScoringMethod forward declaration
/// @author Dominik Gront (dgront@chem.uw.edu.pl)

#ifndef INCLUDED_protocols_frag_picker_scores_FragmentScoringMethod_fwd_hh
#define INCLUDED_protocols_frag_picker_scores_FragmentScoringMethod_fwd_hh
...
#endif /* INCLUDED_protocols_frag_picker_scores_FragmentScoringMethod_FWD_HH */

...
#ifndef INCLUDED_protocols_frag_picker_scores_DihedralConstraintsScore_fwd_hh
#define INCLUDED_protocols_frag_picker_scores_DihedralConstraintsScore_fwd_hh
...
#endif /* INCLUDED_protocols_frag_picker_scores_DihedralConstraintsScore_FWD_HH */

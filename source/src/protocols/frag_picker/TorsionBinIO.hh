...
/// @file   protocols/frag_picker/TorsionBinIO.hh
/// @brief reader for a probability distribution over A,B,E,G,O torsion bins.
/// @author James Thompson

#ifndef INCLUDED_protocols_frag_picker_TorsionBinIO_hh
#define INCLUDED_protocols_frag_picker_TorsionBinIO_hh
...
#endif /* INCLUDED_protocols_frag_picker_TorsionBinIO_HH */

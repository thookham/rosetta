...
#ifndef INCLUDED_protocols_antibody_task_operations_DisableCDRsOperationCreator_fwd_hh
#define INCLUDED_protocols_antibody_task_operations_DisableCDRsOperationCreator_fwd_hh

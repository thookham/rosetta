...
/// @file protocols/antibody/GraftedStemOptimizer.fwd.hh
/// @brief
/// @author Jianqing Xu (xubest@gmail.com)

#ifndef INCLUDED_protocols_antibody_GraftedStemOptimizer_fwd_hh
#define INCLUDED_protocols_antibody_GraftedStemOptimizer_fwd_hh

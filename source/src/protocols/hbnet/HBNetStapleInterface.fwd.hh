...
/// @file   <protocols/hbnet/HBNetStapleInterface.fwd.hh
/// @brief
/// @author Scott Boyken (sboyken@gmail.com)

#ifndef INCLUDED_protocols_hbnet_HBNetStapleInterface_fwd_hh
#define INCLUDED_protocols_hbnet_HBNetStapleInterface_fwd_hh

...
/// @file   protocols/hbnet/HBNetTaskOperations.fwd.hh
/// @brief
/// @author Scott Boyken (sboyken@gmail.com)

#ifndef INCLUDED_protocols_hbnet_HBNetTaskOperations_fwd_hh
#define INCLUDED_protocols_hbnet_HBNetTaskOperations_fwd_hh

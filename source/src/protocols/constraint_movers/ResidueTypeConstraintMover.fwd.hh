...
#ifndef INCLUDED_protocols_constraint_movers_ResidueTypeConstraintMover_fwd_hh
#define INCLUDED_protocols_constraint_movers_ResidueTypeConstraintMover_fwd_hh

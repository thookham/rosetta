...
/// @file MultiStateAggregateFunction.fwd.hh
/// @brief
/// @author Colin A. Smith

#ifndef INCLUDED_protocols_multistate_design_MultiStateAggregateFunction_fwd_hh
#define INCLUDED_protocols_multistate_design_MultiStateAggregateFunction_fwd_hh

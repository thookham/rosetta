...
/// @file UniformRigidBodyMover.fwd.hh
/// @brief definition of the FragmentJumpCM class
/// @author

#ifndef INCLUDED_protocols_rigid_UniformRigidBodyMover_fwd_hh
...
#endif //INCLUDED_protocols_rigid_UniformRigidBodyMover_fwd_hh

...
// Unit headers
#include <protocols/rna/denovo/coarse/CoarseRNA_DeNovoProtocol.hh>
...
#include <protocols/rna/denovo/setup/RNA_DeNovoPoseSetup.hh>
...
void CoarseRNA_DeNovoProtocol::apply( core::pose::Pose & pose ) {
	...
	if ( check_pairing_dists_ )  protocols::rna::denovo::print_internal_coords( pose );

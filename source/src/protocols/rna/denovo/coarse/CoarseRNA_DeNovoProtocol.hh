...
#include <protocols/rna/denovo/coarse/MultipleDomainMover.fwd.hh>
#include <protocols/rna/denovo/libraries/RNA_ChunkLibrary.fwd.hh>
#include <protocols/rna/denovo/setup/RNA_DeNovoPoseSetup.fwd.hh>
...
private:
	...
	protocols::rna::denovo::RNA_FragmentMoverOP frag_mover_;
	protocols::rna::denovo::RNA_DeNovoPoseSetupOP rna_structure_parameters_;
	...
	protocols::rna::denovo::MultipleDomainMoverOP multiple_domain_mover_;

...
/// @file protocols/rna/denovo/RNA_FragmentMonteCarlo.fwd.hh
/// @brief
/// @details
/// @author Rhiju Das, rhiju@stanford.edu


#ifndef INCLUDED_protocols_farna_RNA_FragmentMonteCarlo_FWD_HH
#define INCLUDED_protocols_farna_RNA_FragmentMonteCarlo_FWD_HH

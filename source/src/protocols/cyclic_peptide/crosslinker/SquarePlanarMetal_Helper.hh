...
/// @file protocols/cyclic_peptide/crosslinker/SquarePlanarMetal_Helper.hh
/// @brief A helper class for setting up square planarly-coordinated metals
/// like Ni.
/// @author Vikram K. Mulligan (vmullig@u.washington.edu)

#ifndef INCLUDED_protocols_cyclic_peptide_crosslinker_SquarePlanarMetal_Helper_hh
#define INCLUDED_protocols_cyclic_peptide_crosslinker_SquarePlanarMetal_Helper_hh

// Unit headers
#include <protocols/cyclic_peptide/crosslinker/SquarePlanarMetal_Helper.fwd.hh>
...
/// @brief A helper class for setting up square planarly-coordinated metals
/// like Ni.
class SquarePlanarMetal_Helper : public Metal_HelperBase {

public: //Constructors

	/// @brief Default constructor
	SquarePlanarMetal_Helper( std::string const &metal_name_in = "Zn" );
...
protected: // protected methods
	...
	void add_dihedral_constraint_to_stream( std::stringstream &cststream, core::pose::Pose const &pose, utility::vector1< core::Size > const &res_indices ) const;
	...
	/// @brief Set whether this is actually the square pyramidal case.
	/// @details Only called by derived class, in constructor.
	inline void set_pyramidal( bool const setting ) { is_pyramidal_ = setting; }

	/// @brief Return whether this is actually the square pyramidal case.
	/// @details Only called by derived class.
	inline bool is_pyramidal() const { return is_pyramidal_; }

private:

	/// @brief Is this actually the square pyramidal case?
	/// @details Defaults to false.  Set to true by derived class.
	bool is_pyramidal_;
...
#endif //protocols/cyclic_peptide_crosslinker_SquarePlanarMetal_Helper_hh

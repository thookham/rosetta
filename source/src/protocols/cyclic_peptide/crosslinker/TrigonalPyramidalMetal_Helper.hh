...
/// @file protocols/cyclic_peptide/crosslinker/TrigonalPyramidalMetal_Helper.hh
/// @brief A helper class for setting up trigonal pyramidally-coordinated metals
/// like Zn or Cu.
/// @author Vikram K. Mulligan (vmullig@u.washington.edu)

#ifndef INCLUDED_protocols_cyclic_peptide_crosslinker_TrigonalPyramidalMetal_Helper_hh
#define INCLUDED_protocols_cyclic_peptide_crosslinker_TrigonalPyramidalMetal_Helper_hh

// Unit headers
#include <protocols/cyclic_peptide/crosslinker/TrigonalPyramidalMetal_Helper.fwd.hh>
...
/// @brief A helper class for setting up trigonal pyramidally-coordinated metals
/// like Zn or Cu.
class TrigonalPyramidalMetal_Helper : public Metal_HelperBase {

public: //Constructors

	/// @brief Default constructor
	TrigonalPyramidalMetal_Helper( std::string const &metal_name_in = "Zn" );

	/// @brief Copy constructor
	TrigonalPyramidalMetal_Helper( TrigonalPyramidalMetal_Helper const & src );

	/// @brief Destructor (important for properly forward-declaring smart-pointer members)
	~TrigonalPyramidalMetal_Helper() override;
...
#endif //protocols/cyclic_peptide_crosslinker_TrigonalPyramidalMetal_Helper_hh

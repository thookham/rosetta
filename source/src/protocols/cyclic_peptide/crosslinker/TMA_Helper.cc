...
/// unpublished.
void
TMA_Helper::provide_citation_info(
	basic::citation_manager::CitationCollectionList & citations
) const {
	citations.add(
		utility::pointer::make_shared< basic::citation_manager::UnpublishedModuleInfo >(
		"TMA_Helper", basic::citation_manager::CitedModuleType::CrosslinkerMoverHelper,
		"Vikram K. Mulligan", "Systems Biology Group, Center for Computational Biology, Flatiron Institute",
		"vmulligan@flatironinstitute.org", "Added support for trimesic acid crosslinking to the CrosslinkerMover."
		)
	);
}

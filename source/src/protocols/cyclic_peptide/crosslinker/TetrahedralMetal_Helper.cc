...
void
TetrahedralMetal_Helper::provide_citation_info(
	basic::citation_manager::CitationCollectionList & citations
) const {
	basic::citation_manager::CitationCollectionOP cc(
		utility::pointer::make_shared< basic::citation_manager::CitationCollection >(
		"TetrahedralMetal_Helper", basic::citation_manager::CitedModuleType::CrosslinkerMoverHelper
		)
	);
	cc->add_citation(
...
TetrahedralMetal_Helper::is_allowed_type(
	...
	if ( type_aa == core::chemical::aa_his || type_aa == core::chemical::aa_dhi || type_aa == core::chemical::aa_b3h ||
			...
			type.base_name() == "C26" || type.base_name() == "DC26" /*homocysteine*/ )

...
/// @file fwd.hh file for enzdes cacheable observer
/// @brief
/// @author Florian Richter, floric@u.washington.edu

#ifndef INCLUDED_protocols_toolbox_match_enzdes_util_EnzdesCacheableObserver_fwd_hh
#define INCLUDED_protocols_toolbox_match_enzdes_util_EnzdesCacheableObserver_fwd_hh

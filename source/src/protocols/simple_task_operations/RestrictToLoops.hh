...
#ifndef INCLUDED_protocols_task_operations_RestrictToLoops_HH
#define INCLUDED_protocols_task_operations_RestrictToLoops_HH

// Unit headers
#include <protocols/simple_task_operations/RestrictToLoops.fwd.hh>

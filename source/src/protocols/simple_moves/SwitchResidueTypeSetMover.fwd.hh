...
/// @file SwitchResidueTypeSetMover.fwd.hh
/// @brief switch between residue type sets (e.g. centroid and all atom)
/// @author

#ifndef INCLUDED_protocols_simple_moves_SwitchResidueTypeSetMover_fwd_hh
#define INCLUDED_protocols_simple_moves_SwitchResidueTypeSetMover_fwd_hh
...
#endif // INCLUDED_protocols_simple_moves_SwitchResidueTypeSetMover_fwd_hh

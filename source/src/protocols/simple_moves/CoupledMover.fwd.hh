...
/// @file protocols/simple_moves/CoupledMover.fwd.hh
/// @brief
/// @author Noah Ollikainen (nollikai@gmail.com)

#ifndef INCLUDED_protocols_simple_moves_CoupledMover_fwd_hh
#define INCLUDED_protocols_simple_moves_CoupledMover_fwd_hh

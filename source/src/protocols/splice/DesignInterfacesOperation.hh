...
#ifndef INCLUDED_protocols_splice_DesignInterfacesOperation_hh
#define INCLUDED_protocols_splice_DesignInterfacesOperation_hh

// Unit Headers
#include <protocols/splice/DesignInterfacesOperation.fwd.hh>

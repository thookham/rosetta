...
#ifndef INCLUDED_protocols_indexed_structure_store_H5FragmentStoreBackend_hh
#define INCLUDED_protocols_indexed_structure_store_H5FragmentStoreBackend_hh

...
//
/// @file protocols/indexed_structure_store/DirStructureStoreBackend.hh
/// @brief Directory-backed protein structure store.
/// @author Alex Ford <fordas@uw.edu>
//

#ifndef INCLUDED_protocols_indexed_structure_store_DirStructureStoreBackend_HH
#define INCLUDED_protocols_indexed_structure_store_DirStructureStoreBackend_HH
...
// Encapsulates reading Structure/Residue data from a directory of pdb files.
class DirStructureStoreBackend : public StructureStoreProvider
{
public:

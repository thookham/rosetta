...
PseudocontactShiftEnergyController_Ts1::PseudocontactShiftEnergyController_Ts1()
{
...
void
PseudocontactShiftEnergyController_Ts1::set_defaults( ){

}

bool PseudocontactShiftEnergyController_Ts1::read_tag( std::string tag, std::istream& is ) {
...
void
PseudocontactShiftEnergyController_Ts1::init_after_reading(){
	using namespace protocols::scoring::methods::pcsTs1;
	control_grid_param();

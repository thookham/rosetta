...
#ifndef INCLUDED_protocols_topology_broker_PseudocontactShiftEnergyController_Ts2_hh
#define INCLUDED_protocols_topology_broker_PseudocontactShiftEnergyController_Ts2_hh

// Unit Headers
#include <protocols/topology_broker/PseudocontactShiftEnergyController_Ts2.fwd.hh>
...
class PseudocontactShiftEnergyController_Ts2 : public TopologyClaimer {

	typedef TopologyClaimer Parent;
public:
	PseudocontactShiftEnergyController_Ts2(); //for factory

	TopologyClaimerOP clone() const override {
		return utility::pointer::make_shared< PseudocontactShiftEnergyController_Ts2 >( *this );
	}
	...
	static std::string _static_type_name() {
		return "PseudocontactShiftEnergyController_Ts2";
	}

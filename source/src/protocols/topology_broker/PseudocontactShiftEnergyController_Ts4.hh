...
#ifndef INCLUDED_protocols_topology_broker_PseudocontactShiftEnergyController_Ts4_hh
#define INCLUDED_protocols_topology_broker_PseudocontactShiftEnergyController_Ts4_hh

// Unit Headers
#include <protocols/topology_broker/PseudocontactShiftEnergyController_Ts4.fwd.hh>
...
class PseudocontactShiftEnergyController_Ts4 : public TopologyClaimer {

	typedef TopologyClaimer Parent;
public:
	PseudocontactShiftEnergyController_Ts4(); //for factory

	TopologyClaimerOP clone() const override {
		return utility::pointer::make_shared< PseudocontactShiftEnergyController_Ts4 >( *this );
	}
	...
	static std::string _static_type_name() {
		return "PseudocontactShiftEnergyController_Ts4";
	}

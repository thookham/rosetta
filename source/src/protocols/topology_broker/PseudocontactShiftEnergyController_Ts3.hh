...
#ifndef INCLUDED_protocols_topology_broker_PseudocontactShiftEnergyController_Ts3_hh
#define INCLUDED_protocols_topology_broker_PseudocontactShiftEnergyController_Ts3_hh

// Unit Headers
#include <protocols/topology_broker/PseudocontactShiftEnergyController_Ts3.fwd.hh>
...
class PseudocontactShiftEnergyController_Ts3 : public TopologyClaimer {

	typedef TopologyClaimer Parent;
public:
	PseudocontactShiftEnergyController_Ts3(); //for factory

	TopologyClaimerOP clone() const override {
		return utility::pointer::make_shared< PseudocontactShiftEnergyController_Ts3 >( *this );
	}
	...
	static std::string _static_type_name() {
		return "PseudocontactShiftEnergyController_Ts3";
	}

...
/// @file   protocols/protein_interface_design/filters/RelativeSegmentFilterCreator.hh
...
class RelativeSegmentFilterCreator : public protocols::filters::FilterCreator
{
public:

...
MatchCollisionFilter::MatchCollisionFilter(
	...
	empty_pose_( utility::pointer::make_shared< core::pose::Pose >() ),
	empty_sfxn_( utility::pointer::make_shared< core::scoring::ScoreFunction >() ),
	etable_energy_( /* 0 */ ),
	bump_grid_( utility::pointer::make_shared< BumpGrid >() )
{}
...
void MatchCollisionFilter::set_filter_by_lj( bool setting )
{
	...
	if ( filter_by_lj_ ) {
		...
		etable_energy_ = utility::pointer::make_shared< TableLookupEtableEnergy >(

...
/// @file   protocols/match/output/MatchEvaluator.fwd.hh
/// @brief  Forward declaration for abstract class to filter matches.
/// @author Alex Zanghellini (zanghell@u.washington.edu)
/// @author Andrew Leaver-Fay (aleaverfay@gmail.com), porting to mini

#ifndef INCLUDED_protocols_match_output_MatchEvaluator_fwd_hh
#define INCLUDED_protocols_match_output_MatchEvaluator_fwd_hh

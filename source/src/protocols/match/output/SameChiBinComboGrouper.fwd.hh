...
/// @file   protocols/match/output/SameChiBinComboGrouper.fwd.hh
/// @brief
/// @author Alex Zanghellini (zanghell@u.washington.edu)
/// @author Andrew Leaver-Fay (aleaverfay@gmail.com), porting to mini

#ifndef INCLUDED_protocols_match_output_SameChiBinComboGrouper_fwd_hh
#define INCLUDED_protocols_match_output_SameChiBinComboGrouper_fwd_hh

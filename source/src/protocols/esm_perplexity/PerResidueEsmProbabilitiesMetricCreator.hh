...
/// @file protocols/esm_perplexity/PerResidueEsmProbabilitiesMetricCreator.hh
/// @brief Predicting amino acid probabilities using the ESM language model
/// @author MoritzErtelt (moritz.ertelt@googlemail.com)

#ifndef INCLUDED_protocols_esm_perplexity_PerResidueEsmProbabilitiesMetricCreator_HH
#define INCLUDED_protocols_esm_perplexity_PerResidueEsmProbabilitiesMetricCreator_HH
...
class PerResidueEsmProbabilitiesMetricCreator : public core::simple_metrics::SimpleMetricCreator {
public:
...
#endif //INCLUDED_protocols_esm_perplexity_PerResidueEsmProbabilitiesMetricCreator_HH

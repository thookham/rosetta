...
/// @file protocols/branch_angle/BranchParam2.hh
/// @brief definition/implementation of BranchParam2 class and methods
/// @author Colin A. Smith (colin.smith@ucsf.edu)


#ifndef INCLUDED_protocols_branch_angle_BranchParam2_hh
#define INCLUDED_protocols_branch_angle_BranchParam2_hh
...
class BranchParam2 : public BranchParam1 {
...
public:
	...
	BranchParam2(
		...
		m2_b2_Ktheta_(m2_b2_Ktheta),
		m2_b2_theta0_(m2_b2_theta0),
		b1_b2_Ktheta_(b1_b2_Ktheta),
		b1_b2_theta0_(b1_b2_theta0)
	{}

	/// @brief get Ktheta for mainchain atom 1 - branching atom 2 angle
	core::Real
	m1_b2_Ktheta() const
	{
		return m1_b2_Ktheta_;
	}

	/// @brief get theta0 for mainchain atom 1 - branching atom 2 angle
	core::Real
	m1_b2_theta0() const
	{
		return m1_b2_theta0_;
	}

	/// @brief get Ktheta for mainchain atom 2 - branching atom 2 angle
	core::Real
	m2_b2_Ktheta() const
	{
		return m2_b2_Ktheta_;
	}

	/// @brief get theta0 for mainchain atom 2 - branching atom 2 angle
	core::Real
	m2_b2_theta0() const
	{
		return m2_b2_theta0_;
	}

	/// @brief get Ktheta for branching atom 1 - branching atom 2 angle
	core::Real
	b1_b2_Ktheta() const
	{
		return b1_b2_Ktheta_;
	}

	/// @brief get theta0 for branching atom 1 - branching atom 2 angle
	core::Real
	b1_b2_theta0() const
	{
		return b1_b2_theta0_;
	}

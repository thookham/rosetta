...
) const
{
	...
	int const main_mmtype1(pose.residue_type(main_atomid1.rsd()).mm_atom_type_index(main_atomid1.atomno()));
	int const center_mmtype(pose.residue_type(center_atomid.rsd()).mm_atom_type_index(center_atomid.atomno()));
	int const main_mmtype2(pose.residue_type(main_atomid2.rsd()).mm_atom_type_index(main_atomid2.atomno()));
	int const branch_mmtype1(pose.residue_type(branch_atomid1.rsd()).mm_atom_type_index(branch_atomid1.atomno()));
...
) const
{
	...
	int const main_mmtype2(pose.residue_type(main_atomid2.rsd()).mm_atom_type_index(main_atomid2.atomno()));
	int const branch_mmtype1(pose.residue_type(branch_atomid1.rsd()).mm_atom_type_index(branch_atomid1.atomno()));
	int const branch_mmtype2(pose.residue_type(branch_atomid2.rsd()).mm_atom_type_index(branch_atomid2.atomno()));

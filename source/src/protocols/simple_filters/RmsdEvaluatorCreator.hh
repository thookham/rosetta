...
#ifndef INCLUDED_protocols_simple_filters_RmsdEvaluatorCreator_hh
#define INCLUDED_protocols_simple_filters_RmsdEvaluatorCreator_hh
...
class RmsdEvaluatorCreator : public evaluation::EvaluatorCreator
{
public:

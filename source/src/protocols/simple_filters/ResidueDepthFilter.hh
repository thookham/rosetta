...
public:
	...
	utility::vector1< core::Vector > get_CENcrd() const;
	utility::vector1< core::Vector > get_CAcrd() const;

	core::Vector get_CENcrd( core::Size const i ) const { return rdds_[i]->CENcrd; }
	core::Vector get_CAcrd( core::Size const i ) const { return rdds_[i]->CAcrd; }
...
private:
	...
	utility::vector1< core::Vector >
	get_coarse_crd( utility::vector1< core::Vector > const &protein_crd,
		utility::vector1< core::Size > const &coarse_index
	) const;

	void
	duplicate_waterbox( utility::vector1< core::Vector > const &unit_waterbox_crd,
		core::Vector const boxwidth,
		core::Vector const mincrds, core::Vector const maxcrds ) const;

	core::Vector
	bring_to_origin( utility::vector1< core::Vector > &protein_crd,
		core::Vector &maxcrds,
		core::Vector &mincrds
	) const;

	void
	append_unitbox( utility::vector1< core::Vector > const &unitbox,
		utility::vector1< core::Vector > &waterbox_dupl,
		core::Vector const boxwidth,
		int const i, int const j, int const k ) const;

	void
	pert_protein( utility::vector1< core::Vector > &protein_crd ) const;

	utility::vector1< core::Vector >
	quat2U( core::Vector const & quat3, core::Real const &quatw ) const;

	utility::vector1< bool >
	get_exclusion_index( utility::vector1< core::Vector > const & protein_crd,
		utility::vector1< core::Vector > const & protein_coarse_crd ) const;
...
private:
	...
	*/
	...
	utility::vector1< core::Size >
	search_close_frags( utility::vector1< core::Vector > const &frag_crd,
		core::Size const n8,
	...
	get_residue_similarity( core::conformation::Residue const& rsd,
		utility::vector1< core::Vector > const &frag_crd,
		core::Size const n8,
	...
	compare_by_superposition( utility::vector1< ResidueDepthDataCOP > const & context_rdd,
		...
		utility::vector1< core::Vector > const & frag_crd_ref
	) const;

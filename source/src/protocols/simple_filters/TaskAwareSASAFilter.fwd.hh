...
/// @file   protocols/simple_filters/TaskAwareSASAFilter.fwd.hh
/// @brief
/// @author Neil King (neilking@u.washington.edu)


#ifndef INCLUDED_protocols_simple_filters_TaskAwareSASAFilter_fwd_hh
#define INCLUDED_protocols_simple_filters_TaskAwareSASAFilter_fwd_hh

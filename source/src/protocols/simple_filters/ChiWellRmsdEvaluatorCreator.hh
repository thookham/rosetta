...
#ifndef INCLUDED_protocols_simple_filters_ChiWellRmsdEvaluatorCreator_hh
#define INCLUDED_protocols_simple_filters_ChiWellRmsdEvaluatorCreator_hh
...
/// @brief creator for the ChiWellRmsdEvaluatorCreator class
class ChiWellRmsdEvaluatorCreator : public evaluation::EvaluatorCreator
{
public:

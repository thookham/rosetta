...
public:
	...
	filters::FilterOP clone() const  override {
		return utility::pointer::make_shared< ResidueLipophilicityFilter >( *this );
	}
	filters::FilterOP fresh_instance() const override {
		return utility::pointer::make_shared< ResidueLipophilicityFilter >();
	}

	~ResidueLipophilicityFilter() override;

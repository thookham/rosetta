...
/// @file   protocols/simple_filters/TaskAwareSASAFilterCreator.hh
/// @brief  FilterCreator for the TaskAwareSASAFilter
/// @author Neil King (neilking@u.washington.edu)

#ifndef INCLUDED_protocols_simple_filters_TaskAwareSASAFilterCreator_hh
#define INCLUDED_protocols_simple_filters_TaskAwareSASAFilterCreator_hh

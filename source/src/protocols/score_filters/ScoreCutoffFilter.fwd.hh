...
/// @file   /protocols/score_filters/ScoreCutoffFilter.fwd.hh
/// @brief
/// @author Florian Richter


#ifndef INCLUDED_protocols_simple_filters_ScoreCutoffFilter_fwd_hh
#define INCLUDED_protocols_simple_filters_ScoreCutoffFilter_fwd_hh

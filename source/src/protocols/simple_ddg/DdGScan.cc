...
/// @file protocols/simple_ddg/DdGScan.cc
/// @brief
...
void DdGScan::ddG_mover( protocols::simple_ddg::ddGOP const ddG_mover_op ) {
...
protocols::simple_ddg::ddGOP DdGScan::ddG_mover() const { return ddG_mover_; }

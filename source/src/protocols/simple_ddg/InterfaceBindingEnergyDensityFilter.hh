...
/// @file   protocols/simple_ddg/InterfaceBindingEnergyDensityFilter.hh
...
// Unit headers
#include <protocols/simple_ddg/InterfaceBindingEnergyDensityFilter.fwd.hh>
...
public:
	...
	InterfaceBindingEnergyDensityFilter(
		protocols::simple_filters::InterfaceSasaFilterOP sasa_filter,
	...
	void set_interface_sasa_filter( protocols::simple_filters::InterfaceSasaFilterOP sasa_filter );
...
private:
	protocols::simple_filters::InterfaceSasaFilterOP sasa_filter_;

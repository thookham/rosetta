...
/// @file protocols/constraint_filters/SavePoseConstraintToFileFilter.hh
/// @brief Filter for outputing information about the pose.
/// @author Lei Shi (shilei@uw.edu)

#ifndef INCLUDED_protocols_constraint_filters_SavePoseConstraintToFileFilter_hh
#define INCLUDED_protocols_constraint_filters_SavePoseConstraintToFileFilter_hh
...
public:
	...
	filters::FilterOP clone() const override {
		return utility::pointer::make_shared< SavePoseConstraintToFileFilter >( *this );
	}

...
/// @file src/protocols/constraint_filters/ConstraintScoreCutoffFilter.hh
/// @brief header file for ConstraintScoreCutoffFitler class.
/// @details
/// @author Florian Richter floric@u.washington.edu


#ifndef INCLUDED_protocols_constraint_filters_ConstraintScoreCutoffFilter_hh
#define INCLUDED_protocols_constraint_filters_ConstraintScoreCutoffFilter_hh

...
/// @file   protocols/denovo_design/architects/CompoundArchitectCreator.hh
/// @brief  Class for instantiating a particular DeNovoArchitect
/// @author Tom Linsky ( tlinsky at uw dot edu )

#ifndef INCLUDED_protocols_denovo_design_architects_CompoundArchitectCreator_HH
#define INCLUDED_protocols_denovo_design_architects_CompoundArchitectCreator_HH
...
class CompoundArchitectCreator : public DeNovoArchitectCreator {
public:

...
/// @file   protocols/denovo_design/architects/BetaSheetArchitectCreator.hh
/// @brief  Class for instantiating a particular DeNovoArchitect
/// @author Tom Linsky ( tlinsky at uw dot edu )

#ifndef INCLUDED_protocols_denovo_design_architects_BetaSheetArchitectCreator_HH
#define INCLUDED_protocols_denovo_design_architects_BetaSheetArchitectCreator_HH

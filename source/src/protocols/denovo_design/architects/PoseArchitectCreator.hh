...
/// @file   protocols/denovo_design/architects/PoseArchitectCreator.hh
/// @brief  Class for instantiating a particular DeNovoArchitect
/// @author Tom Linsky ( tlinsky at uw dot edu )

#ifndef INCLUDED_protocols_denovo_design_architects_PoseArchitectCreator_HH
#define INCLUDED_protocols_denovo_design_architects_PoseArchitectCreator_HH
...
class PoseArchitectCreator : public DeNovoArchitectCreator {
public:

...
/// @file   protocols/enzdes/EnzdesJobOutputter.fwd.hh
/// @brief forward declaration for EnzdesJobOutputters
/// @author Florian Richter (floric@u.washington.edu), september 2010


#ifndef INCLUDED_protocols_enzdes_EnzdesJobOutputter_fwd_hh
#define INCLUDED_protocols_enzdes_EnzdesJobOutputter_fwd_hh

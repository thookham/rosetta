...
/// @file   protocols/loops/loops_definers/LoopsDatabaseDefinerCreator.fwd.hh
/// @brief  Forward Header for base class for LoopsDatabaseDefinerCreator
/// @author Matthew O'Meara (mattjomeara@gmail.com)

#ifndef INCLUDED_protocols_loops_loops_definers_LoopsDatabaseDefinerCreator_FWD_HH
#define INCLUDED_protocols_loops_loops_definers_LoopsDatabaseDefinerCreator_FWD_HH

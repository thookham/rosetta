...
class EXCN_Loop_not_closed : public utility::excn::Exception {
public:
	EXCN_Loop_not_closed(char const *file, int line, std::string msg = "") : Exception(file, line, "failed to close loop " + msg ) {};
};

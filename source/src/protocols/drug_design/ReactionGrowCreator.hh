...
/// @file   protocols/drug_design/ReactionGrowCreator.hh
/// @brief  Class for instantiating a ReactionGrow
/// @author Rocco Moretti (rmorettiase@gmail.com)

#ifndef INCLUDED_protocols_drug_design_ReactionGrowCreator_HH
...
class ReactionGrowCreator : public protocols::chemistries::ChemistryCreator {
public:

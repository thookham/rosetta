...
/// @brief apply RDKit's reaction facilities to split a ResidueType
/// @author Rocco Moretti (rmorettiase@gmail.com)

#ifndef INCLUDED_protocols_drug_design_ReactionFragment_fwd_hh
#define INCLUDED_protocols_drug_design_ReactionFragment_fwd_hh
...
class ReactionFragment; // fwd declaration

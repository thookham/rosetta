...
void
BackboneGridSampler::provide_citation_info(basic::citation_manager::CitationCollectionList & citations ) const {
	...
	citations.add( pre_scoring_filter_ );
	citations.add( pre_scoring_mover_ );
}

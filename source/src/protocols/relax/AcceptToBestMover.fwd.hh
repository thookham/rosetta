...
/// @file   protocols/relax/AcceptToBestMover.fwd.hh
/// @author Jack Maguire

#ifndef INCLUDED_protocols_relax_AcceptToBestMover_fwd_hh
#define INCLUDED_protocols_relax_AcceptToBestMover_fwd_hh

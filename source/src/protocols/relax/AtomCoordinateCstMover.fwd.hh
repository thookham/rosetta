...
/// @file   protocols/relax/AtomCoordinateCstMover.fwd.hh
/// @brief
/// @author Rocco Moretti (rmoretti@u.washington.edu)


#ifndef INCLUDED_protocols_relax_AtomCoordinateCstMover_fwd_hh
#define INCLUDED_protocols_relax_AtomCoordinateCstMover_fwd_hh

...
#ifndef INCLUDED_protocols_flexpack_interaction_graph_PrecomputedFlexbbInteractionGraph_fwd_hh
#define INCLUDED_protocols_flexpack_interaction_graph_PrecomputedFlexbbInteractionGraph_fwd_hh

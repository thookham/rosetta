...
/// @file protocols/ncbb/triazolamer/TriazolamerRandomSmallMover.cc
/// @brief TriazolamerRandomSmallMover methods implemented
/// @author Kevin Drew, kdrew@nyu.edu

// Unit Headers
#include <protocols/ncbb/triazolamer/TriazolamerRandomSmallMover.hh>
...
static basic::Tracer TR( "protocols.simple_moves.triazolamer.TriazolamerRandomSmallMover" );
...
void TriazolamerRandomSmallMover::apply( core::pose::Pose & pose ){
	...
	for ( core::Size i = 1; i <= triazolamer_seq_positions_.size(); i++ ) {
		...
		runtime_assert ( triazolamer_pre_pos != pose.size() );

...
ddGMover::ddGMover() :
	...
	cst_set_(utility::pointer::make_shared< core::scoring::constraints::ConstraintSet >()),
	min_cst_set_wt_(utility::pointer::make_shared< core::scoring::constraints::ConstraintSet >()),
	min_cst_wt_types_(),
	min_cst_set_mut_(utility::pointer::make_shared< core::scoring::constraints::ConstraintSet >()),
	min_cst_mut_types_(),
	repack_cst_set_wt_(utility::pointer::make_shared< core::scoring::constraints::ConstraintSet >()),
	repack_wt_types_(),
	repack_cst_set_mut_(utility::pointer::make_shared< core::scoring::constraints::ConstraintSet >()),
	repack_mut_types_(),
				...
				for ( int j = 1; j < i; j++ ) {
					...
					if ( pose.residue(j).is_protein() ) {
						...
						if ( CA_dist < CA_cutoff ) {
							...
							ConstraintCOP cst( utility::pointer::make_shared< AtomPairConstraint >(
...
)
{
	...
	if ( basic::options::option[OptionKeys::ddg::use_rotamer_constraints_to_native]() ) {
		...
		repack_cst_set_wt_ = utility::pointer::make_shared< core::scoring::constraints::ConstraintSet >(*(pose.constraint_set()));
		//
		setup_repack_constraints(pose,scorefxn_,true,repack_mut_types_);
		repack_cst_set_mut_ = utility::pointer::make_shared< core::scoring::constraints::ConstraintSet >(*(pose.constraint_set()));
	}
	...
	if ( basic::options::option[OptionKeys::ddg::min_cst]() ) {
		if ( basic::options::option[OptionKeys::ddg::harmonic_ca_tether].user() ) {
			...
			min_cst_set_wt_ = utility::pointer::make_shared< core::scoring::constraints::ConstraintSet >(*(pose.constraint_set()));
			//
			setup_constraints( pose, min_cst_sfxn_, basic::options::option[OptionKeys::ddg::harmonic_ca_tether](), true, min_cst_mut_types_);
			min_cst_set_mut_ = utility::pointer::make_shared< core::scoring::constraints::ConstraintSet >(*(pose.constraint_set()));

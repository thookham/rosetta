...
public:
	...
	/// @brief ResidueRanges Setter (by doing this, it avoids applying the ResidueSelector)
	inline void set_ranges( core::select::residue_selector::ResidueRangesOP const & ranges ) { ranges_ = ranges; };

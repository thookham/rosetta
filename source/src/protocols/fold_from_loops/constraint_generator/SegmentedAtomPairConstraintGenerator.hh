...
#ifndef INCLUDED_protocols_fold_from_loops_constraint_generator_SegmentedAtomPairConstraintGenerator_hh
#define INCLUDED_protocols_fold_from_loops_constraint_generator_SegmentedAtomPairConstraintGenerator_hh

// Unit headers
#include <protocols/fold_from_loops/constraint_generator/SegmentedAtomPairConstraintGenerator.fwd.hh>
...
public:
	...
	void
	set_do_inner( bool pick );

	void
	set_do_outer( bool pick );
...
private:
	...
	inline static ConstraintConditions default_inner() { return ConstraintConditions{ 0.5, 1.0, true, false, false, 40.0, 8 }; }
	inline static ConstraintConditions default_outer() { return ConstraintConditions{ 0.5, 1.0, true, false, false, 12.0, 1 }; }
	inline static bool default_do_inner() { return true; };
	inline static bool default_do_outer() { return true; };

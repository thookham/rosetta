...
/// @file   protocols/fold_from_loops/ProteinResidueSelectorCreator.hh
/// @brief  Selects those residues that are amino acids
/// @author jaumebonet (jaume.bonet@gmail.com), Correia's LPDI/EPFL

#ifndef INCLUDED_protocols_fold_from_loops_ProteinResidueSelectorCreator_HH
#define INCLUDED_protocols_fold_from_loops_ProteinResidueSelectorCreator_HH
...
class ProteinResidueSelectorCreator : public core::select::residue_selector::ResidueSelectorCreator {
public:

...
#ifndef INCLUDED_protocols_kinematic_closure_perturbers_WalkingPerturber_FWD_HH
#define INCLUDED_protocols_kinematic_closure_perturbers_WalkingPerturber_FWD_HH

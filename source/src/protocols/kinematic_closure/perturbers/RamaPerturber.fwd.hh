...
#ifndef INCLUDED_protocols_kinematic_closure_perturbers_RamaPerturber_FWD_HH
#define INCLUDED_protocols_kinematic_closure_perturbers_RamaPerturber_FWD_HH

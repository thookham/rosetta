...
#ifndef INCLUDED_protocols_kinematic_closure_perturbers_IdealizeNonPhiPsi_FWD_HH
#define INCLUDED_protocols_kinematic_closure_perturbers_IdealizeNonPhiPsi_FWD_HH

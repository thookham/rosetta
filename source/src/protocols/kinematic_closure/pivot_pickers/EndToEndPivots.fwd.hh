...
#ifndef INCLUDED_protocols_kinematic_closure_pivot_pickers_EndToEndPivots_FWD_HH
#define INCLUDED_protocols_kinematic_closure_pivot_pickers_EndToEndPivots_FWD_HH

...
#ifndef INCLUDED_protocols_kinematic_closure_solution_pickers_SolutionPicker_FWD_HH
#define INCLUDED_protocols_kinematic_closure_solution_pickers_SolutionPicker_FWD_HH

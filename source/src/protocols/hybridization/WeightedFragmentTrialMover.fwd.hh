...
/// @file WeightedFragmentTrialMover.fwd.hh
/// @brief
/// @author Yifan Song

#ifndef INCLUDED_protocols_hybridization_WeightedFragmentTrialMover_fwd_hh
#define INCLUDED_protocols_hybridization_WeightedFragmentTrialMover_fwd_hh

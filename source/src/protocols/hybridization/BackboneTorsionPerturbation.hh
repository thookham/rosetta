...
/// @file   BackboneTorsionPerturbation.hh
///
/// @brief
/// @author Yifan Song

#ifndef INCLUDED_protocols_hybridization_BackboneTorsionPerturbation_hh
#define INCLUDED_protocols_hybridization_BackboneTorsionPerturbation_hh

// Unit Headers
//#include <protocols/hybridization/BackboneTorsionPerturbation.fwd.hh>
...
public:
	...
	void perturb(core::pose::Pose & pose, core::Real max_delta_torsion);

...
/// @file   StructFragmentMoverCreator.hh
/// @brief  Creating fragments from supplied structures.
/// @author andreas scheck (graziano.bud@gmail.com), Correia's LPDI/EPFL

#ifndef INCLUDED_protocols_struct_fragment_StructFragmentMoverCreator_hh
#define INCLUDED_protocols_struct_fragment_StructFragmentMoverCreator_hh

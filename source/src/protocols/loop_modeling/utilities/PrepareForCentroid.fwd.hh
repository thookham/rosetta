...
#ifndef INCLUDED_protocols_loop_modeling_utilities_PrepareForCentroid_FWD_HH
#define INCLUDED_protocols_loop_modeling_utilities_PrepareForCentroid_FWD_HH

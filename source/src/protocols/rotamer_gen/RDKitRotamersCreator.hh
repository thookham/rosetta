...
#ifndef INCLUDED_protocols_rotamer_gen_RDKitRotamersCreator_hh
#define INCLUDED_protocols_rotamer_gen_RDKitRotamersCreator_hh
...
class RDKitRotamersCreator : public protocols::chemistries::ChemistryCreator {
public:

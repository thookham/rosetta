...
protocols::symmetry::NCSResMapping::NCSResMapping() {}

/// @brief Automatically generated serialization method
template< class Archive >
void
protocols::symmetry::NCSResMapping::save( Archive & arc ) const {
...
template< class Archive >
void
protocols::symmetry::NCSResMapping::load( Archive & arc ) {
	arc( cereal::base_class< basic::datacache::CacheableData >( this ) );
...
SAVE_AND_LOAD_SERIALIZABLE( protocols::symmetry::NCSResMapping );
CEREAL_REGISTER_TYPE( protocols::symmetry::NCSResMapping )

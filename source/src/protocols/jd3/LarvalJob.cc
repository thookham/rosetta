...
static basic::Tracer TR( "protocols.jd3.LarvalJob" );
...
std::string LarvalJob::job_tag_with_index_suffix( JobOutputIndex const & output_index, core::Size const min_digits ) const
{

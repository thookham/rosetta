...
Options = Option_Group( '',
    ...
    Option( 'replonly_loops', 'Boolean', desc = 'all loops will be regarded as repulsive-only', default='false' ),
		Option( 'use_database', 'Boolean', desc="Read in structures from database.  Specify database via -inout:dbms:database_name and wanted structures with -in:file:tags"),
		Option_Group( 'path',
		...
		Option_Group( 'file',
			...
			Option( 'rama2b_map', 'File', default = 'scoring/score_functions/rama/Rama08.dat', desc="Ramachandran file used by rama2b" ),
...
#			 Option( 'minimize_tensor', 'Boolean', desc = 'Optimize the best tensor found form the grid search'),
	...
	Option_Group( 'out',
		...
		Option( 'use_database', 'Boolean', desc="Write out structures to database.  Specify database via -inout:dbms:database_name and wanted structures with -in:file:tags"),
...
## --------------------------  END OF fragment picking --------------
  ...
  Option_Group('nonlocal',
	...
	Option_Group( 'score',
		...
		Option( 'weights', 'String', desc="Name of weights file (without extension .wts)" , default="pre_talaris_2013_standard.wts" ),
	...
	Option_Group( 'corrections',
		...
		Option_Group( 'score',
			...
			Option( 'score12prime', 'Boolean', desc="Whenever get_score_function() would have returned the ScoreFunction from standard.wts + score12.wts_patch, instead return a revised score12 (score12prime) with reference energies optimized with optE for sequence profile recovery", default='false' ),
  ...
  # fold from loops
	...
	Option_Group( 'match',
		...
		Option( 'dynamic_grid_refinement', 'Boolean', desc="When too many hits land in the same 'connected component', requiring the \
				enumeration of twoo many matches, refine the grid size to be smaller so that fewer matches have to be samplingd. \

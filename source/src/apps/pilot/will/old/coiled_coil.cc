...
void add_fa_cst(core::pose::Pose & cc, CCParam & p) {
	...
	Size c2 = p.cys_pos[2]; assert("CY"==cc.residue(c2).name3().substr(0,2));
	Size c3 = p.cys_pos[3]; assert("CY"==cc.residue(c3).name3().substr(0,2));
	Size c4 = p.cys_pos[4]; assert("CY"==cc.residue(c4).name3().substr(0,2));

	add_apc(cc, AtomID(5,c1), AtomID( 2,p.nres+1), 1.804057, 0.1 ); //0.036217 );
	add_apc(cc, AtomID(5,c2), AtomID( 5,p.nres+1), 1.804057, 0.1 ); //0.036217 );
	add_apc(cc, AtomID(5,c3), AtomID( 8,p.nres+1), 1.804057, 0.1 ); //0.036217 );
	add_apc(cc, AtomID(5,c4), AtomID(11,p.nres+1), 1.804057, 0.1 ); //0.036217 );

	add_agc(cc, AtomID(5,c1), AtomID( 2,p.nres+1),AtomID( 1,p.nres+1),numeric::conversions::radians(108.2215),numeric::conversions::radians(9.0377));
	add_agc(cc, AtomID(5,c2), AtomID( 5,p.nres+1),AtomID( 4,p.nres+1),numeric::conversions::radians(108.2215),numeric::conversions::radians(9.0377));
	add_agc(cc, AtomID(5,c3), AtomID( 8,p.nres+1),AtomID( 7,p.nres+1),numeric::conversions::radians(108.2215),numeric::conversions::radians(9.0377));
	add_agc(cc, AtomID(5,c4), AtomID(11,p.nres+1),AtomID(10,p.nres+1),numeric::conversions::radians(108.2215),numeric::conversions::radians(9.0377));

	add_agc(cc, AtomID(2,c1), AtomID( 5,c1),AtomID( 2,p.nres+1),numeric::conversions::radians(114.1297),numeric::conversions::radians(3.232815));
	add_agc(cc, AtomID(2,c2), AtomID( 5,c2),AtomID( 5,p.nres+1),numeric::conversions::radians(114.1297),numeric::conversions::radians(3.232815));
	add_agc(cc, AtomID(2,c3), AtomID( 5,c3),AtomID( 8,p.nres+1),numeric::conversions::radians(114.1297),numeric::conversions::radians(3.232815));
	add_agc(cc, AtomID(2,c4), AtomID( 5,c4),AtomID(11,p.nres+1),numeric::conversions::radians(114.1297),numeric::conversions::radians(3.232815));

	add_dhc(cc, AtomID(2,c1), AtomID( 5,c1), AtomID( 2,p.nres+1),AtomID( 1,p.nres+1),numeric::conversions::radians(86.13981),numeric::conversions::radians(26.35887));
	add_dhc(cc, AtomID(2,c2), AtomID( 5,c2), AtomID( 5,p.nres+1),AtomID( 4,p.nres+1),numeric::conversions::radians(86.13981),numeric::conversions::radians(26.35887));
	add_dhc(cc, AtomID(2,c3), AtomID( 5,c3), AtomID( 8,p.nres+1),AtomID( 7,p.nres+1),numeric::conversions::radians(86.13981),numeric::conversions::radians(26.35887));
	add_dhc(cc, AtomID(2,c4), AtomID( 5,c4), AtomID(11,p.nres+1),AtomID(10,p.nres+1),numeric::conversions::radians(86.13981),numeric::conversions::radians(26.35887));
...
align_sf4(
	...
	core::Real dissdv, core::Real angsdv
) {
	using core::id::AtomID;
	...
	tp.append_residue_by_jump(*sf4,1);


	add_apc(tp, AtomID(5,1), AtomID( 2,5), 1.804057, 0.36217 ); // 10x nat sd
	add_apc(tp, AtomID(5,2), AtomID( 5,5), 1.804057, 0.36217 ); // 10x nat sd
	add_apc(tp, AtomID(5,3), AtomID( 8,5), 1.804057, 0.36217 ); // 10x nat sd
	add_apc(tp, AtomID(5,4), AtomID(11,5), 1.804057, 0.36217 ); // 10x nat sd
	add_agc(tp, AtomID(5,1), AtomID( 2,5),AtomID( 1,5),numeric::conversions::radians(108.2215),numeric::conversions::radians(9.0377));
	add_agc(tp, AtomID(5,2), AtomID( 5,5),AtomID( 4,5),numeric::conversions::radians(108.2215),numeric::conversions::radians(9.0377));
	add_agc(tp, AtomID(5,3), AtomID( 8,5),AtomID( 7,5),numeric::conversions::radians(108.2215),numeric::conversions::radians(9.0377));
	add_agc(tp, AtomID(5,4), AtomID(11,5),AtomID(10,5),numeric::conversions::radians(108.2215),numeric::conversions::radians(9.0377));
	add_agc(tp, AtomID(2,1), AtomID( 5,1),AtomID( 2,5),numeric::conversions::radians(114.1297),numeric::conversions::radians(3.232815));
	add_agc(tp, AtomID(2,2), AtomID( 5,2),AtomID( 5,5),numeric::conversions::radians(114.1297),numeric::conversions::radians(3.232815));
	add_agc(tp, AtomID(2,3), AtomID( 5,3),AtomID( 8,5),numeric::conversions::radians(114.1297),numeric::conversions::radians(3.232815));
	add_agc(tp, AtomID(2,4), AtomID( 5,4),AtomID(11,5),numeric::conversions::radians(114.1297),numeric::conversions::radians(3.232815));
	mnm.apply(tp);
	add_dhc(tp, AtomID(2,1), AtomID( 5,1),AtomID( 2,5),AtomID( 1,5),numeric::conversions::radians(86.13981),numeric::conversions::radians(26.35887));
	add_dhc(tp, AtomID(2,2), AtomID( 5,2),AtomID( 5,5),AtomID( 4,5),numeric::conversions::radians(86.13981),numeric::conversions::radians(26.35887));
	add_dhc(tp, AtomID(2,3), AtomID( 5,3),AtomID( 8,5),AtomID( 7,5),numeric::conversions::radians(86.13981),numeric::conversions::radians(26.35887));
	add_dhc(tp, AtomID(2,4), AtomID( 5,4),AtomID(11,5),AtomID(10,5),numeric::conversions::radians(86.13981),numeric::conversions::radians(26.35887));
	mnm.apply(tp);
	core::pose::Pose tmp = tp;

	tp.remove_constraints();
	add_apc(tp, AtomID(5,2), AtomID( 2,5), 1.804057, 0.36217 ); // 10x nat sd
	add_apc(tp, AtomID(5,1), AtomID( 5,5), 1.804057, 0.36217 ); // 10x nat sd
	add_apc(tp, AtomID(5,3), AtomID( 8,5), 1.804057, 0.36217 ); // 10x nat sd
	add_apc(tp, AtomID(5,4), AtomID(11,5), 1.804057, 0.36217 ); // 10x nat sd
	add_agc(tp, AtomID(5,2), AtomID( 2,5),AtomID( 1,5),numeric::conversions::radians(108.2215),numeric::conversions::radians(9.0377));
	add_agc(tp, AtomID(5,1), AtomID( 5,5),AtomID( 4,5),numeric::conversions::radians(108.2215),numeric::conversions::radians(9.0377));
	add_agc(tp, AtomID(5,3), AtomID( 8,5),AtomID( 7,5),numeric::conversions::radians(108.2215),numeric::conversions::radians(9.0377));
	add_agc(tp, AtomID(5,4), AtomID(11,5),AtomID(10,5),numeric::conversions::radians(108.2215),numeric::conversions::radians(9.0377));
	add_agc(tp, AtomID(2,2), AtomID( 5,2),AtomID( 2,5),numeric::conversions::radians(114.1297),numeric::conversions::radians(3.232815));
	add_agc(tp, AtomID(2,1), AtomID( 5,1),AtomID( 5,5),numeric::conversions::radians(114.1297),numeric::conversions::radians(3.232815));
	add_agc(tp, AtomID(2,3), AtomID( 5,3),AtomID( 8,5),numeric::conversions::radians(114.1297),numeric::conversions::radians(3.232815));
	add_agc(tp, AtomID(2,4), AtomID( 5,4),AtomID(11,5),numeric::conversions::radians(114.1297),numeric::conversions::radians(3.232815));
	mnm.apply(tp);
	add_dhc(tp, AtomID(2,2), AtomID( 5,2),AtomID( 2,5),AtomID( 1,5),numeric::conversions::radians(86.13981),numeric::conversions::radians(26.35887));
	add_dhc(tp, AtomID(2,1), AtomID( 5,1),AtomID( 5,5),AtomID( 4,5),numeric::conversions::radians(86.13981),numeric::conversions::radians(26.35887));
	add_dhc(tp, AtomID(2,3), AtomID( 5,3),AtomID( 8,5),AtomID( 7,5),numeric::conversions::radians(86.13981),numeric::conversions::radians(26.35887));
	add_dhc(tp, AtomID(2,4), AtomID( 5,4),AtomID(11,5),AtomID(10,5),numeric::conversions::radians(86.13981),numeric::conversions::radians(26.35887));
	mnm.apply(tp);
	...
	Vec com(0,0,0);
	for ( Size i = 1; i <= 12; ++i ) com += tp.xyz(AtomID(i,5));
	com.z(0);
	using numeric::min;
	using numeric::max;
	// !!!!!!!!!!! assumes no SF4 in yet!!!
	...
	Real tailbonus = 300 - 50*( max(0.0,4.0-nt) + max(0.0,4.0-ct) );
...
place_sf4(
	...
	Real const THRESH(121.0),NEAR(25.0);
	Real bestscore=9e9;
	using core::id::AtomID;
	for ( Size i =   1; i <= p.nres       ; ++i ) {
		for ( Size j = i+1; j <= p.nres*p.nsub; ++j ) {
			...
			for ( Size k = j+1; k <= p.nres*p.nsub; ++k ) {
				if ( i%p.nres == k%p.nres ) continue;
				if ( j%p.nres == k%p.nres ) continue;
				if ( THRESH < cc.xyz(AtomID(5,i)).distance_squared(cc.xyz(AtomID(5,k))) ) continue;
				if ( THRESH < cc.xyz(AtomID(5,j)).distance_squared(cc.xyz(AtomID(5,k))) ) continue;
				if ( NEAR   > cc.xyz(AtomID(5,i)).distance_squared(cc.xyz(AtomID(5,k))) ) continue;
				if ( NEAR   > cc.xyz(AtomID(5,j)).distance_squared(cc.xyz(AtomID(5,k))) ) continue;
				for ( Size l = k+1; l <= p.nres*p.nsub; ++l ) {
					if ( i%p.nres == l%p.nres ) continue;
					if ( j%p.nres == l%p.nres ) continue;
					if ( k%p.nres == l%p.nres ) continue;
					if ( THRESH < cc.xyz(AtomID(5,i)).distance_squared(cc.xyz(AtomID(5,l))) ) continue;
					if ( THRESH < cc.xyz(AtomID(5,j)).distance_squared(cc.xyz(AtomID(5,l))) ) continue;
					if ( THRESH < cc.xyz(AtomID(5,k)).distance_squared(cc.xyz(AtomID(5,l))) ) continue;
					if ( NEAR   > cc.xyz(AtomID(5,i)).distance_squared(cc.xyz(AtomID(5,l))) ) continue;
					if ( NEAR   > cc.xyz(AtomID(5,j)).distance_squared(cc.xyz(AtomID(5,l))) ) continue;
					if ( NEAR   > cc.xyz(AtomID(5,k)).distance_squared(cc.xyz(AtomID(5,l))) ) continue;
					...
					for ( Size ir = 1; ir <= p.nres*p.nsub; ++ir ) {
						for ( Size ia = 1; ia <= cc.residue_type(ir).nheavyatoms(); ++ia ) {
							if ( com.distance_squared(cc.xyz(AtomID(ia,ir))) < 9.0 ) {
								collision = true;
							}
						}
					}
					...
					core::pose::Pose tmp;
					Real sf4score = fabs(align_sf4(cc,p,tmp,i,j,k,l,dissdv,angsdv));
					// std::cout << "align_sf4 score " << sf4score << std::endl;
					// std::cerr << "sf4score " << sf4score << " "
					//           << i+floor((i-1)/(p.nres)) << " "
					//           << j+floor((j-1)/(p.nres)) << " "
					//           << k+floor((k-1)/(p.nres)) << " "
					//           << l+floor((l-1)/(p.nres)) << std::endl;
					if ( sf4score < bestscore ) bestscore = sf4score;
					if ( sf4score < cstthresh ) {
	...
	if ( idxs.size()==0 ) TR << "place SF4 fail " << bestscore << std::endl;
	return idxs;
}
...
add_symm_sf4(
	...
	Size bestii = 0;
	utility::vector1<utility::vector1<Size> > idxs( place_sf4(cc,p,cstthresh,dissdv,angsdv) );
	...
	for ( Size ii = 1; ii <= idxs.size(); ++ii ) {
		...
		core::pose::Pose tp;
		Real minus = align_sf4(tmppose,p,tp,c1,c2,c3,c4,0.3,5.0);

		// make symm pose w/SF4
		ResidueTypeSetCAP residue_set( ChemicalManager::get_instance()->residue_type_set( CENTROID ) );
		ResidueOP sf4 = ResidueFactory::create_residue( residue_set->name_map("SF4") );
		...
		pose.append_residue_by_jump( *sf4, c1 );
		...
		if ( minus < 0 ) { Size tmp = c1; c1 = c2; c2 = tmp; }
		cpos[1] = c1; cpos[2] = c2; cpos[3] = c3; cpos[4] = c4;
		// std::cout << "c " << c1 << " " << c2 << " " << c3 << " " << c4 << std::endl;
		add_apc(tmppose,AtomID(5,c1),AtomID( 2,p.nres+1),1.808803,dissdv);
		add_apc(tmppose,AtomID(5,c2),AtomID( 5,p.nres+1),1.808803,dissdv);
		add_apc(tmppose,AtomID(5,c3),AtomID( 8,p.nres+1),1.808803,dissdv);
		add_apc(tmppose,AtomID(5,c4),AtomID(11,p.nres+1),1.808803,dissdv);

		add_agc(tmppose,AtomID(5,c1),AtomID( 2,p.nres+1),AtomID( 1,p.nres+1),numeric::conversions::radians(100.0),numeric::conversions::radians(angsdv));
		add_agc(tmppose,AtomID(5,c2),AtomID( 5,p.nres+1),AtomID( 4,p.nres+1),numeric::conversions::radians(100.0),numeric::conversions::radians(angsdv));
		add_agc(tmppose,AtomID(5,c3),AtomID( 8,p.nres+1),AtomID( 7,p.nres+1),numeric::conversions::radians(100.0),numeric::conversions::radians(angsdv));
		add_agc(tmppose,AtomID(5,c4),AtomID(11,p.nres+1),AtomID(10,p.nres+1),numeric::conversions::radians(100.0),numeric::conversions::radians(angsdv));

		add_agc(tmppose,AtomID(2,c1),AtomID( 5,c1),AtomID( 2,p.nres+1),numeric::conversions::radians(100.0),numeric::conversions::radians(angsdv));
		add_agc(tmppose,AtomID(2,c2),AtomID( 5,c2),AtomID( 5,p.nres+1),numeric::conversions::radians(100.0),numeric::conversions::radians(angsdv));
		add_agc(tmppose,AtomID(2,c3),AtomID( 5,c3),AtomID( 8,p.nres+1),numeric::conversions::radians(100.0),numeric::conversions::radians(angsdv));
		add_agc(tmppose,AtomID(2,c4),AtomID( 5,c4),AtomID(11,p.nres+1),numeric::conversions::radians(100.0),numeric::conversions::radians(angsdv));

		add_dhc(tmppose,AtomID(2,c1),AtomID( 5,c1),AtomID( 2,p.nres+1),AtomID( 1,p.nres+1),numeric::conversions::radians(100.0),numeric::conversions::radians(angsdv));
		add_dhc(tmppose,AtomID(2,c2),AtomID( 5,c2),AtomID( 5,p.nres+1),AtomID( 4,p.nres+1),numeric::conversions::radians(100.0),numeric::conversions::radians(angsdv));
		add_dhc(tmppose,AtomID(2,c3),AtomID( 5,c3),AtomID( 8,p.nres+1),AtomID( 7,p.nres+1),numeric::conversions::radians(100.0),numeric::conversions::radians(angsdv));
		add_dhc(tmppose,AtomID(2,c4),AtomID( 5,c4),AtomID(11,p.nres+1),AtomID(10,p.nres+1),numeric::conversions::radians(100.0),numeric::conversions::radians(angsdv));

		core::Real score = (*sf)(tmppose);
		// std::cout << ii << std::endl;
		// sf->show(tmppose);
		// tmppose.dump_pdb("tmppose.pdb");
		// std::cerr << "sf4 censcore " << score/p.nres << " " << c1 << " " << c2 << " " << c3 << " " << c4 << std::endl;
		if ( score < bestscore ) {
			bestscore = score;
			bestpose  = tmppose;
			bestii    = ii;
...
main( int argc, char * argv [] )
{
	...
	try {
		...
		while ( true ) {
			...
			zcyl = zcyl_score(cenpose,p.nres,p.trans); if ( zcyl     <  1.0 ) { continue; }
			censcore = (*sfc)(cenpose)/p.nres;         if ( censcore >= 2.0 ) { continue; }
			if ( !add_symm_sf4(cenpose,p,sfc,300,0.1,4.0) ) { continue; }
			...
			sf4score = cenpose.energies().residue_total_energy(p.nres+1);
			// TR << "cstscore " << cstscore << std::endl;
			//std::cerr << "CENSCORE AFTER MIN SF4 " << censcore << " " << censcore2 << " " << cstscore << std::endl;
			if ( censcore2 >= 2.0 ) {
				TR << "SF4 censcore fail " << censcore2 << std::endl;
				continue;
			}

			TR << LJ(35,"cenp_cen_"+tag+".pdb.gz") << " " << F(10,5,censcore) << " " << F(10,5,censcore2) << " " << F(10,5,cstscore) << " " << F(10,5,sf4score) << " " << p.nres << " " << p.trans << " " << p.rot << std::endl;
			TR << p.str() << std::endl;

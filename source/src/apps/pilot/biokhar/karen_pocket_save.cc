...
int main( int argc, char * argv [] ) {
	...
	try{
		...
		//call function to get eggshell using pocket grid
		protocols::pockets::EggshellGrid comparison_eggshell_grid( comparison_pg );
		TR << "Comparison pocket eggshell made" << std::endl;

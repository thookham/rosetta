...
#include <core/optimization/MinimizerOptions.hh> // MANUAL IWYU

#include <core/optimization/symmetry/SymAtomTreeMinimizer.hh> // AUTO IWYU For SymAtomTreeMinimizer
...
public:
	...
	void design_cycle( Pose & pose, core::scoring::ScoreFunctionOP sf, core::scoring::ScoreFunctionOP sfsoft, utility::vector1<bool> interface ) {
		...
		// 2 hard design+min+hard pack+min
		{

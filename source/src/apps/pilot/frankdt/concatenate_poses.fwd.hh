...
/// @file apps/pilot/frankdt/concatenate_poses.fwd.hh
/// @brief concatenates poses together end-to-end while transforming them to avoid chainbreaks
/// @author frankdt (frankdt@email.unc.edu)

#ifndef INCLUDED_apps_pilot_frankdt_concatenate_poses_fwd_hh
#define INCLUDED_apps_pilot_frankdt_concatenate_poses_fwd_hh
...
#endif //INCLUDED_apps_pilot_frankdt_concatenate_poses_fwd_hh

...
static basic::Tracer TR( "apps.pilot.whitney_specificity_switch.main" );
...
main( int argc, char * argv [] )
{
	...
	try {
		...
		core::import_pose::pose_from_file( bound_pose_native, input_pdb_name , core::import_pose::PDB_file);

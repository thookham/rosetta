...
////////////////////////////////////////
/// Sfxn fingerprint mover /////////////
////////////////////////////////////////

/// @brief Andrew's Score Function fingerprint mover used for sfxn fingerprint tests
...
void MPScoreFunctionFingerprintMover::apply( pose::Pose & pose ) {
...
int main( int argc, char ** argv )
{
	try {
		...
		MPScoreFunctionFingerprintMoverOP sffm = new MPScoreFunctionFingerprintMover();

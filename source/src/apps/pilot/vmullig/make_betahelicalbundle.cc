...
int main( int argc, char * argv [] ) {
	...
	const string sequence = "A[B3A]A[B3A]A[B3A]A[B3A]A[B3A]A[B3A]A[B3A]A[B3A]A[B3A]A[B3A]A[B3A]A[B3A]A[B3A]A[B3A]A[B3A]A[B3A]A[B3A]A[B3A]A[B3A]A[B3A]A[B3A]A[B3A]A[B3A]A[B3A]";
	...
	for ( core::Size i=1; i<90; i+=1 ) {
		...
		for ( core::Size ir=1; ir<=mypose.size(); ir++ ) {
			...
			curphi = acos(dotpdt(T1,v1)*dotpdt(v1,v2)-dotpdt(T1,v2)) /2.0/numeric::constants::d::pi*360.0-180.0;
			curpsi = acos(dotpdt(T2,v2)*dotpdt(v1,v2)-dotpdt(T2,v1)) /2.0/numeric::constants::d::pi*360.0-180.0;

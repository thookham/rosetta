...
void PepMinMover::apply (pose::Pose& pose ) {
	...
	//minimization
	protocols::minimization_packing::MinMoverOP min_mover = new protocols::minimization_packing::MinMover( movemap, scorefxn_, option[ OptionKeys::run::min_type ].value(), 0.01, true /*use_nblist*/ );

...
LibraryJumpSetup::LibraryJumpSetup( Size nres, SecondaryStructureOP ss,core::pose::PoseOP native_one,int iResidue,int jResidue,int orientation,int pleating) {
        nres_ = nres;
        ss_def_ = ss;
        nJumps_ = 1;
...
LibraryJumpSetup::LibraryJumpSetup( Size nres, SecondaryStructureOP ss,core::pose::PoseOP native_one,int nJumps,int *iResidue,int *jResidue,int *orientation,int *pleating) {
        nres_ = nres;
        ss_def_ = ss;
        nJumps_ = nJumps;
        native_pose_ = native_one;
...
JumpSample
LibraryJumpSetup::create_jump_sample( ) const {
  PairingsList jumps;
  // ANTI = 1, INWARDS = 2

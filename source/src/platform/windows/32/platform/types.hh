...
/// @file   platform/windows/32/platform/types.hh
/// @brief  Platform-specific types for 32-bit Windows
/// @author Stuart G. Mentzer (Stuart_Mentzer@objexx.com)


#ifndef INCLUDED_platform_windows_32_platform_types_hh
#define INCLUDED_platform_windows_32_platform_types_hh
...
typedef  long int  intptr_t; // Pointer-sized signed integer
typedef  unsigned long int  uintptr_t; // Pointer-sized unsigned integer

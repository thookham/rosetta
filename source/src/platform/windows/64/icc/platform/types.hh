...
/// @file   platform/windows/64/icc/platform/types.hh
/// @brief  Platform-specific types for 64-bit Windows with Intel C++
/// @author Stuart G. Mentzer (Stuart_Mentzer@objexx.com)


#ifndef INCLUDED_platform_windows_64_icc_platform_types_hh
#define INCLUDED_platform_windows_64_icc_platform_types_hh

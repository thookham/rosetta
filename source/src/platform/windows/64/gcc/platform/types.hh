...
/// @file   platform/windows/64/gcc/platform/types.hh
/// @brief  Platform-specific types for 64-bit Windows with GCC
/// @author Stuart G. Mentzer (Stuart_Mentzer@objexx.com)


#ifndef INCLUDED_platform_windows_64_gcc_platform_types_hh
#define INCLUDED_platform_windows_64_gcc_platform_types_hh

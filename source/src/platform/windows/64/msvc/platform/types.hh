...
/// @file   platform/windows/64/msvc/platform/types.hh
/// @brief  Platform-specific types for 64-bit Windows with MS VC++
/// @author Stuart G. Mentzer (Stuart_Mentzer@objexx.com)


#ifndef INCLUDED_platform_windows_64_msvc_platform_types_hh
#define INCLUDED_platform_windows_64_msvc_platform_types_hh

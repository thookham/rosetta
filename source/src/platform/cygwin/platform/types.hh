...
/// @file   platform/linux/platform/types.hh
/// @brief  Platform-specific types for Linux
/// @author Stuart G. Mentzer (Stuart_Mentzer@objexx.com)


#ifndef INCLUDED_platform_cygwin_platform_types_hh
#define INCLUDED_platform_cygwin_platform_types_hh

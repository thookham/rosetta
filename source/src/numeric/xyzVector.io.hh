...
/// @file   numeric/xyzVector.io.hh
/// @brief  xyzVector input/output functions
/// @author Frank M. D'Ippolito (Objexx@objexx.com)
/// @author Stuart G. Mentzer (Stuart_Mentzer@objexx.com)


#ifndef INCLUDED_numeric_xyzVector_io_hh
#define INCLUDED_numeric_xyzVector_io_hh
...
/// @brief stream << xyzVector output operator
template< typename T >
std::ostream &
...
/// @brief stream >> xyzVector input operator
...
template< typename T >
std::istream &
operator >>( std::istream & stream, xyzVector< T > & v )
{
...
#endif // INCLUDED_numeric_xyzVector_io_HH
